...
[堆叠 ID](Stack_ID.md "堆叠 ID")：`CONTAGION_FILTH_FEVER` [状态组](Status_groups.md "状态组")：[SG_Disease](SG_Disease.md "SG 疾病")

[持续时间结束](Conditions.md#Duration "状态")：回合开始时

## 备注

- 可能是在穿越[灰色港口码头](Grey_Harbour_Docks.md "灰色港口码头")隔离的船只[华丽少女号](Lustrous_Lass.md "华丽少女号")时染上的，该船位于[下城区](Lower_City.md "下城区")。

## 海疫来源

- [华丽少女号](Lustrous_Lass.md "华丽少女号")
