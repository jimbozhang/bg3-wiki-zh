...
[堆叠 ID](Stack_ID.md "堆叠 ID")：`WET` [状态组](Status_groups.md "状态组")：[SG_Surface](SG_Surface.md "SG Surface")
...
- 受影响实体的[护甲等级](Armour_Class.md "护甲等级")已降低 5。该唾液可用水清除。

[腐蚀唾液：溶解中](Corrosive_Spit_colon__Dissolving_(Condition).md "腐蚀唾液：溶解中 (状态)")
|

- 每回合受到 1d10[强酸](Acid.md "强酸")伤害。
- 受影响实体的[护甲等级](Armour_Class.md "护甲等级")已降低 1。除非用水洗掉，否则唾液会持续侵蚀其防御，进一步降低其护甲等级。
