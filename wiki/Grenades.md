...
[炼金术](Alchemy.md "Alchemy")窗口中的手雷列表。

**手雷**是一种[消耗品](Consumables.md "Consumables")，可以被[投掷](Throw.md "Throw")以造成[伤害](Damage.md "Damage")、施加[状态](Conditions.md "Conditions")、创造[表面](Surface.md "Surface")、击退[生物](Explosives.md "Explosives")或产生其他效果。大多数[涂层](Coating.md "Coating")、[酏剂](Elixir.md "Elixir")和[药水](Potions.md "Potions")在投掷时也可以作为手雷使用。许多手雷还可以[爆炸](Explosives.md "Explosives")。
...
大多数手雷在被摧毁时会触发各自的效果，通常是通过[投掷](Throw.md "Throw")轻型物品时造成的1点[钝击](Bludgeoning.md "Bludgeoning")伤害来触发。然而，放置在世界中的手雷也可以被任何其他伤害来源触发，例如[攻击](Attacks.md "Attacks")、造成伤害的[表面](Surface.md "Surface")（如[火焰](Fire_(surface).md "Fire (surface)")）或其他手雷。

同一物品堆叠中的多个手雷的爆炸效果与单个手雷完全相同。因此，建议在使用前先将物品堆叠拆分为单个物品。

当放置在可破坏的[容器](Containers.md "Containers")中时，可以通过投掷容器一次投掷多个手雷。但是，以这种方式散落的手雷不会因投掷而受到伤害，必须通过二次伤害来源手动触发。

手雷可以通过拾取、从商人处购买或使用[炼金术](Alchemy.md "Alchemy")系统制作获得。某些手雷只能通过其中部分方式获取。

## 手雷

### 普通手雷

另见：[爆炸物#普通手雷](Explosives.md#Regular_Grenades "Explosives")

可以在世界各处常见的手雷，可从商人处购买或使用[炼金术](Alchemy.md "Alchemy")制作。购买这些手雷没有等级要求，但某些手雷仅由特定商人出售，详见下表。
...
| / [油脂瓶](Grease_Bottle.md "油脂瓶")油脂瓶 | 3 m / 10 ft | - | [油脂](Grease_(surface).md "Grease (surface)") / [困难地形](Difficult_Terrain_(Condition).md "Difficult Terrain (Condition)") / [倒伏](Prone_(Condition).md "Prone (Condition)") | 否 | [DC](Dice_rolls#Save_DCs.md#Save_DCs "Dice rolls") 12 [敏捷](Dexterity.md "Dexterity")[豁免检定](Saving_throw.md "Saving Throw")以免除倒地。 |
...
另见：[爆炸物#特殊手雷](Explosives.md#Special_Grenades "Explosives")

难以找到且数量极其有限的手雷，并非用于常规使用。
...
另见：[爆炸物#炸药包与桶](Explosives.md#Satchels_and_Barrels "Explosives")

可以投掷并产生爆炸效果的物品。然而与其他手雷不同，这些爆炸物必须被点燃或受到足够的伤害才会爆炸。与特殊手雷类似，其中一些物品稀有且难以获取。这些物品在游戏文件中没有GRENADE标签。
...
严格来说不是**手雷**。但如果投掷，它会像一枚特别强力的毒素**手雷**一样发挥作用。

- [可疑毒药](Suspicious_Poison.md "Suspicious Poison")

1. [↑](#cite_ref-ingredient_1-0) 这是一种炼金术材料，因此从某种意义上说它不止是可制作的。
