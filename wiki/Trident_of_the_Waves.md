...
波涛三叉戟是一把+1 [三叉戟](Tridents.md "三叉戟")。它会在目标周围创造一个[水](Water_(surface).md "水（地表）")地表，并施加[濡湿](Wet_(Condition).md "濡湿（状态）")状态。

[安博里](Umberlee.md "安博里")，海洋女神，反复无常、聪慧过人，且远非其领域所暗示的那般“湿漉漉”。她常向水手索要祭品，例如他们的船只、货物，以及顺带地，他们自己。
...
重量：1.8 千克 (3.6 磅)
价格：630 金币
UID `MAG_LC_Wave_Trident` UUID `657678f2-5924-4d8e-b8ce-a2079154c91b` Stats `MAG_LC_Wave_Trident` ### 特殊

**持有此物品者获得：**

[求水得水](The_Water_Caller.md "求水得水")
命中时，施加[濡湿](Wet_(Condition).md "濡湿（状态）")，并在目标周围创造一个 ⁠2 米 / 7 英尺的[水](Water_(surface).md "水（地表）")地表。
...
集中攻击敌人的手部，可能迫使其丢弃所持武器。 (充能：[短休](Short_rest.md "短休")。)

## 获取地点

- [清账屋](The_Counting_House.md "清账屋") X: -711 Y: 882：在高安保险库4中
