...
[体](CON.md "体质")[检定](Saving_throw.md "豁免检定")（[骰子掷骰](DC.md "骰子掷骰") 13）

- 在[感知](WIS.md "感知")[豁免检定](Saving_throw.md "豁免检定")上具有[劣势](Disadvantage.md "劣势")，无法进行[反应](Reaction_(Resource).md "反应")，并且失去其[护甲等级](Armor_Class.md "护甲等级")的[敏捷](Dexterity.md "敏捷")加值。
- 如果盟友[协助](Help.md "协助")此生物，则移除该状态。

## 获取地点

- [月出之塔](Moonrise_Towers.md "月出之塔") X: -174 Y: -179：由主层的[罗阿·月光](Roah.md "罗阿·月光")出售
