...
`60933e69-c642-46e0-92ee-0e4353fc2adf` ###

属性

`CRE_Githyanki_Savarsh` **训练官凯斯克**是[第一幕](Act_One.md "第一幕")期间[伊雷珂养育间](Cr%C3%A8che_Y'llek.md "伊雷珂养育间")[教室](Cr%C3%A8che_Y'llek.md#Classroom "伊雷珂养育间")中的一名教官。

> “
>
> K'chakhi！你为什么一直犹豫？我的指令很清楚！
>
> „
...
凯斯克是一名残酷的监工，如果这意味着能让幸存者变得更坚强，他不惜杀死自己的学生。除非被队伍打断，否则他会对[青年瓦尔](Varrl.md "青年瓦尔")做出这种事，队伍可以介入拯救青年的生命，或者自己杀死这个孩子。

凯斯克坚信适者生存，并宣扬他在育儿和其他传统吉斯洋基哲学信条上的信念。

如果队伍在[找出遗物的秘密](Discover_the_Artefact's_Secrets.md "找出遗物的秘密")中进展足够远，他和他的学生会变得敌对。
...
目标获得20点[临时生命值](Temporary_Hit_Points.md "临时生命值")，并在失去临时生命值之前造成额外2d6[心灵](Psychic.md "心灵")伤害。
...
造成常规伤害，并可能造成[开放伤口](Gaping_Wounds_(Condition).md "开放伤口（状态）")，导致攻击时造成额外伤害。
...
消耗一个卓越骰子以增强一个友方生物的决心。它获得额外8点[临时生命值](Temporary_Hit_Points.md "临时生命值")。
...
凯斯克最多可以花费四个[卓越骰子](Battle_Master.md#Level_3 "战斗大师")用于[策略](Manoeuvres.md "策略")：
...
---
*Source: [Kethk](https://bg3.wiki/wiki/Kethk)*