...
对游侠[猎人印记](Hunter's_Mark.md "猎人印记")的目标造成额外1d6伤害。
...
`BoarCompanion_Summon_CompanionsBond` ###
...
`Companion_Boar_5` ## 变体 1

###

UID

`BoarCompanion_Summon_ExceptionalTraining` ###
...
`Companion_Boar_7` ## 变体 2

###

UID

`BoarCompanion_Summon_8` ###
...
`Companion_Boar_8` **野猪座**是通过[驯兽师](Beast_Master.md "驯兽师")的[野猪伙伴](Boar_Companion.md "野猪伙伴")能力召唤的[野猪](Boar.md "野猪")，是[游侠伙伴](Ranger's_Companion.md "游侠伙伴")的变体。当驯兽师达到5级时，野猪座会从[野猪座](Verres.md "野猪座")升级而来；当驯兽师达到11级时，会变成[灾祸豕](Verres_Calamitosus.md "灾祸豕")。
...
狂暴期间，你的近战攻击造成额外2+1d4⁠⁠[挥砍](Slashing.md "挥砍") _\[[参见注释](Rage_(Boar).md#Notes).md#Notes> "狂暴 (野猪)")\]_ 伤害，并且你处于[巨化](Enlarged_(Condition).md "巨化 (状态)") _\[[参见注释](Rage_(Boar).md#Notes).md#Notes> "狂暴 (野猪)")\]_ 状态。

你获得对物理伤害的[抗性](Resistance.md "抗性")，以及力量[检定](Checks.md "检定")和[豁免检定](Saving_throws.md "豁免检定")的[优势](Advantage.md "优势")。
...
随着游侠等级提升，野猪座也会成长，直到在11级时转变为[灾祸豕](Verres_Calamitosus.md "灾祸豕")：
...
- 野猪座拥有51[生命值](Hit_Points.md "生命值")（探索者难度下为102）和15[护甲等级](Armour_Class.md "护甲等级")。

---
*Source: [Verres Major](https://bg3.wiki/wiki/Verres_Major)*