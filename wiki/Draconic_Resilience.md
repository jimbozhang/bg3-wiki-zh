...
- 职业等级1：[龙族血脉](Draconic_Bloodline.md "龙族血脉")

生物使用：

- [艾丽丝·瑟里亚夏斯](Aelis_Siryasius.md "艾丽丝·瑟里亚夏斯")、[哈克拉格](Havkelaag.md "哈克拉格")、[克劳斯](Klaus.md "克劳斯")
...
- [魔法护甲](Mage_Armour_(Condition).md "魔法护甲（状态）")、龙族韧性、[无甲防御](Unarmoured_Defence_(Barbarian).md "无甲防御（野蛮人）")、[无甲防御](Unarmoured_Defence_(Monk).md "无甲防御（武僧）")和[树肤术](Barkskin_(Condition).md "树肤术（状态）")都会改变你的自然护甲，因此不会叠加。
- 如果你拥有多个此类效果，你只会获得提供最高[护甲等级](Armour_Class.md "护甲等级")的那个效果。
  - 只要在变形前没有在任何装备栏中装备护甲，龙族韧性在[荒野形态](Wild_Shape.md "荒野形态")中仍可生效。
  - 此效果仅对自然护甲等级低于13的形态有效。
