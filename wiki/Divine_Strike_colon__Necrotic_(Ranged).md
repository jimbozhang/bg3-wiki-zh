...
本文介绍远程版本。关于近战版本，请参见 [神圣打击：黯蚀（近战）](Divine_Strike_colon__Necrotic_(Melee)..md) 关于该特性的通用信息，请参见 [神圣打击](Divine_Strike.md "神圣打击")。

**神圣打击：黯蚀（远程）** 是 [死亡领域](Death_Domain.md "死亡领域") 牧师的武器动作和反应，可在远程武器攻击时造成额外的黯蚀伤害。
...
---
*Source: [Divine Strike: Necrotic (Ranged)](https://bg3.wiki/wiki/Divine_Strike:_Necrotic_(Ranged)*