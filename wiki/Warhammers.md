...
战锤是一种两用军用近战[武器](Weapons.md "武器")。以下是大多数战锤共有的基础属性，尽管特殊或魔法变体可能有显著差异。关于最常见的非魔法类型，请参阅[战锤](Warhammer.md "战锤")。在下方，您可以找到游戏中所有战锤的列表。
...
1d10 (1~10) + [力量调整值](Damage_Roll.md#Modifiers "伤害掷骰") ⁠[钝击](Bludgeoning.md "钝击")
...
| --- | --- | --- | --- | --- | --- | --- |
| [火矮人战锤](Azer_Warhammer.md "火矮人战锤") |  | 1d8 / 1d6 | 钝击 / 火焰 | 2.7 公斤 / 5.4 磅 | 0 | [过热](Overheat.md "过热") () 释放部分内在火焰。所有附近生物受到伤害并开始[灼烧](Burning_Fiercely_(Condition).md "灼烧（状态）")。 |
| [魔契战锤](Pactbound_Warhammer.md "魔契战锤") |  | 1d8 | 钝击 | 2.7 公斤 / 5.4 磅 | 0 |  |
| [战锤](Warhammer.md "战锤") |  | 1d8 | 钝击 | 2.7 公斤 / 5.4 磅 | 50 |  |
| [仪式战锤](Ceremonial_Warhammer.md "仪式战锤") | +1 | 1d8 + 1 | 钝击 | 2.7 公斤 / 5.4 磅 | 65 |  |
...
| [战锤 +2](Warhammer_+2.md "战锤 +2") | +2 | 1d8 + 2 | 钝击 | 2.7 公斤 / 5.4 磅 | 155 |  |
| [矮人投手](Dwarven_Thrower.md "矮人投手") | +2 | 1d8 + 2 | 钝击 | 2.7 公斤 / 5.4 磅 | 770 | [归巢武器](Homing_Weapon.md "归巢武器")此武器投掷后将返回持有者手中。[矮人投手](Dwarven_Thrower_(passive_feature).md "矮人投手（被动特性）")[矮人](Dwarf.md "矮人")投掷此战锤时造成额外 1d8⁠⁠[钝击](Bludgeoning.md "钝击")伤害。如果目标是大型、巨型或超巨型生物，攻击将造成额外 2d8⁠⁠[钝击](Bludgeoning.md "钝击")伤害。 |
| [俄耳甫斯之锤](Orphic_Hammer.md "俄耳甫斯之锤") | +3 | 1d8 + 3 | 钝击 | 2.7 公斤 / 5.4 磅 | 770 | [法术抗性](Spell_Resistance.md "法术抗性")您对法术的[豁免检定](Saving_throw.md "豁免检定")具有[优势](Advantage.md "优势")。[解缚打击](Unshackling_Strike.md "解缚打击") () 打击束缚生物的魔法锁链，使其[束缚](Restrained_(status_group).md "束缚（状态组）")、[麻痹](Paralyzed_(status_group).md "麻痹（状态组）")和[震慑](Stunned_(status_group).md "震慑（状态组）")状态解除，使其自由。 |

## 遗留内容

- [地狱战锤](Infernal_Warhammer.md "地狱战锤") - _[不可访问](Category_colon_Inaccessible.md "类别：不可访问")_
- [锈战锤](Rusty_Warhammer.md "锈战锤") - _[不可访问](Category_colon_Inaccessible.md "类别：不可访问")_

## 外部链接

- ⁠[战锤](https://forgottenrealms.fandom.com/wiki/Warhammer) 在 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page)

[￪ 返回顶部](#top)

---
*Source: [Warhammers](https://bg3.wiki/wiki/Warhammers)*