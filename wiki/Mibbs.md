...
`S_LOW_BaldursGate_FlamingFist_Ranger_001` ###

UUID

`08d0dcec-a5c3-4099-922c-2a0b8b97fcd6` ###

属性

`FlamingFist_Human_Ranger` **拳手“神射手”米布斯**是一名[人类](Human.md "Human")[游侠](Ranger.md "Ranger")，也是[焰拳](Flaming_Fist.md "Flaming Fist")的成员。他可以在[下城区](Lower_City.md "Lower City")的[第三幕](Act_Three.md "Act Three")中找到。
...
米布斯在[上城区大门检查点](Upper_City_Gate_Checkpoint.md "Upper City Gate Checkpoint")的桥远端站岗。他与[焰拳医师达博纳](Darbonna.md "Darbonna")和[焰拳格兰尼特达特](Granitdatter.md "Granitdatter")一起监视着试图进入[上城区](Upper_City.md "Upper City")的居民队列。然而，达博纳实际上已接到命令，不得让任何“未经授权”的人进入上城区。除了达博纳之外，周围所有人都不知道米布斯感染了[夺心魔蝌蚪](Mind_Flayer_Tadpole.md "Mind Flayer Tadpole")。
...
### 攻击与能力<sup>[\[3\]](#cite_note-3)</sup>

[备战（远程）](Brace_(Ranged).md "Brace (Ranged)") () – [重弩](Heavy_Crossbow.md "Heavy Crossbow")
消耗 6 米 (20 英尺) 的[移动](Movement_speed.md "Movement Speed")。在你的回合剩余时间内，掷两次远程伤害并取最高值。
...
你的攻击会召唤带刺藤蔓，可能\_(状态)[诱捕](Ensnared_(Ensnaring_Strike)_(Condition).md "Ensnared (Ensnaring Strike) (Condition)")你的目标。
...
[疾速齐射](Volley.md "Volley") () – [重弩](Heavy_Crossbow.md "Heavy Crossbow")
...
- ⁠[神射手米布斯](https://forgottenrealms.fandom.com/wiki/Deadeye_Mibbs) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page)

---
*Source: [Mibbs](https://bg3.wiki/wiki/Mibbs)*