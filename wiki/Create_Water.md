...
**造水术**是一个[法术](Spells.md "法术")。该法术是[造水/枯水术](Create_or_Destroy_Water.md "造水/枯水术")的一个变体，允许施法者召唤一片从稀薄空气中降下的雨水，并形成一片水地表。法术施放时处于该区域内的生物将变为[濡湿](Wet_(Condition).md "濡湿 (状态)")。
