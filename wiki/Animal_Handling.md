...
**驯兽**是一项基于[感知](Wisdom.md "感知")的[技能](Skills.md "技能")。

生物的感知属性越高，他们在处理动物时的驯兽[检定](Checks.md "检定")成功几率就越高。
...
在**驯兽**上**熟练**的角色在进行[属性检定](Ability_Check.md "属性检定")时可以添加其[熟练项加值](Proficiency_Bonus.md "熟练项加值")。

以下[背景](Backgrounds.md "背景")授予**驯兽**熟练项：

- [平民英雄](Folk_Hero.md "平民英雄")

以下职业可以在1级时选择将**驯兽**作为熟练技能：
...
[自然领域](Nature_Domain.md "自然领域")[牧师](Cleric.md "牧师")获得[自然侍僧](Acolyte_of_Nature.md "自然侍僧")，该特性授予**驯兽**熟练项。

## 用途

- 在未激活[动物交谈](Speak_with_Animals.md "动物交谈")时，用于与动物对话。

## 提升或惩罚的方法

提高或降低[感知](Wisdom.md "感知")也会通过每偶数个点提升/惩罚感知调整值（从而影响驯兽），最多上下浮动1点。
...
---
*Source: [Animal Handling](https://bg3.wiki/wiki/Animal_Handling)*