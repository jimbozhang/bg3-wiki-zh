...
如果[暗夜之歌](Aylin.md "Aylin")被释放，[竖琴手同盟](Harpers.md "Harpers")对月出之塔发起进攻，克里斯会被杀死，她的尸体可以在入口处的尸体堆中找到。

## 战斗

### 攻击与能力

[命令术：逃跑](Command_colon__Flee.md "Command: Flee") (+ )
...
保护一个生物免于死亡。下一次伤害将其生命值降至 0 时，它将保持意识并剩余 1 点生命值。

近战：1.5 米 (5 英尺)

[信仰守卫](Guardian_of_Faith.md "Guardian of Faith") (+ )
召唤一个[神圣守卫](Guardian_of_Faith_(creature)攻击附近的敌人.md)。每次造成伤害时，守卫会失去等量的[生命值](Hit_Points.md "Hit Points")。
...
[哈达之饥渴](Hunger_of_Hadar.md "Hunger of Hadar") (+ )
...
此黑色球体内的生物[目盲](Blinded_(Condition).md "Blinded (Condition)")，并在其回合结束和开始时受到伤害。

在区域内开始其回合的生物受到 2d6[寒冷](Cold.md "Cold")伤害。在区域内结束其回合的生物可能受到 2d6[强酸](Acid.md "Acid")伤害。

该区域为[劣势地形](Difficult_Terrain_(Condition).md "Difficult Terrain (Condition)")。
...
扫击一个生物以将其击至[倒伏](Prone_(Condition).md "Prone (Condition)")。

[敏捷](Dexterity.md "Dexterity") [豁免检定](Saving_throws.md "Saving throws")
范围：普通武器范围
重置：[短休](Short_rest.md "Short rest")
...
- ⁠[克里斯](https://forgottenrealms.fandom.com/wiki/Keris) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page)

---
*Source: [Keris](https://bg3.wiki/wiki/Keris)*