...
- 萨雷沃克永久处于[加速](Hastened_(Condition).md "加速 (状态)")状态，且不会被[麻痹](Paralysed_(Condition).md "麻痹 (状态)")、[束缚](Restrained_(Condition).md "束缚 (状态)")，其移动速度也不会以任何方式降低。
...
- 状态结束时，受影响的生物变为[力竭](Lethargic_(Condition).md "力竭 (状态)")，并在1回合内无法移动或进行[动作](Action.md "动作")。
