...
- 此状态可以通过[回生术](Revivify.md "回生术")、[回生术卷轴](Scroll_of_Revivify.md "回生术卷轴")、[完全复生术卷轴](Scroll_of_True_Resurrection.md "完全复生术卷轴")或通过[守墓人](Withers.md "守墓人")的服务，从[雇工](Hirelings.md "雇工")、玩家角色及其[伙伴](Companions.md "伙伴")身上移除。
  - 非玩家角色在死亡后无法被复活。
  - 通常，伙伴、临时伙伴和可玩角色可以被复活。然而，_如果他们尚未被招募，或者因游戏中的某些剧情线而死亡，则大多数无法被复活_。虽然不一定全面，但以下是已知的、对于可招募[伙伴](Companion.md "伙伴")角色而言死亡是永久的情况：
    ...
    - [卡菈克](Karlach.md "Karlach")作为威尔[任务线](The_Blade_of_Frontiers.md#Hunt_down_Karlach "边境之刃")的一部分，在被接纳入队前后被杀。
...
- 如果可玩角色或伙伴在[倒地](Downed_(Condition).md "倒地 (状态)")后未能通过三次[死亡豁免检定](Death_Saving_Throw.md "死亡豁免检定")，则会死亡。
- 如果非玩家生物因[伤害](Damage.md "伤害")而生命值降至零，且该伤害非[非致命](Non-Lethal_Damage_(Condition).md "非致命伤害 (状态)")，则会死亡。

## 备注

1. [↑](#cite_ref-1) 虽然游戏中从未明确说明盖尔因被邪念强行移除手而死亡，但如果发生这种情况，他将无法被招募，且在没有干预的情况下，因手被完全移除导致失血过多而死亡的可能性非常大。
