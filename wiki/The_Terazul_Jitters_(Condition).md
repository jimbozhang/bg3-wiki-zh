...
[堆叠 ID](Stack_ID.md "堆叠 ID"): `CONS_DRUG_STIMULANT` [状态组](Status_groups.md "状态组"): [SG_RemoveOnRespec](SG_RemoveOnRespec.md "SG RemoveOnRespec")
...
- 此效果等同于 [加速](Hastened_(Condition).md "加速 (状态)")，并且可以与其叠加。
