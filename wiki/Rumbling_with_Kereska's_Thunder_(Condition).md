...
| [克雷斯卡的火焰擒握](Gripped_by_Kereska's_Flame_(Condition).md "克雷斯卡的火焰擒握 (状态)") | 受影响实体对[火焰](Fire.md "火焰")伤害具有[抗性](Resistance.md "抗性")。其火焰法术造成的伤害等于其[熟练项加值](Proficiency_Bonus.md "熟练项加值")。当其造成法术伤害时，它获得2回合的[灼热](Heat_(Condition).md "灼热 (状态)")。当与克雷斯卡的火焰调谐时，它可以在一次[短休](Short_Rest.md "短休")内以3环施放一次[火球术术](Fireball.md "火球术术")和以5环施放一次[火墙术](Wall_of_Fire.md "火墙术")。 |
