...
- 当实体具有5回合或以上的残响时，它会受到1d4[雷鸣](Thunder.md "雷鸣")[伤害机制](Damage_rider_as_source.md "伤害机制")伤害，并且必须通过[掷骰](Dice_rolls.md#Save_DCs "掷骰") 10的[体质](Constitution.md "体质")[豁免检定](Saving_throw.md "豁免检定")，否则将[倒伏](Prone_(Condition).md "倒伏 (状态)")。之后状态将被移除。
