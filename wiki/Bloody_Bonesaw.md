...
**骨锯术**是[马鲁斯·索姆](Malus_Thorm.md "马鲁斯·索姆")的类动作之一，允许他用[骨锯](Bonesaw.md "骨锯")劈砍目标。他必须先让他的[汉娜姐妹](Sister_Hunna.md "汉娜姐妹")递给他工具。

## 描述

劈砍目标并可能使其[减速](Slowed_(Condition).md "减速（状态）")。
...
`Target_SurgeryAttack_Bonesaw_Surgeon`
...
---
*Source: [Bloody Bonesaw](https://bg3.wiki/wiki/Bloody_Bonesaw)*