...
从近战范围发动的弩攻击不会获得[劣势](Disadvantage.md "劣势")。
...
`S_CRE_HiddenCheckpointMainGuard` ###

UUID

`3bcbf8fb-5a90-4439-bd81-d9113d74f27e` ###

属性

`Githyanki_Raider` **掠夺者 G'r'ath** 是[审判官 W'wargaz](W'wargaz.md "W'wargaz")在[第一幕](Act_One.md "第一幕")期间抵达之前，伊雷珂养育间吉斯洋基社群的一名成员。
