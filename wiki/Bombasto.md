...
`S_LOW_Elfsong_Patron_006` ###

UUID

`b026b2d2-bd8a-4ca6-910d-03d23bfd637b` ###

属性

`LOW_Elfsong_Patron_Human_Barbarian` **伯姆巴托**是[博德之门3](Baldur's_Gate_3.md "博德之门3")中的人类角色。
...
伯姆巴托是[博德之门](Baldur's_Gate.md "博德之门")[下城区](Lower_City.md "下城区")的[精灵之歌酒馆](Elfsong_Tavern.md "精灵之歌酒馆")的顾客。他曾与[勾刀女爵](Dame_Guisarme.md "勾刀女爵")一起做过一些英雄事迹和恶作剧。
...
你的[狂暴](Rage_(Condition).md "狂暴 (状态)")变成了狂怒！你获得[狂怒攻击](Frenzied_Strike.md "狂怒攻击")和[愤怒投掷](Enraged_Throw.md "愤怒投掷")。你还可以作为附赠动作进行一次[即兴近战武器](Improvised_Melee_Weapon_(Bonus_Action).md "即兴近战武器 (附赠动作)")攻击。

使用近战和即兴武器以及投掷时，造成 2 点额外伤害。获得对[物理伤害](Physical_damage.md "物理伤害")的[抗性](Resistance.md "抗性")，以及在力量[检定](Checks.md "检定")和[豁免检定](Saving_throws.md "豁免检定")上具有[优势](Advantage.md "优势")。
...
不顾一切地进行近战[攻击掷骰](Attack_roll.md "攻击掷骰")，获得[优势](Advantage.md "优势")。

直到你的下一回合，你在攻击掷骰上具有优势，但敌人在攻击你时也具有优势。
...
- [巨斧](Greataxe.md "巨斧")
- [标枪](Javelin.md "标枪") - 2 把

## 备注

- 伯姆巴托和他的伙伴[勾刀女爵](Dame_Guisarme.md "勾刀女爵")可能是对 Vox Machina 的致敬，类似于侏儒牧师 Pike Trickfoot 和山丘巨人野蛮人 Grog Strongjaw。*Guisarme* 是一种中世纪长柄武器——或长矛。

---
*Source: [Bombasto](https://bg3.wiki/wiki/Bombasto)*