...
当使用你[重甲的](Proficient.md "Proficient")的近战武器并双手持握进行攻击时，[攻击掷骰](Attack_roll.md "Attack Roll")承受-5减值，但其伤害增加10。
...
`S_END_LastStandGuard_003` ###

UUID

`0e5ae266-ba26-48ac-9c2a-c9a461f1352d` ###

属性

`END_CityWatchMelee_Human` **卫兵 弗莱**是[第三幕](Act_Three.md "Act Three")中[上城区](Upper_City.md "Upper City")[卫士](City_Watch.md "City Watch")的一员。在[至高大殿](High_Hall.md "High Hall")的庭院被[绝对](Absolute.md "Absolute")的势力攻占后，他试图逃离。

> “
>
> 不确定我还能战斗多久，但我会尽力一搏。为了博德之门。
>
> „
...
挥动武器进行大范围弧线攻击，最多同时攻击3个敌人。他们各自承受你武器通常造成伤害的一半。
...
- 弗莱和其他有名有姓的卫兵的属性与通过[召集盟友](Gather_Your_Allies_(class_action).md "Gather Your Allies (class action)")动作[卫士](The_Watch.md "The Watch")召唤的[守望者卫士](Watcher_Guardian.md "Watcher Guardian")相同。
- 弗莱和其他有名有姓的卫兵的护甲外观类似于染成蓝色、棕色和黑色的[胸甲 +1](Breastplate_+1.md "Breastplate +1")，而不是为[卫士](City_Watch.md "City Watch")其他成员专门设计并看到的板甲。
  - 弗莱还戴着面罩掀起的[调节钢盔](Adjustable_Steel_Helm.md "Adjustable Steel Helm")。
...
---
*Source: [Fry](https://bg3.wiki/wiki/Fry)*