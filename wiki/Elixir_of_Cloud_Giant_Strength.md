...
云巨人力量灵药是一种[灵药](Elixir.md "Elixir")，食用后可增加[力量](Strength.md "Strength")。

将此溶液精确调角，可折射出黎明的色彩。

## 属性

- [灵药](Elixirs.md "Elixirs")
- 单次使用
- 稀有度：稀有
- 重量：0.1 千克 (0.2 磅)
- 价格：160 gp
- UID `OBJ_Potion_Of_Cloud_Giant_Strength` UUID `e6490cc8-7f81-4aac-95e8-a58ce5e88a31` Stats `OBJ_Potion_Of_Cloud_Giant_Strength` ### 效果

[附赠动作](Actions.md#Resources "Actions")

- 食用灵药，将你的[力量](Strength.md "Strength")提升至 27。
  - 饮用时会替换其他灵药的效果。

[动作](Actions.md#Resources "Actions")

- [投掷](Throw.md "Throw")灵药，使半径 1 米 (3 英尺) 内所有生物的[力量](Strength.md "Strength")提升。
...
- 通过[炼金术](Alchemy.md "Alchemy")合成，将[云巨人指甲盐](Salts_of_Cloud_Giant_Fingernails.md "云巨人指甲盐")（从[云巨人手指](Cloud_Giant_Finger.md "Cloud Giant Finger")获取）与任意[悬液](Alchemy.md#Extractions "Alchemy")结合
- 由任何拥有[灵药台](Elixir_Table.md "Elixir Table")或[药水台](Potion_Table.md "Potion Table")的商人出售，_起始等级为 9_；由于库存是半随机生成的，商人可能有 0 到 2 瓶：
  ...
  - [奥利弗·特福科](Oliver_Tefoco.md "Oliver Tefoco")在[下城区](Lower_City.md "Lower City")[蜂巢杂货铺](Beehive_General_Goods.md "Beehive General Goods")
...
- [至高大殿](High_Hall.md "High Hall")内[科尔](Koll_(kobold).md "Koll (kobold)")旁边，坐标 X: 235 Y: 45
  - [慈爱神殿地窖](Open_Hand_Temple_Cellar.md "Open Hand Temple Cellar")内的展示柜中，坐标 X: 8 Y: -1024（有 1/3 几率包含一瓶；其他选项为[极效奥术滋养灵药](Supreme_Elixir_of_Arcane_Cultivation.md "Supreme Elixir of Arcane Cultivation")或[心灵抗性灵药](Elixir_of_Psychic_Resistance.md "Elixir of Psychic Resistance")）
...
- ⁠[巨人力量药水](https://forgottenrealms.fandom.com/wiki/Potion_of_giant_strength) 在 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page)

---
*Source: [Elixir of Cloud Giant Strength](https://bg3.wiki/wiki/Elixir_of_Cloud_Giant_Strength)*