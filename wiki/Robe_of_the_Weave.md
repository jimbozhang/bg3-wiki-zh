...
- 必须使用[识破隐形](See_Invisibility.md "识破隐形")来揭示控制结界的拉杆。揭示后，每个角色有一次机会通过DC 20的[奥秘](Arcana.md "奥秘")[属性检定](Ability_Check.md "属性检定")来禁用它。如果他们的第一次尝试失败，陷阱会触发，然后必须由另一名队伍成员尝试以获得此物品。
