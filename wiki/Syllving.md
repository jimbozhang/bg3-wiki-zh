...
`S_LOW_SWS_Patrols_001_FF_001` ###

UUID

`15f6e3e7-8bb7-47af-b4bf-a15ddc18bdd0` ###

属性

`NPC_FlamingFist_Melee_Cleric` **焰拳医师塞尔文**是一名[矮人](Dwarf.md "矮人")治疗师，也是[焰拳](Flaming_Fist.md "焰拳")的成员。她可以在[下城区](Lower_City.md "下城区")的街道上找到，位于[第三幕](Act_Three.md "第三幕")。
...
在你的攻击中施加额外的力量，可能将你的敌人击至[倒伏](Prone_(Condition).md "倒伏 (状态)")。
...
[类人生物](Humanoids.md "类人生物")不能被[魅惑](Charmed_(Condition).md "魅惑 (状态)")、[恐慌](Frightened_(Condition).md "恐慌 (状态)")，或变得激怒。_\[[见：错误](Calm_Emotions.md#Bugs "安定心神")\]_
...
散发出神圣的力量，鼓舞你和附近的盟友。他们的武器攻击造成额外的1d4⁠⁠[光耀](Radiant.md "光耀")伤害。
...
---
*Source: [Syllving](https://bg3.wiki/wiki/Syllving)*