...
`RavenCompanion_Summon_CompanionsBond` ###
...
`Companion_Raven_5` ## 变体 1

###

UID

`RavenCompanion_Summon_ExceptionalTraining` ###
...
`Companion_Raven_7` ## 变体 2

###

UID

`RavenCompanion_Summon_8` ###
...
`Companion_Raven_8` **乌鸦座**是通过[驯兽师](Beast_Master.md "驯兽师")的[恐鸦伙伴](Dire_Raven_Companion.md "恐鸦伙伴")能力召唤的[渡鸦](Raven.md "Raven")，是[游侠伙伴](Ranger's_Companion.md "游侠伙伴")的变体。当驯兽师达到 5 级时，乌鸦座会从[乌鸦座](Corvus.md "乌鸦座")升级而来，并在驯兽师达到 11 级时变为[神速鸦](Corvus_Celer.md "神速鸦")。
...
随着游侠等级提升，乌鸦座也会成长，在 11 级时进化为[神速鸦](Corvus_Celer.md "神速鸦")：

#### 等级 7

- 乌鸦座获得被动特性[训练有素](Exceptional_Training.md "训练有素")，使其获得：
...
- 乌鸦座拥有 32 [生命值](Hit_Points.md "生命值")（探索者难度下为 64）和 19 [护甲等级](Armour_Class.md "护甲等级")。

---
*Source: [Corvus Major](https://bg3.wiki/wiki/Corvus_Major)*