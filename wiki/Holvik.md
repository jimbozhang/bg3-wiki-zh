...
对被[中毒](Poisoned_(Condition).md)的[豁免检定](Saving_throw.md "豁免检定")具有[优势](Advantage.md "优势")，且对[中毒](Poison.md "中毒")伤害具有[抗性](Resistance.md "抗性")。
...
`S_UND_LoneDuergar_Squad_Ranged` ###

UUID

`9c792a46-8a05-43fb-8efa-63d234dbcc6a` ###

属性

`UND_Duergar_Ranger` **霍尔威克**是陪同[格克·煤球](Gekh_Coal.md "格克·煤球")前往[第一幕](Act_One.md "第一幕")中[破败村落](Decrepit_Village.md "破败村落")的灰矮人之一。

> “
>
> 为了一个逃兵，半个小队都死了。_Gh'rack。_
>
> „
...
霍尔威克是格克·煤球特遣队的一员，任务是取回[军士长斯林](Elenna_Thrinn.md "军士长斯林")被盗的靴子。如果一名非[卓尔](Drow.md "卓尔")的队伍成员与他交谈，霍尔威克会对其伤亡表示厌恶，这些伤亡是由[蕈人](Myconid.md "蕈人")幻觉导致成员跳崖身亡造成的。
...
消耗 6 米 (20 英尺) 的[移动速度](Movement_speed.md "移动速度")。在你的回合剩余时间内，掷两次远程伤害并取最高值。
...
标记一个生物作为你的猎物，每次用武器攻击命中时造成额外 1d6⁠⁠[武器](Weapon.md "武器")伤害。
...
- [勒根](Lurgan.md "勒根")
- [复活的尸体](Reanimated_Corpse.md "复活的尸体") - 7 具，如果被格克复活

### 战利品

- [火焰箭](Arrow_of_Fire.md "火焰箭")（如果未使用）
- [闪电箭](Arrow_of_Lightning.md "闪电箭")（如果未使用）
...
---
*Source: [Holvik](https://bg3.wiki/wiki/Holvik)*