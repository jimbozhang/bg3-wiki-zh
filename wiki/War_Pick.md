...
关于装备类型，请参见 [战镐](War_Picks.md "战镐")。

**战镐**是 [战镐](War_Picks.md "战镐") 武器家族的常见变体。它是一种单手挥舞的 [武器](Weapons.md "武器")。

一种经过改造的十字镐，用于刺穿血肉和护甲，而非岩石。
...
重量：0.9 千克 (1.8 磅)
价格：50 金币
UID `WPN_HUM_Warpick_A_0` UUID `a088775a-8f75-42f2-aa74-76a3f80701fa` ### 武器动作
...
---
*Source: [War Pick](https://bg3.wiki/wiki/War_Pick)*