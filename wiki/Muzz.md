...
`S_WYR_OpenHand_Shifter_003` ###

UUID

`83bbacf9-5395-4420-b5de-5a112d598840` ###
...
`WYR_OpenHand_Doppelganger_003` ###

UUID

`20487fd4-90e9-4e7f-9b65-1ea3d12355b8` ###

属性

`HalfElf_Ranger` **玛兹**是在[第三幕](Act_Three.md "第三幕")中，位于[慈爱神殿](Open_Hand_Temple.md "慈爱神殿")下方的[神殿洞穴区域](Under_Temple_Cave_Area.md "神殿洞穴区域")中发现的一个[变形怪](Doppelganger.md "变形怪")。
...
玛兹和她的变形怪同伙应对多起谋杀案负责，包括[罗根神父](Lorgan.md "罗根神父")的谋杀案。她会与[佐姆](Zomm.md "佐姆")和[鲁德](Rudd.md "鲁德")一同在视线范围内发起攻击。
...
---
*Source: [Muzz](https://bg3.wiki/wiki/Muzz)*