...
- [2 长休](#long-rest)
  - [2.1 完全休息](#full-rest)
  - [2.2 部分休息](#partial-rest)
  - [2.3 长休的后果](#consequences-of-long-resting)
- [3 短休](#short-rest)
- [4 其他类型](#additional-types)

## 概述

休息可分为长休或短休。**长休**会恢复所有失去的生命值和消耗的资源，而**短休**则恢复有限的生命值和较少种类的资源。

## 长休

在营地开始长休

长休主要在[营地](Campsite.md "营地")进行。进行长休会度过一夜，并消耗40点（在硬核或荣誉难度下为80点，在自定义难度下最多120点）[营地补给](Camp_supplies.md "营地补给")。
...
- 生命值 - 最多恢复至其最大值的一半，向下取整
- 资源 - 最多恢复至角色最大值的一半，向下取整
...
- 冷却时间的刷新，包括物品和职业特性，如[休憩曲](Song_of_Rest.md "休憩曲")、[预兆](Portent.md "预兆")和大多数[灵吸怪威能](Illithid_powers.md "灵吸怪威能")
  - [幸运眷顾](Luck_of_the_Far_Realms.md "幸运眷顾")不会恢复，因为它消耗一种隐藏资源，该资源最大值为1，并且从一半向下取整为零（0）。

进行部分长休时，短休次数_不会_恢复。

### 长休的后果

许多[出身](Origin.md "出身")、[伙伴](Companions.md "伙伴")和[营地随从](Camp_Followers.md "营地随从")的互动会在长休时发生。长休也可以推进某些[时间敏感内容](Time-sensitive_activities.md "时间敏感内容")；此外，每个章节都有一些[任务](Quests.md "任务")会在长休时推进。

任何具有“持续时间：直至长休”的[临时增益](Temporary_bonuses.md "临时增益")都会结束。

[灵药](Elixirs.md "灵药")的任何效果都会结束。
...
- [深邃浅眠药水](Potion_of_Angelic_Reprieve.md "深邃浅眠药水")的作用相当于短休（此外还能恢复所有已消耗的和[法术位](Spell_Slot.md "法术位")），前提是消耗它的角色保持睡眠状态且不受干扰，持续2回合。
- [深邃沉眠药水](Potion_of_Angelic_Slumber.md "深邃沉眠药水")的作用相当于长休，前提是消耗它的角色保持睡眠状态且不受干扰，持续2回合。
- [神圣干预：光耀复苏](Divine_Intervention_colon__Opulent_Revival.md "神圣干预：光耀复苏")会恢复队伍，如同他们进行了长休，复活任何倒地的队伍成员，甚至可以在战斗中使用。然而，任何形式的神圣干预在整个游戏中每个角色只能使用一次。
- 使用在序幕中[鹦鹉螺](Nautiloid.md "鹦鹉螺")上或[第二章](Act_Two.md "第二章")的[夺心魔殖民地](Mind_Flayer_Colony.md "夺心魔殖民地")中、[第三章](Act_Three.md "第三章")[希望之邸](House_of_Hope.md "希望之邸")的[内室](Boudoir.md "内室")中，或同样在第三章的[至高大殿](High_Hall.md "至高大殿")中找到的[恢复站](Restoration.md "恢复站")，也会恢复队伍，如同他们进行了长休，_而不会_结束相关效果，如[神莓](Goodberry.md "神莓")或[灵药](Elixirs.md "灵药")。
