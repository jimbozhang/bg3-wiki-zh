...
这是《博德之门3》中所有[法术](Spells.md "Spells")的列表。

## 目录

- [1 戏法](#cantrips)
- [2 1环法术](#level-1-spells)
- [3 2环法术](#level-2-spells)
- [4 3环法术](#level-3-spells)
- [5 4环法术](#level-4-spells)
- [6 5环法术](#level-5-spells)
- [7 6环法术](#level-6-spells)
- [8 9环法术](#level-9-spells)
...
戏法是0环法术，施放时不需要消耗[法术位](Spells.md#Spell_Slots "Spells")。它们无法[升环施放](Spells.md#Upcasting "Spells")，但大多数造成伤害的戏法会在角色等级达到5级和10级时分别获得额外的伤害骰。
...
- [目盲](Colour_Spray.md "Colour Spray")

- [命令术](Command.md "Command")

- [强令对决](Compelled_Duel.md "Compelled Duel") * [造水/枯水术](Create_or_Destroy_Water.md "Create or Destroy Water")

- [疗伤术](Cure_Wounds.md "Cure Wounds")
...
- [羽落术](Feather_Fall.md "Feather Fall") *[获得魔宠](Find_Familiar.md "Find Familiar")* [雾隐术](Fog_Cloud.md "Fog Cloud") * [浆果术](Goodberry.md "Goodberry")
...
- [大步奔行](Longstrider.md "Longstrider") * [魔法护甲](Mage_Armour.md "Mage Armour")

- [魔法飞弹](Magic_Missile.md "Magic Missile")

- [防护善恶](Protection_from_Evil_and_Good.md "Protection from Evil and Good") * [疾病射线](Ray_of_Sickness.md "Ray of Sickness")

- [庇护术](Sanctuary.md "Sanctuary")
...
- [巫术爆击](Witch_Bolt.md "Witch Bolt") * [激愤斩](Wrathful_Smite.md "Wrathful Smite")

## 2环法术

- **2环法术**是施放时消耗2环[法术位](Spells.md#Spell_Slots "Spells")的法术。
...
- [炽焰法球](Flaming_Sphere.md "Flaming Sphere") * [造风术](Gust_of_Wind.md "Gust of Wind")
...
- [镜像术](Mirror_Image.md "Mirror Image")

- [迷踪步](Misty_Step.md "Misty Step")

- [月华之光](Moonbeam.md "Moonbeam") *[行动无踪](Pass_Without_Trace.md "Pass Without Trace")* [魅影之力](Phantasmal_Force.md "Phantasmal Force") * [治疗祷言](Prayer_of_Healing.md "Prayer of Healing")

- [防护毒素](Protection_from_Poison.md "Protection from Poison")

- [衰弱射线](Ray_of_Enfeeblement.md "Ray of Enfeeblement") * [灼热射线](Scorching_Ray.md "Scorching Ray")

- [识破隐形](See_Invisibility_(spell).md "See Invisibility (spell)")
...
- **3环法术**是施放时消耗3环[法术位](Spells.md#Spell_Slots "Spells")的法术。
...
- [给予飞行](Grant_Flight.md "Grant Flight") *[加速术](Haste.md "Haste")* [哈达之饥渴](Hunger_of_Hadar.md "Hunger of Hadar") *[催眠图纹](Hypnotic_Pattern.md "Hypnotic Pattern")* [闪电箭](Lightning_Arrow.md "Lightning Arrow")

- [闪电束](Lightning_Bolt.md "Lightning Bolt")

- [群体治愈真言](Mass_Healing_Word.md "Mass Healing Word")

- [植物滋长](Plant_Growth.md "Plant Growth")

- [防护能量伤害](Protection_from_Energy.md "Protection from Energy") * [移除诅咒](Remove_Curse.md "Remove Curse")
...
- **4环法术**是施放时消耗4环[法术位](Spells.md#Spell_Slots "Spells")的法术。

- [放逐术](Banishment.md "Banishment") * [枯萎术](Blight.md "Blight")

- [困惑](Confusion.md "Confusion") * [召唤初级元素生物](Conjure_Minor_Elemental.md "Conjure Minor Elemental")

- [召唤林地妖精](Conjure_Woodland_Being.md "Conjure Woodland Being")

- [死亡防护](Death_Ward.md "Death Ward")

- [任意门](Dimension_Door.md "Dimension Door")

- [支配野兽](Dominate_Beast.md "Dominate Beast") *[艾伐黑触手](Evard's_Black_Tentacles.md "Evard's Black Tentacles")* [火焰护盾](Fire_Shield.md "Fire Shield")

- [行动自如](Freedom_of_Movement.md "Freedom of Movement")

- [贪婪藤蔓](Grasping_Vine.md "Grasping Vine")

- [高等隐形术](Greater_Invisibility.md "Greater Invisibility") * [信仰守卫](Guardian_of_Faith.md "Guardian of Faith")
...
- **5环法术**是施放时消耗5环[法术位](Spells.md#Spell_Slots "Spells")的法术。

- [放逐打击](Banishing_Smite.md "Banishing Smite")

- [死云术](Cloudkill.md "Cloudkill") * [寒冰锥](Cone_of_Cold.md "Cone of Cold")

- [召唤元素生物](Conjure_Elemental.md "Conjure Elemental")

- [疫病术](Contagion.md "Contagion")

- [战略课程：战争艺术](Curriculum_of_Strategy_colon__Artistry_of_War.md "Curriculum of Strategy: Artistry of War")

- [湮灭波](Destructive_Wave.md "Destructive Wave")

- [废黜](Dethrone.md "Dethrone")

- [反制善恶](Dispel_Evil_And_Good.md "Dispel Evil And Good") *[支配人类](Dominate_Person.md "Dominate Person")* [焰击术](Flame_Strike.md "Flame Strike")

- [高等复原术](Greater_Restoration.md "Greater Restoration")

- [怪物定身术](Hold_Monster.md "Hold Monster") *[虫群瘟疫](Insect_Plague.md "Insect Plague")* [群体疗伤术](Mass_Cure_Wounds.md "Mass Cure Wounds")

- [异界誓缚](Planar_Binding.md "Planar Binding") * [伪装术](Seeming.md "Seeming")

- [心灵遥控](Telekinesis.md "Telekinesis") * [石墙术](Wall_of_Stone.md "Wall of Stone")

## 6环法术

- **6环法术**是施放时消耗6环[法术位](Spells.md#Spell_Slots "Spells")的法术。

- [秘法门](Arcane_Gate.md "Arcane Gate") *[剑刃屏障](Blade_Barrier.md "Blade Barrier")* [链状闪电](Chain_Lightning.md "Chain Lightning")

- [死亡法阵](Circle_of_Death.md "Circle of Death")

- [唤起死灵](Create_Undead.md "Create Undead")

- [崩溃](Disintegrate.md "Disintegrate")

- [噬眼术](Eyebite.md "Eyebite") *[石化术](Flesh_to_Stone.md "Flesh to Stone")* [法术无效结界](Globe_of_Invulnerability.md "Globe of Invulnerability") * [伤害术](Harm.md "Harm")

- [治愈术](Heal.md "Heal")

- [英雄盛宴](Heroes'_Feast.md "Heroes' Feast")

- [欧提路克冰封法球](Otiluke's_Freezing_Sphere.md "Otiluke's Freezing Sphere")

- [奥图迷舞](Otto's_Irresistible_Dance.md "Otto's Irresistible Dance") * [异界誓盟](Planar_Ally.md "Planar Ally")

- [博览喜乐廷：召唤使徒](Sights_of_the_Seelie_colon__Summon_Deva.md "Sights of the Seelie: Summon Deva")

- [阳炎射线](Sunbeam.md "Sunbeam") *[冰墙](Wall_of_Ice.md "Wall of Ice")* [棘墙术](Wall_of_Thorns.md "Wall of Thorns") * [御风而行](Wind_Walk.md "Wind Walk")

## 9环法术

- 这些是仅限[非玩家角色](Non-player_characters.md "Non-Player Characters")或通过独特任务解锁的特殊法术。

- [巴尔的律令死亡仪式](Bhaal's_Power_Word_Kill_Ritual.md "Bhaal's Power Word Kill Ritual")

- [巴尔律令死亡](Power_Word_Kill.md "Power Word Kill")
...
- [神圣狂欢](Divine_Revelry.md "Divine Revelry")

## 特殊NPC法术

- 这些是仅限[非玩家角色](Non-player_characters.md "Non-Player Characters")的特殊法术。

- [元素叱喝](Elemental_Retort.md "Elemental Retort")

- [死亡一指](Finger_of_Death.md "Finger of Death")

- [地狱火球术](Hellfire_Orb.md "Hellfire Orb")

- [焚灭术](Incinerate.md "Incinerate")
...
- [附身术](Possession.md "Possession")

- [财富承诺](Promise_of_Wealth.md "Promise of Wealth")

- [撤销访客身份](Revoke_Guest_Status.md "Revoke Guest Status")

- [呓语护盾](Shield_of_Screams.md "Shield of Screams")

- [召唤镶金地狱野猪](Summon_Gilded_Hellsboar.md "Summon Gilded Hellsboar")

- [潜水器传送](Teleport_to_Submersible.md "Teleport to Submersible")
...
- 这些是装备特定魔法[物品](Items.md "Items")时获得的特殊法术。

- [召唤黑暗](Beckoning_Darkness.md "Beckoning Darkness")

- [标点弱点](Brand_the_Weak.md "Brand the Weak")

- [决斗挑战](Challenge_to_Duel.md "Challenge to Duel")

- [死亡之舞](Danse_Macabre.md "Danse Macabre")

- [龙族元素武器](Draconic_Elemental_Weapon.md "Draconic Elemental Weapon")

- [元素年代](Elemental_Age.md "Elemental Age")

- [诱捕绳索](Ensnaring_Strands.md "Ensnaring Strands")

- [劝诫复生者](Exhort_the_Risen.md "Exhort the Risen")

- [获得魔宠：顽皮夸塞魔](Find_Familiar_colon__Cheeky_Quasit.md "Find Familiar: Cheeky Quasit")

- [血肉成金](Flesh_to_Gold.md "Flesh to Gold")

- [亡者哀嚎](Howl_of_the_Dead.md "Howl of the Dead")
...
- [防护飞弹](Protection_from_Missiles.md "Protection from Missiles")

- [恐惧射线](Ray_of_Fear.md "Ray of Fear")

- [攀云步](Ride_the_Winds.md "Ride the Winds")

- [塞伦涅的梦境](Sel%C3%BBne's_Dream.md "Selûne's Dream")

- [破影利刃](Shadow_Blade.md "Shadow Blade")

- [莎尔神盾](Shar's_Aegis.md "Shar's Aegis")

- [博览喜乐廷：召唤使徒](Sights_of_the_Seelie_colon__Summon_Deva.md "Sights of the Seelie: Summon Deva")

- [召唤渡鸦科斯](Summon_Quothe_the_Raven.md "Summon Quothe the Raven") * [致伤射线](Wounding_Ray.md "Wounding Ray")

## 另见

- [所有法术列表（可排序）](List_of_all_spells_(sortable).md)
- [未实装法术](Unimplemented_spells.md "Unimplemented spells")
...
---
*Source: [List of all spells](https://bg3.wiki/wiki/List_of_all_spells)*