...
`S_LOW_CountingHouse_Guard_11` ###

UUID

`b2e920a0-0ca6-463c-beed-6fee81a6bb0b` ###

Stats

`LOW_CountingHouse_Melee_Human` **现金守卫打手 维琪** ，是位于 [博德之门](Baldur's_Gate.md "博德之门") [下城区](Lower_City.md "下城区") [清账屋](The_Counting_House.md "清账屋") 的现金守卫中的一名人类成员。她可以在禁区外的码头巡逻时找到。
...
唤起一道天界闪光，并可能使目标 \_(状态)[目盲](Blinded_(Blinding_Smite)_(Condition).md "目盲 (致盲斩) (状态)")
...
你的武器造成额外的 2d8⁠⁠[光耀](Radiant.md "光耀")[DRS](Damage_rider_as_source.md "伤害来源") 伤害，当攻击 [邪魔](Fiends.md "邪魔") 或 [不死生物](Undead.md "不死生物") 时，该伤害增加 1d8⁠⁠[光耀](Radiant.md "光耀")。
...
- [头盔](Helmet.md "头盔")
- [保险库钥匙](Vault_Key_(item).md "保险库钥匙 (物品)")
...
- ⁠[维琪](https://forgottenrealms.fandom.com/wiki/Vikki) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page)

---
*Source: [Vikki](https://bg3.wiki/wiki/Vikki)*