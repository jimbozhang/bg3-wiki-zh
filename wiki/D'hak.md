...
`S_CRE_CaptainsBeast02` ###

UUID

`fcd64862-67ba-4358-9636-09ff9545177a` ###

Stats

`CRE_Githyanki_Captain_Wolf` **达'哈克**是[伊雷珂养育间](Cr%C3%A8che_Y'llek.md "Crèche Y'llek")中的一匹[狼](Wolf.md "Wolf")，出现在[第一幕](Act_One.md "Act One")。
...
轻咬一个目标并使其分心。如果你的攻击命中，2 米 (7 英尺) 内对目标的下一次攻击将造成[重击](Critical_Hit.md "Critical Hit")。
...
---
*Source: [D'hak](https://bg3.wiki/wiki/D'hak)*