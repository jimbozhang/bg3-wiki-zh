...
阿尔弗的宅邸是一座大型两层建筑，位于 X: 11 Y: -95，穿过主干道后立即进入利文顿。或者，也可以从 X: 26 Y: -100 和 X: 1 Y: -77 的侧路接近宅邸的入口。

房子有两个入口：正门处其主人正与一户难民家庭陷入争吵（见下文），以及 X: 20 Y: -78 处小露台上的门，如果小心接近，可以利用此门调查房屋内部而不卷入冲突。

宅邸是[阿尔弗·格雷戈里奥](Arfur_Gregorio.md "阿尔弗·格雷戈里奥")的家，他是一位富商，返回利文顿时发现自己的领地被非法占用者占据。当队伍接近时，会触发过场动画，阿尔弗试图借助一小群名为_利文顿鼠帮_的土匪来解决情况，他雇佣了这群土匪来守卫他的商队货物。

### 与非法占用者的冲突

抵达时，队伍会发现阿尔弗正与非法占用者家庭的家长[本·戈莱维茨](Ben_Golewits.md "本·戈莱维茨")争吵，威胁要借助利文顿鼠帮的帮助强行驱逐他们，该帮派由[泽诺维娅·道格](Zenovia_Dawg.md "泽诺维娅·道格")领导。

队伍有多种解决冲突的选项，需要进行各种[属性检定](Ability_Check.md "属性检定")。特定对话选项和检定难度取决于玩家角色的[职业](Class.md "职业")。他们也可以尝试通过[侦测思想](Detect_Thoughts.md "侦测思想")或事先调查建筑来查明阿尔弗为何如此急于驱逐难民。

如果队伍说服商人让难民留下，他们还必须站出来对抗对干涉此事不满的土匪。队伍可以花钱打发走这些暴徒，或[威吓](Intimidation.md "威吓")他们离开。

如果队伍成功读取了阿尔弗的思想，或调查了宅邸（尤其是地下室），他们可以尝试就此审问他。在这种情况下（以及[侦测思想](Detect_Thoughts.md "侦测思想")检定失败时）<sup>[\[1\]](#cite_note-1)</sup>，阿尔弗会立即支付泽诺维娅所要求的额外金钱，并与利文顿鼠帮开始战斗。如果在开始对话前预先扒窃阿尔弗的金币，可以避免这场战斗。如果阿尔弗身上没有钱，泽诺维娅和她的暴徒会离开，但这种结果会使冲突悬而未决。

以某种方式解决冲突可能获得以下一项或多项激励点：

- ⁠[行使审判](Noble.md#Exerting_Judgement "贵族")（[贵族](Noble.md "贵族")背景）- 无论以何种方式结束冲突<sup>[\[2\]](#cite_note-2）
- ⁠[拾者得之](Urchin.md#Finders_Keepers "流浪儿")</sup>（[流浪儿](Urchin.md "流浪儿")背景）- 支持非法占用者
- ⁠[多数之需](Acolyte.md#Needs_of_the_Many "侍僧")（[侍僧](Acolyte.md "侍僧")背景）- 如果说服阿尔弗让他们留下
- ⁠[确保款待](Folk_Hero.md#Securing_Hospitality "平民英雄")（[平民英雄](Folk_Hero.md "平民英雄")背景）- 拯救非法占用者免遭驱逐

提出以低于利文顿鼠帮要求的价格驱逐非法占用者，会为具有[罪犯](Criminal.md "罪犯")背景的角色获得激励点[供需法则](Criminal.md#Supply_and_Demand "罪犯")。

试图将非法占用者家庭赶出宅邸（无论检定结果如何），对于[古贤之誓](Oath_of_the_Ancients.md "古贤之誓")和[奉献之誓](Oath_of_Devotion.md "奉献之誓")的[圣武士](Paladin.md "圣武士")来说，如果由圣武士角色与本谈论此事，则被视为[破誓行为](Paladin.md#Oaths_and_Oathbreaking "圣武士")。

### 宅邸内部

宅邸内部有三层：带大厅、厨房和工作室的底层；带阿尔弗卧室的上层；以及地下室。
