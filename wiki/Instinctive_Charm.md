...
**直觉魅惑**是[惑控学派](Enchantment_School.md "惑控学派")法师的被动特性和反应，能够魅惑攻击者，中断并阻止攻击。如果目标成功通过[感知](Wisdom.md "感知")[豁免检定](Saving_throw.md "豁免检定")，则在[长休](Long_Rest.md "长休")之前无法再次受到影响。

## 描述

[魅惑](Charmed_(Condition).md "魅惑（状态）")攻击你的敌人。如果可能，他们将作为反应攻击新目标。_\[[参见注释](#notes)\]_
...
- 在[长休](Long_Rest.md "长休")之前，无法受到直觉魅惑的影响。

## 如何习得

职业：

- 职业等级 6：[惑控学派](Enchantment_School.md "惑控学派")

## 注释

- 一般规则是，生物对来自与之处于主动战斗中的敌人的魅惑效果进行豁免检定时具有[优势](Advantage.md "优势")。因此，此动作的豁免检定总是以优势进行。
- 此反应的工作方式如下：
...
- 直觉魅惑中断敌人攻击的方式与[法术反制](Counterspell.md "法术反制")非常相似，只是它适用于以惑控法师为目标的攻击。它甚至使用与法术反制相同的动画、视觉效果和声音。

---
*Source: [Instinctive Charm](https://bg3.wiki/wiki/Instinctive_Charm)*