...
利文顿综合商店是一家武器和护甲商店，位于[终末马戏团](Circus_of_the_Last_Days.md "终末马戏团")对面，主入口位于 X: 3 Y: -31，在[阿尔弗的宅邸](Arfur's_Mansion.md "阿尔弗的宅邸")以北。该商店实际上由两栋建筑组成，通过一个位于高石铺平台上的大型露天锻炉连接，该平台适应了地面逐渐升高的坡度。

店主兼大师铁匠[吉尔德罗·角铁](Gyldro_Angleiron.md "吉尔德罗·角铁")的房子位于锻炉附近，是一栋单层建筑，带有一个巨大的地下地窖（见下文）；其通往锻炉的门位于 X: -1 Y: -56。商店由开朗的龙裔[埃克维凯普](Exxvikyap.md "埃克维凯普")监督，是一栋两层建筑，其上层在 X: -4 Y: -42 处通向锻炉。

尽管商店内放置了多块赞美黑板，但展架和展示柜中的大多数武器都很普通，只有几件不常见物品（所有武器都带有红色轮廓）。上层 X: 7 Y: -33 处有一个未上锁的木箱，里面有一些金币。

露天锻炉有两条石阶通往街道，分别位于 X: -15 Y: -50 和 X: -9 Y: -49 的后方小径。

### 互动

吉尔德罗·角铁是可能被[腥红奥林](Flaming_Fist_Sergeant.md "奥林")选中作为伪装来威胁小队的角色之一。<sup>[\[1\]](#cite_note-1)</sup> 如果吉尔德罗被冒充，他最终无法存活下来向除小队之外的任何人讲述他的经历，他的尸体稍后可以在[下城区](Lower_City.md "下城区")的[巴尔神殿](Bhaal_Temple.md "巴尔神殿")中找到。
...
当小队首次接近洞口时，会进行一次被动 DC 15 的[求生](Survival.md "求生")[检定](Ability_Check.md "属性检定")。成功则会注意到通往洞穴的小脚印。<sup>[\[3\]](#cite_note-3)</sup>
...
- 两名难民，[阿纳·雅各布森](Arne_Jacobson.md "阿纳·雅各布森")和[贝隆·强步](Belron_Strongstep.md "贝隆·强步")正在讨论进入博德之门的可能选择。贝隆抱怨守卫要求高额贿赂才允许进入，但尽管如此，他禁止阿诺典当他妻子（似乎已故）的戒指来凑齐所需的钱。
- 两名博德人，[盖特林](Gethin.md "盖特林")和[伊万](Iwan.md "伊万")在调侃为维持难民秩序而组织的民兵。伊万的孩子[瑞特](Rhett.md "瑞特")渴望参加巡逻。
...
1. [↑](#cite_ref-1) 这可以通过右键点击角色并选择“检视”来确定。如果奥林伪装成吉尔德罗，该角色为12级，她的被动特性会替换其页面信息框中显示的特性。
1. [↑](#cite_ref-2) 回答奥林关于杀死亲近之人的提问时，互动的小队成员必须选择“*也许吧。如果别无选择*”这一行。此问题的其他可能答案没有“*WYR_OrinsImpersonation_DescribedPerfectWeapon*”标签（对话文件 Wyrm/WYR_OrinsImpersonation_SmithOrin）。
1. [↑](#cite_ref-3) 属于幽暗地域种族的角色，即[卓尔](Drow.md "卓尔")、[灰矮人](Duergar.md "灰矮人")或[地底侏儒](Deep_Gnome.md "地底侏儒")，会明确无误地认出这些是地底侏儒的脚印。
1. ↑ [4.0](#cite_ref-backup_4-0) [4.1](#cite_ref-backup_4-1) 只有在[第一幕](Act_1.md "第一幕")和[第二幕](Act_2.md "第二幕")中仅有两名铁手侏儒幸存时才能遇到。
1. [↑](#cite_ref-5) 由乌尔布伦提供，或从他的桌子上偷走
1. [↑](#cite_ref-6) 在角铁地窖 X: -241 Y: -1078 的架子附近有2个
1. [↑](#cite_ref-7) 至少8个（在角铁地窖中）
1. [↑](#cite_ref-8) 在角铁地窖中有3个
1. [↑](#cite_ref-9) 在角铁地窖的腐烂桶内有5个
