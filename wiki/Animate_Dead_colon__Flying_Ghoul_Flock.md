...
**操纵死尸：飞行食尸鬼群**是一个[6级死灵学派法术](Spells.md "法术")。该法术是[操纵死尸：飞行食尸鬼](Animate_Dead_colon__Flying_Ghoul.md "操纵死尸：飞行食尸鬼")的更高等级版本，可以召唤3个[飞行食尸鬼](Flying_Ghoul.md "飞行食尸鬼")，而不是1个。相应地，使用者也必须为此法术指定3具尸体，而不是1具。

## 描述

创造3个擅长近战的[飞行食尸鬼](Flying_Ghoul.md "飞行食尸鬼")。
...
`Target_AnimateDead_FlyingGhoul_6`
...
---
*Source: [Animate Dead: Flying Ghoul Flock](https://bg3.wiki/wiki/Animate_Dead:_Flying_Ghoul_Flock)*