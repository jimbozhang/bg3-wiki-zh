...
你的[先攻](Initiative.md "先攻")获得 +2 加值。
...
`CRE_Githyanki_Captain` **凯斯拉克百夫长赛泽恩**是[伊雷珂养育间](Cr%C3%A8che_Y'llek.md "伊雷珂养育间")的指挥官，位于[第一幕](Act_One.md "第一幕")。

> “
>
> 一个伊斯提克。在我的养育间里。你是被派来运送武器的雇佣兵之一吗？
>
> „
...
凯斯拉克百夫长赛泽恩位于[队长办公区](Cr%C3%A8che_Y'llek.md#Captain's_Quarters "伊雷珂养育间")，坐标 X: 1409 Y: -765。尽管军衔很高，但初次遭遇时她缺乏与其地位相称的自信，因为[审判官 W'wargaz](W'wargaz.md "审判官 W'wargaz")的存在给她带来了巨大压力，要求她找到[维拉基斯](Vlaakith.md "维拉基斯")正在追捕的[神秘遗物](Mysterious_Artefact.md "神秘遗物")。

赛泽恩携带[吉斯碎片](Gith_Shard.md "吉斯碎片")，该碎片可开启通往审判官房间的路径。因此，队伍最终必须从她手中夺回碎片以完成多个任务。

队伍可以提议向百夫长展示遗物，或通过[欺瞒](Deception.md "欺瞒")[属性检定](Ability_Check.md "属性检定")隐藏其存在。如果队伍试图将遗物交给她，赛泽恩会自愿打开通往审判官房间的屏障。如果队伍隐瞒信息，则可以通过扒窃或杀死队长并从其尸体上搜刮来获得碎片。
...
敌对目标丢下一切并变得[恐惧](Fearful_(Condition).md "恐惧 (状态)")：他们在[属性检定](Ability_Check.md "属性检定")和[攻击掷骰](Attack_roll.md "攻击掷骰")上具有[劣势](Disadvantage.md "劣势")。
...
撕裂敌人的身体和灵魂，造成额外的⁠[心灵](Psychic.md "心灵")伤害，伤害值等于你的[熟练项加值](Proficiency_Bonus.md "熟练项加值")，并可能[震慑](Stunned_(Condition).md "震慑 (状态)")他们。
...
- ⁠[赛泽恩](https://forgottenrealms.fandom.com/wiki/Therezzyn) 于 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page)

---
*Source: [Therezzyn](https://bg3.wiki/wiki/Therezzyn)*