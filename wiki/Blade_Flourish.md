...
- _仅当攻击命中时才会消耗吟游诗人激励点数。_

- 挥砍华舞对两个目标分别进行攻击掷骰，而非一次掷骰同时攻击两个目标。

- **挥砍华舞（远程）** 允许你使用[魔法飞弹](Magic_Missile.md "魔法飞弹")的瞄准系统选择两个目标。

- **挥砍华舞（近战）** 执行劈砍并命中2个目标。

- 两种移动华舞的传送均使用标准移动距离。

  - 要进行传送，你需要保留6米（20英尺）的移动距离，加上推击前你与目标的距离。

---
*Source: [Blade Flourish](https://bg3.wiki/wiki/Blade_Flourish)*