...
关于魔法学派，请参见[惑控学派（学派）](Enchantment_(school).md "惑控学派")。关于[法师](Wizard.md "法师")子职业，请参见[惑控学派](Enchantment_School.md "惑控学派")。

**附魔**是强大魔法 [武器](Weapon.md "Weapon") 和 [护甲](Armour.md "Armour") 的一种属性，可提升其在战斗中的基础效果。附魔数值范围从 +1 到 +5。

具有附魔数值的物品至少为精良稀有度。一些魔法武器和护甲——尤其是那些具有名称和历史的——除了各种可能的物品特定属性外，还具有附魔数值。

## 武器附魔

**武器附魔**为 [攻击掷骰](Attack_roll.md "Attack Roll") 和 [伤害掷骰](Damage_Roll.md "Damage Roll") 提供等于附魔数值的加值。
...
**护甲附魔**将护甲的基础 [护甲等级](Armour_Class.md "Armour Class") 提升等于附魔数值的数值。例如，一件普通的 [皮甲](Leather_Armour.md "Leather Armour") 的基础护甲等级为 11。一件 [皮甲 +1](Leather_Armour_+1.md "Leather Armour +1") 将该基础护甲等级提升至 12。

此外，+1 附魔护甲根据其类型具有额外的被动效果，而 +2 附魔护甲获得第二个被动效果。
