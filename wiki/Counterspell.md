...
**法术反制**是一个[3环防护学派法术](Spells.md "法术")。它允许施法者打断另一位施法者的施法，使其失败且没有任何效果。

## 描述

尝试阻止一个正在施放的法术。

如果该法术的环级高于你用于[法术反制](Counterspell.md "法术反制")的法术位环级，你必须使用你的[施法关键属性](Ability_Check.md "属性检定")进行一次[检定](#notes)来阻止它。检定的难度等于10加上你试图反制的法术环级。
