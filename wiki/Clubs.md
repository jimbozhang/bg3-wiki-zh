...
短棒是一种单手持用的简易近战[武器](Weapons.md "武器")。以下列出了大多数短棒共有的基础属性，但特殊或魔法变体可能有显著差异。关于此武器最常见的非魔法类型，请参阅[短棒](Club.md "短棒")。在下方，您可以找到游戏中所有短棒的列表。

## 目录

- [1 属性](#properties)
  - [1.1 动作](#actions)
- [2 短棒列表](#list-of-clubs)
...
- [执法者短棒](Enforcer_Club.md "执法者短棒") - _[无法访问](Category_colon_Inaccessible.md "分类：无法访问")_

## 外部链接

- ⁠[短棒](https://forgottenrealms.fandom.com/wiki/Club) 位于 [被遗忘的国度Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page)

[￪ 返回顶部](#top)

---
*Source: [Clubs](https://bg3.wiki/wiki/Clubs)*