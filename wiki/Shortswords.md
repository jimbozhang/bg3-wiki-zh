...
短剑是一种单手军用近战[武器](Weapons.md "武器")。以下是大多数短剑共有的基础属性，尽管特殊或魔法变体可能有显著差异。关于该武器最常见的非魔法类型，请参阅[短剑](Shortsword.md "短剑")。在下方，您可以找到游戏中所有短剑的列表。
...
1d6 (1~6) + [力量或敏捷调整值](Damage_Roll.md#Modifiers "伤害掷骰") ⁠[穿刺](Piercing.md "穿刺")
...
| [短剑（尤格）](Shortsword_(Yurgir).md "短剑（尤格）") |  | 2d4 | 穿刺 | 0.9 kg / 1.8 lb | 16 | 类人生物不可用。 |
| [刺客短剑](Assassin's_Shortsword.md "刺客短剑") | +1 | 1d6 + 1 | 穿刺 | 0.9 kg / 1.8 lb | 65 | [隐匿](Stealth.md "隐匿")检定具有[优势](Advantage.md "优势")。 |
| [吉斯洋基短剑 (+1)](Githyanki_Shortsword_(+1).md "吉斯洋基短剑 (+1)") | +1 | 1d6 + 1 | 穿刺 | 0.9 kg / 1.8 lb | 40 |  |
| [心体裁决者](Render_of_Mind_and_Body.md "心体裁决者") | +1 | 1d6 + 1 | 穿刺 | 0.9 kg / 1.8 lb | 65 | [钢铁意志大师](Psychic_Steel_Virtuoso.md "钢铁意志大师")当使用者以[优势](Advantage.md "优势")攻击时，造成额外1d8⁠⁠[心灵](Psychic.md "心灵")伤害。 |
| [破影利刃（武器）](Shadow_Blade_(weapon).md "破影利刃（武器）") |  | 2d8 | 心灵 | 0.9 kg / 1.8 lb | 65 | [破影利刃](Shadow_Blade_(passive_feature).md "破影利刃（被动特性）")使用此刃时，对轻度或重度遮蔽目标进行[攻击掷骰](Attack_roll.md "攻击掷骰")具有[优势](Advantage.md "优势")。 |
...
| [偷生之剑](Sword_of_Life_Stealing.md "偷生之剑") | +2 | 1d6 + 2 | 穿刺 | 0.9 kg / 1.8 lb | 480 | [生命窃取重击](Life_Stealing_Critical.md "生命窃取重击")在[重击](Critical_Hit.md "重击")时，目标会受到额外10⁠⁠[黯蚀](Necrotic.md "黯蚀")[伤害机制](Damage_rider_as_source.md "伤害机制")伤害，只要它不是构装生物或不死生物。您还会获得10点[临时生命值](Temporary_Hit_Points.md "临时生命值")。 |
| [猩红诡计](Crimson_Mischief.md "猩红诡计") | +2 | 1d6 + 2 / 1d4 | 穿刺 / 黯蚀 | 0.9 kg / 1.8 lb | 640 | [弱肉强食](Prey_Upon_the_Weak.md "弱肉强食")此武器对生命值低于或等于50%的目标造成额外1d4⁠⁠[穿刺](Piercing.md "穿刺")伤害。主手限定：[猩红残暴](Redvein_Savagery.md "猩红残暴")当您以[优势](Advantage.md "优势")攻击时，目标会受到额外7⁠⁠[穿刺](Piercing.md "穿刺")[伤害机制](Damage_rider_as_source.md "伤害机制")伤害。副手限定：[猩红武器](Crimson_Weapon.md "猩红武器")当您使用副手武器攻击时，可将您的[属性调整值](Ability_score_modifier.md "属性值调整值")加到攻击伤害上。 |

## 遗留内容

- [黑暗剑](Darkblade.md "黑暗剑") - _[不可访问](Category_colon_Inaccessible.md "类别：不可访问")_
- [处刑者之剑](Executioner_Sword.md "处刑者之剑") - _[不可访问](Category_colon_Inaccessible.md "类别：不可访问")_
- [恶毒短剑](Vicious_Shortsword.md "恶毒短剑") - _[不可访问](Category_colon_Inaccessible.md "类别：不可访问")_

## 外部链接

- ⁠[短剑](https://forgottenrealms.fandom.com/wiki/Short_sword) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page)

[￪ 返回顶部](#top)

---
*Source: [Shortswords](https://bg3.wiki/wiki/Shortswords)*