...
[堆叠 ID](Stack_ID.md "Stack ID"): `ALCH_ELIXIR`
...
- 受影响实体获得[奥术敏锐](Arcane_Acuity_(Condition).md "奥术敏锐 (状态)")，直至其下一次[长休](Long_Rest.md "长休")。饮用时替换其他灵药的效果。
- 获得奥术敏锐，持续 3 驱散。
- 奥术敏锐不会低于 3 驱散。
...
| [黑暗视觉灵药](Elixir_of_Darkvision_(Condition).md "黑暗视觉灵药 (状态)") | 可在黑暗中看清 12 米（40 英尺）内的事物。 |
