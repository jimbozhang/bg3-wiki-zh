...
从近战范围发起的弩攻击不会获得[劣势](Disadvantage.md "劣势")。
...
`S_GLO_GithRaider_001` ###

UUID

`6b265792-c6ce-4eb0-94cd-a12b7bbe590d` ###

属性

`Githyanki_Raider` **掠夺者 扎斯特里**是[第一幕](Act_One.md "第一幕")期间在[山隘](Mountain_Pass.md "山隘")的[吉斯洋基人](Githyanki.md "吉斯洋基人")[掠夺者](Githyanki_raider.md "吉斯洋基掠夺者")。
...
专精远程武器的战士，扎斯特里是[凯斯拉克百夫长沃斯](Voss.md "沃斯")寻找强大武器的搜索队成员。
...
消耗 6 米 (20 英尺) 的[移动速度](Movement_speed.md "移动速度")。在本回合剩余时间内，远程伤害掷骰两次并取最高值。
...
扎斯特里最多可以花费四枚[卓越骰子](Battle_Master.md#Level_3 "战斗大师")用于[策略](Manoeuvres.md "策略")：
...
---
*Source: [Zastri](https://bg3.wiki/wiki/Zastri)*