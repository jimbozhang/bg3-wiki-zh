...
当使用你[重甲的](Proficient.md "Proficient")的近战武器并双手持握时，[攻击掷骰](Attack_roll.md "Attack Roll")承受-5减值，但伤害增加10点。
...
当投掷[双手](Two-Handed.md "Two-Handed")近战伤害时，任何掷出1或2的骰子可以重投一次。
...
`S_END_LastStandGuard_005` ###

UUID

`09eec5b4-d504-4c46-8410-ec180722456b` ###

属性

`END_CityWatchMelee_Human` **卫士普雷恩**是[第三幕](Act_Three.md "Act Three")中[上城区](Upper_City.md "Upper City")[卫士](City_Watch.md "City Watch")的一员。在[至高大殿](High_Hall.md "High Hall")的庭院被[绝对](Absolute.md "Absolute")势力占领后，他试图逃离。
...
挥动武器进行大范围挥砍，同时攻击最多3个敌人。每个敌人受到武器通常造成伤害的一半。
...
---
*Source: [Preyn](https://bg3.wiki/wiki/Preyn)*