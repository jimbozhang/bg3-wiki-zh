...
`S_WYR_MerchantsHouse_Thug_001` ###

UUID

`2c1b28c2-279f-4a85-951b-96d4d5256634` ###

属性

`WYR_MerchantsHouse_Gnome_Bard` **溯源者迪普斯**是 [泽诺维娅·道格](Zenovia_Dawg.md "泽诺维娅·道格") 帮派的 [侏儒](Gnome.md "侏儒") 成员，也是 [公会](The_Guild.md "公会") 的成员，可在 [利文顿](Rivington.md "利文顿") 的 [阿尔弗·格雷戈里奥](Arfur_Gregorio.md "阿尔弗·格雷戈里奥") 庄园外找到。

## 参与

迪普斯和 [泽诺维娅·道格](Zenovia_Dawg.md "泽诺维娅·道格") 帮派的其他成员受雇于 [阿尔弗·格雷戈里奥](Arfur_Gregorio.md "阿尔弗·格雷戈里奥")，驱逐目前非法占据其庄园的难民。如果被激怒，或威吓失败，阿尔弗会召唤泽诺维娅武力驱逐难民。如果介入，战斗爆发，迪普斯会变得敌对。
...
用你的表演激励盟友超越其能力。他们可以为下一个 [攻击掷骰](Attack_roll.md "攻击掷骰")、[属性检定](Ability_Check.md "属性检定") 或 [豁免检定](Saving_throw.md "豁免检定") 添加 +1d6 奖励。
...
[恐慌](Frightened_(Condition).md "恐慌 (状态)") 一个生物：他们在 [属性检定](Ability_Check.md "属性检定") 和 [攻击掷骰](Attack_roll.md "攻击掷骰") 上具有 [劣势](Disadvantage.md "劣势")，且无法移动。
...
---
*Source: [Dimples Backster](https://bg3.wiki/wiki/Dimples_Backster)*