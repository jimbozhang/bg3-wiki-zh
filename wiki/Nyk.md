...
使用[武僧武器](Monk.md#Monk_weapons "Monk")进行攻击或徒手攻击后，你可以使用附赠动作进行另一次徒手攻击。

- [**武艺：敏捷攻击**](Martial_Arts_colon__Dextrous_Attacks.md "武艺：敏捷攻击")

如果你的敏捷更高，[武僧武器](Monk.md#Monk_weapons "Monk")和徒手攻击的伤害将随敏捷而非力量调整。
...
`S_INT_PortalGithyanki_Wave1_Melee_02` ###

UUID

`91153fd6-7d2a-4ac2-a647-fcac53a8c113` ###

Stats

`Githyanki_Gishra_Melee` **高阶熟手尼克**是一名[熟手](Gish'ra_(melee).md)，在[第三幕](Act_Three.md "第三幕")开始时于[飞龙关](Wyrm's_Crossing.md "飞龙关")的[营地](Campsite.md "营地")遭遇。
...
---
*Source: [Nyk](https://bg3.wiki/wiki/Nyk)*