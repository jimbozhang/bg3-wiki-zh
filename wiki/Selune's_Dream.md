...
**塞伦涅的梦境** 是一个 [戏法（塑能学派）](Spells.md "法术")。它治疗一名盟友，但可能使其陷入沉睡。**塞伦涅的梦境** 在游戏中仅作为由 [塞伦涅选民护符](Amulet_of_Sel%C3%BBne's_Chosen.md "塞伦涅选民护符") 提供的、每 [长休](Long_Rest.md "长休") 一次的动作。

## 描述

你接触的一名盟友恢复生命值，但可能陷入 [沉睡](Sleeping_(Condition).md "沉睡（状态）")。
...
- 对其进行的 [攻击掷骰](Attack_roll.md "攻击掷骰") 具有 [优势](Advantage.md "优势")，并且如果攻击者在该生物 1.5 米（5 英尺）范围内，任何命中该生物的攻击均为 [重击](Critical_Hit.md "重击")。
