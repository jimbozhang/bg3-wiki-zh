...
`S_LOW_BasiliskGate_DoorGuard` ###

UUID

`c14b2865-fd6f-4d52-8e41-b5f8aad97583` ###

属性

`FlamingFist_Dwarf_Melee_Attacker` **拳手米勒**是一名[矮人](Dwarf.md "Dwarf")[战士](Fighter.md "Fighter")，也是[焰拳](Flaming_Fist.md "Flaming Fist")的成员。他可以在[第三幕](Act_Three.md "Act Three")的[下城区](Lower_City.md "Lower City")找到。

> “
>
> 犯罪报告要简短——不要用琐碎的问题浪费我们的时间。
>
> „
...
米勒在[石化蜥蜴之门营房](Basilisk_Gate_Barracks.md "Basilisk Gate Barracks")守卫通往办公室的门。如果与他交谈，他会建议玩家角色不要进行任何滑稽行为，以便减少关于不当行为的投诉数量。此外，米勒对[半兽人](Half-Orc.md "Half-Orc")角色有独特的问候语。

### 伙伴好感度

如果[顾问弗洛瑞克](Florrick.md "Counsellor Florrick")被处决，与米勒的对话会更加详细<sup>[\[1\]](#cite_note-1)</sup>，并可能带来来自不同伙伴的好感度/厌恶度变化：

- 米勒
  当心，公民——叛徒弗洛瑞克在广场上被处决了。没人会想念她。
- 除得好。 +1 -1 -1 -1 -1 +1 -1 +1 +1 -2
- 她不该死。 -1 +1 +1 +1 +1 -1 +1 +1 +1 +2
  - 这样谈论她太残忍了。 -1 +1 +1 +1 +1 -1 +1 +1 +1 +2
...
[穿刺打击](Piercing_Strike.md "Piercing Strike") () – [标枪](Javelin.md "Javelin")
...
- [希普赛德军械库钥匙](Heapside_Armoury_Key.md "Heapside Armoury Key")
- [头盔](Helmet.md "Helmet")
- [标枪](Javelin.md "Javelin") - 2x（如果未使用）

## 注释

1. [↑](#cite_ref-1) 在游戏内对话文件中，米勒被称为对被处决的顾问“极其守法……且可怕”

---
*Source: [Miller](https://bg3.wiki/wiki/Miller)*