...
**跛足打击**是一种[武器动作](Weapon_action.md "武器动作")，可供[重甲的](Proficient.md "重甲的")使用并主手持握[战斧](Battleaxes.md "战斧")或[战镐](War_Picks.md "战镐")的角色使用。
...
- 虽然此武器动作通常仅适用于战斧和战镐，但其他类型的几种独特武器也授予此动作。
