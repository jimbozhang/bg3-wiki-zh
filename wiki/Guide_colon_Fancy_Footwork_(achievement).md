...
当接近要塞堡垒内的对峙时，可以在准备室中停留，通过使用远程武器手动瞄准陷阱（按住Ctrl键）来消除大部分陷阱。前往这场战斗最简单、最直接的路径是沿着悬崖面走到一些藤蔓处，爬上藤蔓和一些脚手架到达顶层。有两个明显的地面陷阱需要避开，但一旦进入“BOSS房间”，地面陷阱就不再是问题。有条不紊地清理这个房间以及入口通道另一侧的安全空间，可以消除手雷和火焰陷阱、近身触发的范围效果（AoE）的威胁，使尝试更有可能成功。
