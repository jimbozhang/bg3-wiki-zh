...
可以使用附赠动作进行[疾走](Dash_(bonus_action).md), [撤离](Disengage_colon__Bonus_Action.md "撤离：附赠动作")，以及[协助](Help_(bonus_action).md)。
...
`Companion_Bear_11` **熊战士** 是通过[驯兽师](Beast_Master.md "驯兽师")的[熊伙伴](Bear_Companion.md "熊伙伴")能力召唤的[熊](Bear.md "熊")，这是[游侠伙伴](Ranger's_Companion.md "游侠伙伴")的一个变体。熊战士是[大熊座](Ursa.md "大熊座")和[大熊座](Ursa_Major.md "大熊座")在驯兽师达到 11 级后的完全升级形态。
...
用沾满蜂蜜的爪子猛击，并使目标[缴械](Disarmed_(Condition).md "缴械 (状态)")。如果目标未持有任何武器，则改为使其[倒伏](Prone_(Condition).md "倒伏 (状态)")。
...
---
*Source: [Ursa Ingens](https://bg3.wiki/wiki/Ursa_Ingens)*