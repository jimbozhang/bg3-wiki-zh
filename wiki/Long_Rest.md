...
- [法术位](Spells.md#Spell_Slots "法术位") - 全部
...
许多[出身](Origin.md "出身")、[伙伴](Companions.md "伙伴")和[营地追随者](Camp_Followers.md "营地追随者")互动发生在长休时。长休也可以推进某些[时间敏感内容](Time-sensitive_activities.md "时间敏感内容")；此外，每个幕都有一些[任务](Quests.md "任务")会在长休时推进。
...
- 资源：
  ...
  - [邪术师](Warlock.md "邪术师")恢复其[邪术师法术位](Spells.md#Pact_Magic "法术位")
