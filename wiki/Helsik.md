...
> “
>
> 欢迎来到魔鬼的小费，这里的每一件地狱奇珍都是稀世之宝！请尽情欢乐——并愉快购物。
>
> „
...
赫尔希克是一名服务于 archdevil ⁠[玛门](https://forgottenrealms.fandom.com/wiki/Mammon) 的邪术师，玛门可能是现存最富有的存在，也是一位只忠于金钱的吝啬鬼。在魔鬼的小费，赫尔希克交易奇珍异宝和信息，提供大量通过其魔鬼信徒职业积累的稀有地狱物品。然而，赫尔希克对从奇珍中赚取的金币并不满意，决定将其技能多样化，提供“通道”服务。<sup>[\[1\]](#cite_note-1)</sup>
...
如果一个角色与赫尔希克的 [态度](Attitude.md "Attitude") 很高，例如通过交易赠送她足够的金币，该角色在她面前会获得 [传染贪婪](Infectious_Greed_(Condition).md "传染贪婪 (状态)") 增益。
...
如果队伍在她提供仪式物品之前偷过赫尔希克的东西，她会愤怒地将队伍赶出商店并封住门。试图返回商店会导致她变得敌对。
...
对应 `LOW_DevilsFee_Diabolist_Trade_Magic`。

### 常规物品

- 各种 [炼金术](Alchemy.md "Alchemy") 材料、[手雷](Grenades.md "Grenades") 和 [染料](Dyes.md "Dyes")

### 精选物品

- [卑鄙法杖](Caitiff_Staff.md "Caitiff Staff")
- [魔网斗篷](Cloak_of_the_Weave.md "Cloak of the Weave")
- [双子手套](Gemini_Gloves.md "Gemini Gloves")
- [地狱髯须长戟](Hellbeard_Halberd.md "Hellbeard Halberd")
- [变形生物帽子](Shapeshifter_Hat.md "Shapeshifter Hat")
- [法术搜寻手套](Spellseeking_Gloves.md "Spellseeking Gloves")
- [虔诚仆人的礼帽](Gibus_of_the_Worshipful_Servant.md "Gibus of the Worshipful Servant") 有时有售

### 她面前的桌子上

- [虔诚仆人的礼帽](Gibus_of_the_Worshipful_Servant.md "Gibus of the Worshipful Servant") 有时会出现在桌子上

## 战斗

如果赫尔希克被攻击，六只 [镶金小魔鬼](Gilded_Imp.md "Gilded Imp") 和两只 [镀金牛头人](Gilded_Minotaur.md "Gilded Minotaur") 会加入她的战斗。
...
1d10⁠[力场](Force.md "Force")

召唤一道噼啪作响的能量光束。对目标造成 1d10⁠⁠[力场](Force.md "Force") 伤害。

范围: 18 米 (60 英尺)

[玛门的税费](Mammon's_Tax.md "Mammon's Tax") (+ )

伤害: 6~36

6d6⁠[挥砍](Slashing.md "Slashing")

撕裂贪婪生物的肉体，每拥有 500 金币就造成 6d6⁠⁠[挥砍](Slashing.md "Slashing") 伤害。
...
- [术士长袍](Sorcerer_Robe.md "Sorcerer Robe")

## 死者交谈

赫尔希克可以通过 [死者交谈](Speak_with_Dead.md "Speak with Dead") 与之对话。
...
- [戈塔什](Enver_Gortash.md "Enver Gortash") 付钱让你做什么？
...
- 你知道 [拉斐尔](Raphael.md "Raphael") 在他的宅邸里守护着什么吗？
...
- [关于魔鬼信徒的文件](File_Under_Diabolist.md "File Under Diabolist")
- [小魔鬼皮装订魔法书](Grimoire_Bound_in_Imp_Skin.md "Grimoire Bound in Imp Skin")
- [赫尔希克的日志](Helsik's_Diary.md "Helsik's Diary")
- [来自负责人戈塔什的字条](Note_from_Director_Gortash.md "Note from Director Gortash")
- [来自赫尔希克的字条](Note_from_Helsik.md "Note from Helsik")
- [开启一扇地狱大门](Opening_a_Hell_Gate.md "Opening a Hell Gate")
- [关于拉斐尔的报告](Report_for_Raphael.md "Report for Raphael")
- [关于恩弗·戈塔什活动的报告](Report_on_Activities_of_Enver_Gortash.md "Report on Activities of Enver Gortash")
...
- 由于其属性块中的一个错误，赫尔希克的移动速度为 9 米 (30 英尺)，而不是矮人应有的 7.5 米 (25 英尺)。

## 注释与参考

1. [↑](#cite_ref-1) [赫尔希克的日志](Helsik's_Diary.md "Helsik's Diary")

## 外部链接

⁠[玛门](https://forgottenrealms.fandom.com/wiki/Mammon) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page) 上

---
*Source: [Helsik](https://bg3.wiki/wiki/Helsik)*