...
**训练盾**是一种常见的[盾牌](Shields.md "Shields")，专为练习而非实战保留。考虑到它在任何地方都买不到，需要偷窃，并且比其他盾牌更差，它只能被视为垃圾。
...
- UID `WPN_HUM_Toy_Shield_A` UUID `e13facc6-aced-4b48-b239-b0e76448013f` ## 获取地点
...
---
*Source: [Training Shield](https://bg3.wiki/wiki/Training_Shield)*