...
**盾牌猛击**是许多[盾牌](Shields.md "盾牌")提供的反应，允许穿戴者在被近战攻击命中时用盾牌反击，可能将攻击者击至[倒伏](Prone_(Condition).md "倒伏（状态）")。

## 描述

当敌人用近战攻击命中你时，你可以使用你的反应将其击至[倒伏](Prone_(Condition).md "倒伏（状态）")，除非他们成功通过一次[力量](Strength.md "力量")[豁免检定](Saving_throw.md "豁免检定")。
...
- 该能力的游戏内描述说明它需要敏捷豁免检定，但实际上它是力量豁免检定。

---
*Source: [Shield Blow](https://bg3.wiki/wiki/Shield_Blow)*