...
**污物**是一种[地表](Surface.md "Surface")，它会减半移动速度并可能导致你滑倒。它在[下城区下水道](Lower_City_Sewers.md "下城区下水道")中大量存在。

## 描述

劣势地形 - [移动速度](Movement_speed.md "移动速度")减半，生物可能[倒伏](Prone.md "倒伏")。易燃。
...
- 倒伏生物必须花费其一半的[移动速度](Movement_speed.md "移动速度")才能站起。
  - 拥有[运动员](Athlete.md "运动员")[专长](Feat.md "专长")的角色仅需花费1.5米（5英尺）的移动速度即可站起。
...
---
*Source: [Sewage](https://bg3.wiki/wiki/Sewage)*