...
**洞悉**是基于[感知](Wisdom.md "感知")的[技能](Skills.md "技能")。

生物的感知值越高，就越有可能在洞悉[检定](Checks.md "检定")中成功识破谎言和解读他人的肢体语言。
...
在**洞悉**上[重甲的](Proficient.md "重甲的")的角色在进行[属性检定](Ability_Check.md "属性检定")时，可以添加其[熟练项加值](Proficiency_Bonus.md "熟练项加值")。

以下[背景](Backgrounds.md "背景")授予**洞悉**熟练项：

- [侍僧](Acolyte.md "侍僧")
- [公会工匠](Guild_Artisan.md "公会工匠")

以下职业可以在1级时选择将**洞悉**作为熟练技能：
...
提高或降低[感知](Wisdom.md "感知")也会通过每偶数个点提升/惩罚感知调整值（从而影响洞悉），最多提升或降低1点。

| 名称 | 奖励或惩罚 | 备注 |
| --- | --- | --- |
| [权威服饰](Cloth_of_Authority.md "权威服饰") | +1 |  |
...
| [真实之戒](Ring_of_Truthfulness.md "真实之戒") | +1 |  |
| [变形者的恩赐之戒](Shapeshifter's_Boon_Ring.md "变形者的恩赐之戒") | +1d4 | 所有变形/伪装时的属性检定 |
...
---
*Source: [Insight](https://bg3.wiki/wiki/Insight)*