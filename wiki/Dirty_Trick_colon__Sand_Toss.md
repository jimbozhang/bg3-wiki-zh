...
**肮脏伎俩：扬沙**是[风流剑客](Swashbuckler.md "风流剑客")游荡者可用的类动作。

## 描述

向敌人投掷一把沙子，并可能使其[目盲](Blinded_(Condition).md "目盲（状态）")。

获得[优势](Advantage.md "优势")于你的下一次攻击。
...
**[肮脏优势](Dirty_Advantage_(Condition).md "肮脏优势（状态）")**
...
- 职业等级 4：[风流剑客](Swashbuckler.md "风流剑客")
...
- 当使用当前激活的远程武器时，[攻击掷骰](Attack_roll.md "攻击掷骰")使用[力量](Strength.md "力量")调整值。
- 由于此动作进行近战武器攻击掷骰，它会受到[巨武器大师：全力一击](Great_Weapon_Master_colon__All_In.md "巨武器大师：全力一击")的 -5 惩罚，但当装备[双手](Two-Handed.md "双手")和[两用](Versatile.md "两用")（无护盾）武器时，其伤害不会增加 10。

---
*Source: [Dirty Trick: Sand Toss](https://bg3.wiki/wiki/Dirty_Trick:_Sand_Toss)*