...
你可以在Larian的[补丁7](https://larian.club/Patch7)概述和他们的[社区更新#29 - 使用模组游玩](https://baldursgate3.game/news/community-update-29-playing-with-mods_124)中找到Larian的模组资源。

_如果你正在寻找Larian的官方模组文档，你可以在他们的[官方模组维基](https://docs.baldursgate3.game/index.php?title=Main_Page)上找到。_
...
想要创建模组？查看[模组创建主页](Modding_colon_Creating_mods.md "Modding:创建模组")！
...
你需要一些工具来开始模组制作。请确保下载以下工具，因为它们基本上是模组制作的必备工具：

- [BG3 Multitool](https://github.com/ShinyHobo/BG3-Modders-Multitool) by ShinyHobo
  - 多工具是一个很棒的工具，提供了几个重要功能，其中最主要的是能够搜索游戏文件，以及将你的模组打包成可导入BG3MM的格式。
- [Lslib](https://github.com/Norbyte/lslib) by Norbyte
  - Lslib允许你在可编辑格式和游戏就绪格式之间转换文件。详见[模组:解包和转换文件](Modding_colon_Unpacking_and_converting_files.md "Modding:解包和转换文件")。
...
- [Blender](https://www.blender.org/download/lts/3-6/) (推荐版本3.6)
  - 仅当你计划进行任何类型的网格编辑（头发、头部、衣服、武器等）时才需要此工具。
