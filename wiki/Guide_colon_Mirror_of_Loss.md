...
这是一个[用户操作指南](Guide_colon_Index.md "Guide:Index")，遵循与Wiki其余部分不同的[指南](Help_colon_Guide_namespace.md "Help:Guide namespace")。编辑此页面前请先询问用户。请在[讨论](Guide_talk_colon_Mirror_of_Loss.md "Guide talk:Mirror of Loss")页面留下反馈。

这是关于[失落之镜](Mirror_of_Loss.md "Mirror of Loss")的指南。

只需一名角色通过初始的[奥秘](Arcana.md "Arcana")或[宗教](Religion.md "Religion")检定来识别镜子，但每个队伍成员都必须通过各自的[宗教](Religion.md "Religion")祈祷检定，才能获得永久属性增益。能够提升宗教或[智力](Intelligence.md "Intelligence")的物品（可在每次尝试时传递给每个队伍成员）将增加成功几率。这些物品包括：
...
如果愿意重置属性，有一种自洽的方法可以确保通过DC 25的宗教检定，无需重新加载存档。
...
为了更可靠地获得先祖记忆的额外奖励，每个与镜子互动的角色可以在祈祷前进行互动。这样，他们不会因获得+2奖励而提前锁定后续掷骰，并增加获得先祖记忆结果的几率。**但他们最好不要这样做**，因为先祖记忆的掷骰只有20%的几率，你可能会失去所有或大部分提供记忆的选项（总共6个），并且在提供祈祷以获得+2奖励后，获得所需60%掷骰的机会更少。在单存档模式下，这可能至关重要，因此如果您追求实际可靠的游戏策略，请不要使用上述技巧。

---
*Source: [Guide:Mirror of Loss](https://bg3.wiki/wiki/Guide:Mirror_of_Loss)*