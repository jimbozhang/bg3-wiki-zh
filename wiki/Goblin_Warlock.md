...
`Goblin_Warlock` **地精邪术师**是通用的地精邪术师 [NPC](NPC.md "NPC")，在 [第一幕](Act_One.md "Act_One") 中随处可见。
...
获得 5 [临时生命值](Temporary_Hit_Points.md "Temporary Hit Points")，并对任何用近战攻击击中你的生物造成 5⁠⁠[寒冷](Cold.md "Cold") 伤害。
...
---
*Source: [Goblin Warlock](https://bg3.wiki/wiki/Goblin_Warlock)*