...
`245be20a-c140-48b8-bea7-9ff44d9606b2` ###

属性

`Githyanki_Warrior` **战士 Vu'un** 是在[审判官 W'wargaz](W'wargaz.md "W'wargaz") 于[第一幕](Act_One.md "Act_One")期间抵达之前，居住在[伊雷珂养育间](Cr%C3%A8che_Y'llek.md "Crèche Y'llek")的吉斯洋基社群成员。
...
如果队伍试图偷偷溜过他去偷取[吉斯洋基蛋](Githyanki_Egg.md "Githyanki Egg")并触发陷阱，如果在与[Ko'kuu](Ko'kuu.md "Ko'kuu")交谈时选择错误选项，或者如果被允许接近并拿走蛋，但选择将其砸碎（后一个选项对吉斯洋基玩家角色不可用），Vu'un 会对队伍变得敌对。
...
[缴械攻击（近战）](Disarming_Attack_(Melee).md "Disarming Attack (Melee)") (+ ) – [吉斯洋基巨剑](Githyanki_Greatsword.md "Githyanki Greatsword")
...
运用你的体力保护自己。你恢复 1d10 + 战士等级⁠⁠[治疗](Healing.md "治疗")。
