...
`S_UND_FearfulRothe_Guard_001` ###

UUID

`90780cde-9241-478f-83a8-58a4a7d151fe` ###

Stats

`UND_KC_Duergar_Melee` **牧群大师斯卡贾尔**是[复仇之炉](Grymforge.md "Grymforge")的一名灰矮人，位于[第一幕](Act_One.md "Act_One")。

> “
>
> 你打算鞭打它们还是怎么着？那些地底洛斯兽该干活了。
>
> „
...
[恐吓攻击（近战）](Menacing_Attack_(Melee).md "Menacing Attack (Melee)") (+ ) – [鞭刑杖](Whipping_Cane.md "Whipping_Cane")
...
[推撞攻击（近战）](Pushing_Attack_(Melee).md "Pushing Attack (Melee)") (+ ) – [鞭刑杖](Whipping_Cane.md "Whipping_Cane")
...
消耗一枚卓越骰子，造成额外 1d8⁠⁠[物理](Physical.md "Physical")伤害，并可能将目标击退 4.5 米 / 15 英尺。
...
- [莫伽耶](Morgya.md "Morgya")

### 战利品

- [精金矿渣](Adamantine_Slag.md "Adamantine Slag")
...
斯卡贾尔可以通过[死者交谈](Speak_with_Dead.md "Speak_with_Dead")与之对话。
...
- 是真魂者[尼讷](Nere.md "Nere")派你来寻找熔炉的吗？
...
---
*Source: [Skarjall](https://bg3.wiki/wiki/Skarjall)*