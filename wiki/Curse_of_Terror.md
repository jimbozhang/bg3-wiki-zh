...
**恐惧诅咒**是一种[法术](Spells.md "法术")。此法术对单个目标造成伤害并使其恐慌。玩家角色无法学习此法术。

## 描述

刺入生物的心脏，使其陷入[恐慌](Frightened.md "Frightened")状态。
...
由以下生物使用：[恐惧面具](Mask_of_Terror.md "Mask of Terror")

---
*Source: [Curse of Terror](https://bg3.wiki/wiki/Curse_of_Terror)*