...
三叉戟是一种两用的军用近战[武器](Weapons.md "武器")。以下是大多数三叉戟共有的基础属性，尽管特殊或魔法变体可能有显著差异。关于此武器最常见的非魔法类型，请参阅[三叉戟](Trident.md "三叉戟")。在下方，您可以找到游戏中所有三叉戟的列表。
...
| [尼鲁纳](Nyrulna.md "尼鲁纳") | +3 | 1d6 + 3 / 1d6 | 穿刺 / 雷鸣 | 1.8 千克 / 3.6 磅 | 840 | [和风连接](Zephyr_Connection.md "和风连接")此武器投掷后将返回您手中。您无法被强迫丢弃三叉戟。投掷时，武器在目标中心创建一个爆炸，在 ⁠6 米 / 20 英尺范围内造成 3d4⁠⁠[雷鸣](Thunder.md "雷鸣")[伤害机制](Damage_rider_as_source.md "伤害机制")伤害。[风之纱](Veil_of_the_Wind.md "风之纱")您获得 +3 米 / 10 英尺的[移动速度](Movement_speed.md "移动速度")和跳跃距离加成。装备此武器可使您对[坠落伤害](Damage_Types#Damage_Vulnerability,_Resistance_and_Immunity.md#Damage_Vulnerability,_Resistance_and_Immunity "伤害类型")免疫。[尼鲁纳：发光](Nyrulna_colon__Glowing.md "尼鲁纳：发光")此物品在 ⁠6 米 / 20 英尺半径内散发光芒。[西风闪](Zephyr_Flash.md "西风闪") 向前急冲，创建一个气旋冲击敌人，可能施加[流血](Bleeding_(Condition).md "流血（状态）")。（充能：[短休](Short_rest.md "短休")。）[西风破裂](Zephyr_Break.md "西风破裂") 西风破裂模仿法术[造风术](Gust_of_Wind.md "造风术")的效果，同时造成雷鸣伤害。（充能：[短休](Short_rest.md "短休")。）

## 遗留内容

- [阿兰德拉的浪涛](Allandra's_Whelm.md "阿兰德拉的浪涛") - _[无法访问](Category_colon_Inaccessible.md "类别：无法访问")_

## 外部链接

- ⁠[三叉戟](https://forgottenrealms.fandom.com/wiki/Trident) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page)

[￪ 返回顶部](#top)

---
*Source: [Tridents](https://bg3.wiki/wiki/Tridents)*