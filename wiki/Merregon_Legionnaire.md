...
可以在黑暗中看到事物，包括魔法黑暗，最远 24 米 (80 英尺)。
...
你对[借机攻击](Opportunity_Attack.md "借机攻击")获得[优势](Advantage.md "优势")。

- [**哨兵：陷阱**](Sentinel_colon__Snare.md "哨兵：陷阱")

当你用[借机攻击](Opportunity_Attack.md "借机攻击")命中一个生物时，它在其回合剩余时间内无法移动。
...
`S_UND_KethericCity_LostMerregon` ###

UUID

`07e9b38f-624c-45db-b3fa-b45737314796` ###
...
**军团魔步兵**是_[博德之门3](Baldur's_Gate_3.md "博德之门3")_中的[军团魔](Merregon.md "军团魔")生物。
...
其他几名军团魔步兵可以在尤格的伏击中找到。如果[尤格](Yurgir.md "尤格")被安抚，他们会在 X: -664 Y: -760 的篝火旁休息。
...
---
*Source: [Merregon Legionnaire](https://bg3.wiki/wiki/Merregon_Legionnaire)*