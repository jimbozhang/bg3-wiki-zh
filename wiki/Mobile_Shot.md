...
**移动射击**是一种[武器动作](Weapon_action.md "武器动作")，可供[重甲的](Proficient.md "重甲的")使用并手持[手弩](Hand_Crossbows.md "手弩")的角色使用。

## 描述

在本回合使用[疾走](Dash.md "疾走")或[撤离](Disengage.md "撤离")后，你可以使用附赠动作进行一次远程攻击。
...
---
*Source: [Mobile Shot](https://bg3.wiki/wiki/Mobile_Shot)*