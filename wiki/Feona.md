...
将下一次受到的伤害减少至 1 点，并消耗一层不可撼动。无法被外力移动。
...
`S_LOW_CountingHouse_Cultist_01` ###

UUID

`6217b97e-3715-4e88-ae20-7ba1aa9da1aa` ###

属性

`Human_Cultist_Bhaal_DeathsHead`

**巴尔的死亡牧首费奥纳**是[巴尔邪教](Cult_of_Bhaal.md "巴尔邪教")的成员，可在[下城区](Lower_City.md "下城区")的[清账屋](The_Counting_House.md "清账屋")的高安保金库中找到。

## 参与

在[高阶竖琴手](The_High_Harper.md "高阶竖琴手")任务期间，队伍可以前往[清账屋](Counting_House.md "清账屋")，希望能追上明斯克。在金库内，队伍可以看到明斯克从一只[拟形怪](Mimic.md "拟形怪")中出现并击败它。'贾希拉'随后出现，带着包括费奥纳在内的一群巴尔信徒，并传送走明斯克，留下邪教徒攻击队伍和工作人员。
...
佯攻，可能使对手[失衡](Off_Balance_(Condition).md "失衡 (状态)")。
...
目标一个 18 米 (60 英尺) 内它能看见的生物。目标必须成功通过[感知](Wisdom.md "感知") [豁免检定](Saving_throw.md "豁免检定")，否则将被[震慑](Stunned_(Condition).md "震慑 (状态)")直到其下一回合结束。**硬核难度：** 此动作不需要[专注](Concentration.md "专注")。
...
费奥纳可以使用[死者交谈](Speak_with_Dead.md "死者交谈")进行对话。
...
---
*Source: [Feona](https://bg3.wiki/wiki/Feona)*