...
`S_WYR_Rivington_FlamingFist_000` ###

UUID

`2f0d4a81-4bc3-432b-a201-71bdacc34160` ###

属性

`FlamingFist_Human_Ranger` **拳头哈瓦德**是一名[人类](Human.md "人类")[游侠](Ranger.md "游侠")，也是[焰拳](Flaming_Fist.md "焰拳")的成员。他可以在[利文顿](Rivington.md "利文顿")的街道上找到，位于[第三幕](Act_Three.md "第三幕")。
...
- X: -1 Y: -27（[安格莱隆的铁匠铺](Gyldro_Angleiron.md "吉尔德罗·安格莱隆")）
- X: -18 Y: -76（[终末马戏团](Circus_of_the_Last_Days.md "终末马戏团")）

哈瓦德和他的同伴不会回应任何试图与他们交谈的尝试。
...
---
*Source: [Havard](https://bg3.wiki/wiki/Havard)*