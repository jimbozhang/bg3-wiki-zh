...
**手弩 +2** 是 [手弩](Hand_Crossbows.md "手弩") 武器家族中一种稀有、中等附魔（+2）的变体。它是一种单手挥舞的[军用远程武器](Weapons.md "武器")。它是一种[轻型](Light_(weapon_property).md) 武器，任何人都可以无需特殊训练即可双持。

尽管这把弩小巧轻便，但其弓弦中却蕴含着强大的力量。
...
重量：0.9 千克（1.8 磅）
价格：155 金币
UID `MAG_Generic_02_HandCrossbow_2` UUID `37627613-50b9-407e-9fcd-02962fb4cc33` Stats `WPN_HandCrossbow_2` ### 武器动作
...
- 位于[迦纳斯夫人的宅邸](Lady_Jannath's_Estate.md "迦纳斯夫人的宅邸")一楼办公室的墙内保险箱中

---
*Source: [Hand Crossbow +2](https://bg3.wiki/wiki/Hand_Crossbow_+2)*