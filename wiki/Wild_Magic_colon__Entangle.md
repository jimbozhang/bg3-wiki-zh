...
**狂野魔法：纠缠术**是[狂野魔法术士](Wild_Magic_Sorcerer.md "狂野魔法术士")的自由动作，当被[狂野魔法](Wild_Magic_(passive_feature).md "狂野魔法（被动特性）")掷骰触发时随机使用；它会在附近地面生成藤蔓，可以像[纠缠](Entangle.md "纠缠")法术一样困住生物。

## 描述

在自身周围创建藤蔓地表，减缓生物速度，并可能使其[缠绕](Entangled_(Condition).md "缠绕（状态）")。
...
---
*Source: [Wild Magic: Entangle](https://bg3.wiki/wiki/Wild_Magic:_Entangle)*