...
另请参阅：[魔法飞弹](Magic_Missile.md "魔法飞弹")

**罗兰的魔法飞弹**是一个[等级 1 塑能学派法术](Spells.md "法术")。此法术是[魔法飞弹](Magic_Missile.md "魔法飞弹")的变体，为[罗兰](Rolan.md "罗兰")独有。队伍成员无法学习此法术。

## 描述

投掷一道集中的魔法力场飞镖，可使目标[眩晕](Dazed_(Condition).md "眩晕（状态）")。
...
- 可玩角色无法学习此法术。仅[罗兰](Rolan.md "罗兰")可用。

---
*Source: [Rolan's Magic Missile](https://bg3.wiki/wiki/Rolan's_Magic_Missile)*