...
战镐是一种单手军用近战[武器](Weapons.md "武器")。以下是大多数战镐共有的基础属性，但特殊或魔法变体可能有显著差异。关于该武器最常见的非魔法类型，请参见[战镐](War_Pick.md "战镐")。在下方，您可以找到游戏中所有战镐的列表。

## 目录

- [1 属性](#properties)
  - [1.1 动作](#actions)
- [2 战镐列表](#list-of-war-picks)
...
- [锈战镐](Rusty_War_Pick.md "锈战镐") - _[无法访问](Category_colon_Inaccessible.md "分类：无法访问")_

## 外部链接

- ⁠[战镐](https://forgottenrealms.fandom.com/wiki/War_pick) 于 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page)

[￪ 返回顶部](#top)

---
*Source: [War Picks](https://bg3.wiki/wiki/War_Picks)*