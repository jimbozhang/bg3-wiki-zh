...
本文介绍的是远程版本。关于近战版本，请参见 [神圣打击：雷鸣（近战）](Divine_Strike_colon__Thunder_(Melee).md).）。关于此特性的通用信息，请参见 [神圣打击](Divine_Strike.md "神圣打击")。

**神圣打击：雷鸣（远程）** 是 [风暴领域](Tempest_Domain.md "风暴领域") 牧师的武器动作和反应，可在远程武器攻击时造成额外的雷鸣伤害。

## 描述

造成额外 1d8⁠⁠[雷鸣](Thunder.md "雷鸣") 伤害。
...
`Projectile_DivineStrike_Ranged_Tempest`
...
- 当装备两把 [手弩](Hand_Crossbows.md "手弩") 并启用双持时，此攻击将消耗一个 [动作](Actions.md#Resources "动作") 和一个 [附赠动作](Actions.md#Resources "动作")，但副手攻击将不会执行。

---
*Source: [Divine Strike: Thunder (Ranged)](https://bg3.wiki/wiki/Divine_Strike:_Thunder_(Ranged)*