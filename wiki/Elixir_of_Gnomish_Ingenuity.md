...
- 重量：0.1 千克 (0.2 磅)
- 价格：10 金币
- UID `CONS_Elixir_Blood_Gnome` UUID `65e56bb5-909b-4f52-99e9-18fd1f39ef19` Stats `OBJ_BloodPotion_Gnome` ### 效果
...
**[侏儒天才](Gnomish_Ingenuity_(Condition).md "侏儒天才 (状态)")**
...
由[月出之塔](Moonrise_Towers.md "Moonrise Towers")的[阿拉吉·欧布罗扎](Araj_Oblodra.md "Araj Oblodra")以及之后在[下城区](Lower_City.md "Lower City")以侏儒血液交换获得。

---
*Source: [Elixir of Gnomish Ingenuity](https://bg3.wiki/wiki/Elixir_of_Gnomish_Ingenuity)*