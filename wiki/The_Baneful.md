...
近战：1.5米（5英尺）
重量：0.9千克（1.8磅）
价格：190 gp / 250 gpHHonour
UID `MAG_Bonded_Baneful_Shortsword` UUID `3b578a43-222e-480b-8a22-2c424471099f` Stats `MAG_Bonded_Baneful_Shortsword` ### 特殊

**持有此物品者获得：**

[心仪武器](Favoured_Weapon.md "心仪武器")
此武器的伤害和[攻击掷骰](Attack_roll.md "攻击掷骰")具有+1加值。

[灾祸连接](Baneful_Bond.md "灾祸连接")
命中时，可能对目标施加[灾祸术](Bane_(Condition).md "灾祸术（状态）")。
...
- 此剑的魔法力量只有在[武器绑定](Weapon_Bond.md "武器绑定")于[奥法骑士](Eldritch_Knight.md "奥法骑士")或是[邪术师](Warlock.md "邪术师")的[魔契武器誓缚](Bind_Pact_Weapon.md "魔契武器誓缚")或[脆弱诅咒](Bind_Hexed_Weapon.md "脆弱诅咒武器誓缚")武器时才会生效。这些效果是武器+1惑控学派的额外加成。由于惑控学派和心仪武器加成叠加，此武器在誓缚时相当于一把+2武器。

_关于灾祸连接：_

- 灾祸连接不会在战斗日志中显示豁免检定掷骰。
