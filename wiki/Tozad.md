...
`d8667091-dd64-499c-8bee-000cf42175fc` ###

属性

`Goblin_Ranger` **追踪者托扎德**是位于[地精营地](Goblin_Camp.md "Goblin Camp")的[地精](Goblin.md "Goblin")，出现在[第一幕](Act_One.md "Act One")。
...
托扎德可以在[破碎圣所](Shattered_Sanctum.md "Shattered Sanctum")的东侧走廊巡逻。
...
你的攻击会召唤带刺藤蔓，可能 \_(状态)[诱捕](Ensnared_(Ensnaring_Strike)_(Condition).md "Ensnared (Ensnaring Strike) (Condition)") 目标。
...
- ⁠[托扎德](https://forgottenrealms.fandom.com/wiki/Tozad) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page)

---
*Source: [Tozad](https://bg3.wiki/wiki/Tozad)*