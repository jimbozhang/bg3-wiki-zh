...
- [大卫·蒙蒂斯](https://www.imdb.com/name/nm4109548/)
...
在阳光下时，[攻击掷骰](Attack_Roll.md "攻击掷骰")和[察觉技能](Perception.md "察觉技能")具有劣势。
...
可使用[反应](Reaction.md "反应")将一次命中伤害减半。
...
`S_UND_DuergarRebelMason_02` ###

UUID

`6b07558b-09ef-449c-8dd2-b0c2cbe809f1` ###

属性

`UND_KC_Duergar_Rogue` **石匠格尔格兰**正在[复仇之炉](Grymforge.md "复仇之炉")检查石工作业，位于[第一幕](Act_One.md "第一幕")。

> “
>
> 如果你不是来检查石工的，那就滚开。如果你是……嗯，我怀疑你能说出什么有用的话。
>
> „
...
格尔格兰可在[幽暗地域 —— 复仇之炉](Underdark - Grymforge.md "幽暗地域 —— 复仇之炉")传送点附近 X: -647 Y: 382 处遇到，站在[石匠基思](Kith.md "石匠基思")旁边。他是[烈焰氏族](Clan_Flameshade.md "烈焰氏族")的忠诚成员。

### 启用交易

格尔格兰通常不是商人，但他有充足的药水、卷轴、箭矢和食物库存。<sup>[\[1\]](#cite_note-1)</sup> 与任何其他非商人 NPC 一样，可以通过将与之互动的队伍成员的态度降低至至少 -45%（例如，因偷窃或扒窃被抓）来使其库存可访问。如果此时与他交谈，可以按“交易”按钮使整个库存可用。否则，队伍可以直接扒窃他的库存。
...
1. [↑](#cite_ref-1) 格尔格兰拥有 `UND_KC_Trader_Utility` 标签。

## 外部链接

- ⁠[格尔格兰](https://forgottenrealms.fandom.com/wiki/Gergerann) 在 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page)

---
*Source: [Gergerann](https://bg3.wiki/wiki/Gergerann)*