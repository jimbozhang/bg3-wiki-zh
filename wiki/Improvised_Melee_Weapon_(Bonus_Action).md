...
**即兴近战武器**是[狂战士](Berserker.md "狂战士")[野蛮人](Barbarian.md "野蛮人")的职业动作，允许使用者通过附赠动作捡起地上的物品或生物来进行即兴攻击。只能在[狂怒](Frenzy.md "狂怒")状态下使用。

## 描述

捡起一个物品或生物，并用它进行一次近战攻击。

你的[力量](Strength.md "力量")影响你能举起的重量。更重的物品造成更多伤害。
...
- 伤害：
  ...
  2d4⁠⁠[钝击](Bludgeoning.md "钝击") 伤害。
- 如果投掷的物体或生物重量超过目标重量的一半，目标将被击退 2 米（7 英尺）。
...
- 生物可以捡起重量不超过 0.2⋅力量² 千克的物品和其他生物（源自 `Scripts/thoth/helpers/CommonConditions.khn` 中 `CanImprovisedWeaponWeight()` 的定义）。例如，[力量](Strength.md "力量")为 18 时，即兴武器的重量上限为 64.8 千克（129.6 磅）。
  - 捡起一个普通类人生物（重量：75 千克（150 磅））需要至少 20 点力量。
- **即兴近战武器**被视为一次近战徒手攻击。
  - [酒馆殴斗者](Tavern_Brawler.md "酒馆殴斗者")专长会强化即兴近战武器。
- 目标的重量不受生物装备的物品、生物物品栏内的物品或容器内物品的影响。重量不是捡起或放入物品栏时的重量，而是物体/生物本身的重量。可以通过点击 **“检视 -> 详细信息”** 并查看 **“重量：”** 来查看目标的重量。
