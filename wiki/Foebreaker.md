...
不要与[破誓者](Faithbreaker.md "破誓者")混淆

破敌者是一把非常稀有的+2[巨锤](Mauls.md "Mauls")，它能无视目标的[钝击](Bludgeoning.md "Bludgeoning")[抗性](Damage_types.md#Resistance "伤害类型")。

就像大多数关于某个年轻冒险女孩要成为骑士或草药师之类的故事里的厨房厨师一样，沉重且反对废话。你得有个大而务实的厨师。这就像规则。

## 属性

伤害

2d6 + 2 (4~14) + [力量调整值](Damage_Roll.md#Modifiers "伤害掷骰") [钝击](Bludgeoning.md "Bludgeoning")
...
重量：4.5 千克（9 磅）
价格：480 gp
UID `MAG_TheDestroyer_Maul` UUID `89eacf71-5bf6-4e7f-ac9d-e2d7d1d6bcb0` Stats `MAG_TheDestroyer_Maul` ### 特殊效果

**持有此物品获得：**

[致命武器（钝击）](Lethal_Weapon_(Bludgeoning).md)
此武器无视对[钝击](Bludgeoning.md "Bludgeoning")伤害的[抗性](Resistance.md "抗性")。
...
- [巫术杂物店地窖](Sorcerous_Vault.md "巫术杂物店地窖") X: 326 Y: 998：在卡尔萨斯区域的一个隐藏宝箱中

## 备注

- 进入地窖后，找到指定的门，队伍必须按以下顺序通过：银手 -> 防护学派 -> 银色，以找到一个拉杆来解锁卡尔萨斯保险库大门。然后队伍必须通过恶魔门返回起始房间，并穿过已开启的卡尔萨斯门。宝箱是隐形的，需要[识破隐形](See_Invisibility.md "识破隐形")或[妖火](Faerie_Fire.md "妖火")来显形。
