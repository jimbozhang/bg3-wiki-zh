...
**杀戮**是[杀戮者](Slayer.md "杀戮者")可用的基本攻击。这是一种强大的徒手挥砍攻击，对处于[流血](Bleeding_(Condition).md "流血（状态）")或[倒伏](Prone_(Condition).md "倒伏（状态）")状态的目标具有特殊效果。杀戮者进行的任何[借机攻击](Opportunity_Attack.md "借机攻击")也使用此攻击。

## 描述

用你恶意的爪子划过目标的身体。

如果目标处于[流血](Bleeding_(Condition).md "流血（状态）")状态，他们将感染[疫病术中毒](Contagion_Poisoned_(Condition).md "疫病术中毒（状态）")的第1阶段。
...
- 对更强的[烂肉症](Stricken_With_Flesh_Rot_(Condition).md "烂肉症（状态）")效果有豁免检定，但对[疫病术中毒](Contagion_Poisoned_(Condition).md "疫病术中毒（状态）")没有。
