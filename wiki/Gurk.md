...
[力量](Strength.md "Strength") 提升 2，[魅力](Charisma.md "Charisma") 和 [敏捷](Dexterity.md "Dexterity") [检定](Checks.md "Checks") 有 [劣势](Disadvantage.md "Disadvantage")。
...
`S_GOB_Festivities_Goblin_007` ###

UUID

`10a00987-1dbe-4540-aa34-e96976c7bac0` ###

属性

`Goblin_Warlock` **邪术师古尔克** 是驻扎在 [地精营地](Goblin_Camp.md "Goblin Camp") 的一名地精，位于 [第一幕](Act_One.md "Act One")。

> “
>
> 嘿，我能看看你的印记吗？女祭司给了我一个，我觉得她弄错了。
>
> „

— 古尔克，询问关于 [至上真神的印记](Brand_of_the_Absolute.md "Brand of the Absolute")
...
获得 5 点 [临时生命值](Temporary_Hit_Points.md "Temporary Hit Points")，并对任何用近战攻击击中你的生物造成 5⁠⁠[寒冷](Cold.md "Cold") 伤害。
...
- ⁠[古尔克](https://forgottenrealms.fandom.com/wiki/Gurk) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page)

---
*Source: [Gurk](https://bg3.wiki/wiki/Gurk)*