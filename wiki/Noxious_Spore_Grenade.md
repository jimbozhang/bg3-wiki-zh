...
- 受影响实体每驱散受到 1d4⁠⁠[毒素](Poison.md "毒素") 伤害。它必须成功通过 难度等级 15 的 [体质](Constitution.md "体质") [豁免检定](Saving_throw.md "豁免检定")，否则将额外受到 2d4⁠⁠[毒素](Poison.md "毒素") 伤害，成功时伤害减半。
...
- 1d4⁠⁠[毒素](Poison.md "毒素") 伤害在第一驱散不会生效。
- 2d4⁠⁠[毒素](Poison.md "毒素") 伤害每驱散生效。其难度等级为 15，如果生物在烟雾中移动，可多次生效。
- 当手雷爆炸时，爆炸可造成 2d4 + 1⁠⁠[毒素](Poison.md "毒素") 伤害；这是一个法术攻击。
