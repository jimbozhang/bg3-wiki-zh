...
奥术射击是一组从3级开始可供[魔射手](Arcane_Archer.md "魔射手")副职使用的类别动作。它们是利用[奥术箭](Arcane_Archer.md#Arcane_Arrow "魔射手")为远程攻击添加额外效果的强大攻击。它们在[短休](Short_rest.md "短休")时恢复，并且数量众多，允许它们比许多其他法术和类别能力更频繁地使用。
