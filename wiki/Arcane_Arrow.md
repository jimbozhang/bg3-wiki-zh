...
- 穿刺箭和追踪箭与其他奥术射击不同，由于缺少攻击掷骰，它们与[伤害附加](Damage_mechanics.md "伤害机制")的交互方式不同。因此，来自[泰坦弦弓](Titanstring_Bow.md "泰坦弦弓")和[神射手：孤注一掷](Sharpshooter_colon__All_In.md "神射手：孤注一掷")的额外伤害不会被应用，尽管工具提示显示会应用。然而，其他类似于[蘸取武器](Dip.md "蘸取")或[闪电充能](Lightning_Charges_(Condition).md "闪电充能（状态）")的伤害附加确实会将额外伤害应用于这些箭。
