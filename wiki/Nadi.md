...
`S_MOO_PrisonGuard_004` ###

UUID

`107c72ca-2a4f-477d-a315-deeea3eea49e` ###

属性

`MOO_ZealotOfTheAbsolute_HalfOrc` **纳迪**是一名[半兽人](Half-Orc.md "半兽人")[至上真神狂热信徒](Zealot_of_the_Absolute.md "至上真神狂热信徒")，可在[第二章](Act_Two.md "第二章")的[月出之塔](Moonrise_Towers.md "月出之塔")找到。他位于[月出之塔监狱](Moonrise_Towers_Prison.md "月出之塔监狱")牢房旁站岗。
...
如果[暗夜之歌](Aylin.md "暗夜之歌")被释放，竖琴手同盟对月出之塔发动进攻，纳迪将在随后的战斗中被杀。他的尸体位于通往[月出之塔](Moonrise_Towers.md "月出之塔")主体的桥梁上，被[圣火](Holy_Fire.md "圣火")包围，坐标 X: -154 Y: -113。
...
使敌人[恐慌](Abjure_Enemy_colon__Frightened_(Condition).md "破胆斥喝：恐慌 (状态)")。他们在[属性检定](Ability_checks.md "属性检定")和[攻击掷骰](Attack_roll.md "攻击掷骰")上具有[劣势](Disadvantage.md "劣势")，并且无法移动。
...
- [短弓](Shortbow.md "短弓")
- [虚空球茎](Void_Bulb.md "虚空球茎")

---
*Source: [Nadi](https://bg3.wiki/wiki/Nadi)*