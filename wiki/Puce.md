...
`Goblin_Melee_Strong` **战士普斯** 是在第一幕期间，位于通往[地精营地](Goblin_Camp.md "Goblin Camp")入口前的检查站的一名地精。
...
可能使目标[恐慌](Frightened_(Condition).md "Frightened (Condition)")。他们将在[检定](Ability_Check.md "Ability Check")和[攻击掷骰](Attack_roll.md "Attack Roll")上具有[劣势](Disadvantage.md "Disadvantage")，并且无法移动。
