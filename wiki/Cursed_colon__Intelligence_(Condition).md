...
- 在使用[智力](Intelligence.md "智力")进行的[属性检定](Ability_Check.md "属性检定")和[豁免检定](Saving_throw.md "豁免检定")上具有[劣势](Disadvantage.md "劣势")。
...
- [降咒：智力劣势](Bestow_Curse_colon__Intelligence_Disadvantage.md "降咒：智力劣势")
...
| 状态 | 效果 |
| --- | --- |
| [诅咒：额外伤害](Cursed_colon__Additional_Damage_(Condition).md "诅咒：额外伤害 (状态)") | 从施法者的攻击或法术中受到额外1d8⁠⁠[黯蚀](Necrotic.md "黯蚀")伤害。 |
| [诅咒：攻击劣势](Cursed_colon__Attack_Disadvantage_(Condition).md "诅咒：攻击劣势 (状态)") | 在对诅咒来源的[攻击掷骰](Attack_roll.md "攻击掷骰")上具有[劣势](Disadvantage.md "劣势")。 |
...
---
*Source: [Cursed: Intelligence (Condition)](https://bg3.wiki/wiki/Cursed:_Intelligence_(Condition)*