...
- [欺瞒] 你没时间了，明显在拖延——这就是为什么*凯斯拉克*赛泽恩派我来把它带给她。交出来。(DC 10)
- [威吓] 你在浪费时间。现在把它给我，否则我就告诉她*你*才是弱者。(DC 18)

如果交互的队伍成员通过游说检定说服库库放弃蛋，他会给予他们 [养育官寇库的靴子](Varsh_Ko'kuu's_Boots.md "Varsh Ko'kuu's Boots")，这可以防止穿着者在孵化室水池中受到伤害。
...
*以上任一选项：* +1 -1 -1 -1 -1 -1 请注意，选择以上任一对话选项会导致孵化室立即变为敌对。
...
3d8⁠[雷鸣](Thunder.md "Thunder")

对所有附近的生物和物体造成伤害。

由无机材料（如石头）制成的生物在 [豁免检定](Saving_throw.md "Saving throw") 上具有 [劣势](Disadvantage.md "Disadvantage")。
...
- [养育官寇库的靴子](Varsh_Ko'kuu's_Boots.md "Varsh Ko'kuu's Boots") (也可以通过对话获得)

## 相关文献

- [给养育官寇库的通知](Notice_to_Varsh_Ko'kuu.md "Notice to Varsh Ko'kuu")
...
- ⁠[Varsh Ko'kuu](https://forgottenrealms.fandom.com/wiki/Varsh_Ko%27kuu) 在 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page)
