...
**降咒：攻击劣势** 是一个 [3级死灵学派法术](Spells.md "Spells")。此法术允许施法者诅咒一个目标，使其对施法者的攻击具有劣势。

## 描述

用你的触碰诅咒一个生物。该生物对你进行的 [攻击掷骰](Attack_roll.md "Attack Roll") 具有 [劣势](Disadvantage.md "Disadvantage")。
...
---
*Source: [Bestow Curse: Attack Disadvantage](https://bg3.wiki/wiki/Bestow_Curse:_Attack_Disadvantage)*