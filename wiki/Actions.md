...
所有生物均可使用的动作。
职业动作
通过[特性](Features.md "Features")（例如从[职业](Classes.md "Classes")或[装备](Equipment.md "Equipment")获得）可用的动作。[NPC](Non-player_characters.md "Non-player characters")采取的许多动作也被视为职业动作。
种族动作
