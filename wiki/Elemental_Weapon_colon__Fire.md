...
为武器注入火焰之力。它获得 +1 的 [攻击掷骰](Attack_roll.md "Attack Roll") 加值，并造成额外的 1d4⁠⁠[火焰](Fire.md "Fire") 伤害。
...
- 获得 +1 的 [攻击掷骰](Attack_roll.md "Attack Roll") 加值，并造成额外的 1d4⁠⁠[火焰](Fire.md "Fire") 伤害。
...
- 只有 [魔契主](The_Hexblade.md "The Hexblade") 可以获得升环施法版本的元素武器。
- 它可以与 [魔法武器](Magic_Weapon.md "Magic Weapon") 叠加。

---
*Source: [Elemental Weapon: Fire](https://bg3.wiki/wiki/Elemental_Weapon:_Fire)*