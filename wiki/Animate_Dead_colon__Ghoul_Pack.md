...
**操纵死尸：食尸鬼群**是一个[法术](Spells.md "法术")。该法术是[操纵死尸：食尸鬼](Animate_Dead_colon__Ghoul.md "操纵死尸：食尸鬼")的更高等级版本，可以召唤3个[食尸鬼](Ghoul_(Animate_Dead).md "食尸鬼（操纵死尸）")，而非1个。相应地，使用者也必须为此法术指定3具尸体，而非1具。
