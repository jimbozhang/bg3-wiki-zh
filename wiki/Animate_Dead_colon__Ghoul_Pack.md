...
本文介绍的是该法术的6级变体。关于基础法术，请参见[操纵死尸](Animate_Dead.md "操纵死尸")。关于其他用途，请参见[操纵死尸（消歧义）](Animate_Dead_(disambiguation)..md)

**操纵死尸：食尸鬼群**是一个[6级死灵学派法术](Spells.md "法术")。该法术是[操纵死尸：食尸鬼](Animate_Dead_colon__Ghoul.md "操纵死尸：食尸鬼")的更高等级版本，可以召唤3个[食尸鬼](Ghoul_(Animate_Dead).md "食尸鬼（操纵死尸）")，而非1个。相应地，使用者也必须为此法术指定3具尸体，而非1具。

## 描述

创造3个[食尸鬼](Ghoul_(Animate_Dead).md) 专注于近战战斗。
...
啃咬倒伏、倒地或沉睡的目标，造成3d10 + 力量调整值[挥砍](Slashing.md "挥砍")伤害。治疗等量生命值。
...
---
*Source: [Animate Dead: Ghoul Pack](https://bg3.wiki/wiki/Animate_Dead:_Ghoul_Pack)*