...
| [织法束缚藤蔓](Weavebound_Vines_(Condition).md "织法束缚藤蔓 (状态)") | 由织法本身编织而成的藤蔓——一种极不正统的惑控。使受影响实体[失能](Weavebound_Vines_(Condition).md "失能")。当实体被攻击时驱散。 |

---
*Source: [Entangled (Condition)](https://bg3.wiki/wiki/Entangled_(Condition)*