...
- [帕梅拉·吉基米](https://www.imdb.com/name/nm0422691/)
...
`S_UND_DuergarSquadRude` ###

UUID

`b15669aa-831b-43d7-ac7b-efea2eb09018` ###

属性

`UND_KC_Duergar_Caster` **心智奴役者 凯特尔**是[幽暗地域](Underdark.md "幽暗地域")中[海盗格雷蒙](Greymon.md "海盗格雷蒙")船员的一名灰矮人施法者，出现在[第一幕](Act_One.md "第一幕")。
...
从[幽暗地域](Underdark.md "幽暗地域")海滩登上船只后，一艘由海盗格雷蒙指挥的船驶近了队伍的船。格雷蒙登船，玩家角色必须通过一次[属性检定](Ability_Check.md "属性检定")来说服他让队伍通过前往[复仇之炉](Grymforge.md "复仇之炉")。如果检定失败或选择暴力，格雷蒙会发起攻击，凯特尔也会加入战斗。
...
深入敌人的思维，使其[感知](Wisdom.md "感知")[豁免检定](Saving_throw.md "豁免检定")具有[劣势](Disadvantage.md "劣势")。
...
你的[护甲等级](Armour_Class.md "护甲等级")提高 5，但使用力量的[属性检定](Ability_checks.md "属性检定")和[豁免检定](Saving_throws.md "豁免检定")具有[劣势](Disadvantage.md "劣势")，且你的武器伤害减少 1d4（最低为 1 点伤害）。

范围：自身

### 盟友

- [炼金术师 阿格拉姆](Argram.md "炼金术师 阿格拉姆")
- [波纳](Bonna.md "波纳")
- [格雷蒙](Greymon.md "格雷蒙")
- [赫克](Hurk.md "赫克")
- [杰里斯](Jerris.md "杰里斯")
...
---
*Source: [Kettel](https://bg3.wiki/wiki/Kettel)*