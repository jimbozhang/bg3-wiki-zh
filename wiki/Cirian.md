...
- [罗茜·琼斯](https://www.imdb.com/name/nm4676915/)
...
每次杀死一个生物，获得1层[不可撼动](Unstoppable.md "不可撼动")。
...
`S_LOW_Park_BhaalAssassin03` ###

UUID

`f28f8cd6-dc57-434e-a3ac-ed13cd9ed952` ###

属性

`LOW_Cultist_Bhaal_DeathsHead_Disguise` ## 变体 1
...
`a3df2622-d2fc-4423-9c30-6185ad6e704d` ###

属性

`LOW_Cultist_Bhaal_DeathsHead_Disguise` **希莱恩**是[巴尔教团](Cult_of_Bhaal.md "巴尔教团")的成员，在[第三幕](Act_Three.md "第三幕")期间于[下城区](Lower_City.md "下城区")的[繁花山脊公园](Bloomridge_Park.md "繁花山脊公园")被找到。
...
希莱恩被发现与[险恶蒙面人](Sinister_Hooded_Man.md "险恶蒙面人")在公园中[博德安](Balduran.md "博德安")雕像的台阶下交谈。与她对话会触发与该区域邪教徒的战斗。

## 战斗

### 攻击与能力

[谋杀灵光](Aura_of_Murder_(action).md "谋杀灵光 (动作)")
...
---
*Source: [Cirian](https://bg3.wiki/wiki/Cirian)*