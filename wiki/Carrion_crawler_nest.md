...
在[破败村落](Decrepit_Village.md "Decrepit Village")的东南端，坐标 X: 30 Y: -238 处，一处陡峭的岩石斜坡上可以发现一个奇特的孔洞结构。

如果队伍与其中一个孔洞互动，他们可以检查孔洞并选择将手臂伸入其中：

- [幽暗地域] [求生] _检查孔洞。_ (DC 15)
- [求生] _检查孔洞。_ (DC 15)
- [矮小] _将手臂伸入其中一个孔洞。_
- _将手臂伸入其中一个孔洞。_
...
---
*Source: [Carrion crawler nest](https://bg3.wiki/wiki/Carrion_crawler_nest)*