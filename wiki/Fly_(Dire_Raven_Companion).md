...
飞向目标位置并创建一小团[黑暗](Darkness_(cloud).md "黑暗 (云)")。

## 属性

消耗
[移动速度](Resources.md#Movement_speed "资源")
详情
范围：18 米（60 英尺）
范围效果：3 米（10 英尺）半径
创建区域：黑暗
...
一道魔法黑暗帷幕，使范围内的生物被重度遮蔽并目盲。生物无法向黑暗内或从黑暗内进行远程攻击。
...
生物使用：[神速鸦](Corvus_Celer.md "神速鸦")

## 备注

- 作为自由动作，只要恐鸦仍有移动距离，即可在单回合内重复执行。
- 神速鸦拥有[天眼通](Raven_Sight.md "天眼通")，使其免疫黑暗云的目盲效果。

---
*Source: [Fly (Dire Raven Companion)](https://bg3.wiki/wiki/Fly_(Dire_Raven_Companion)*