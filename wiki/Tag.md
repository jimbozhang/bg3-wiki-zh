...
**标签**在_[博德之门3](Baldur's_Gate_3.md "博德之门3")_中是附着在生物身上的标识符。它们可以对游戏玩法产生各种影响，例如启用额外的对话选项，或决定生物是否可以被特定法术锁定。游戏中有许多不同的标签。有些由角色的背景和固有特征定义，而另一些则通过执行特定动作获得。
...
[圣武士](Paladin.md "圣武士")没有职业标签，只有其选择的副职标签。[牧师](Cleric.md "牧师")也缺乏职业标签，只有基于其选择神祇的特殊标签。通过[身兼多职](Multiclassing.md "身兼多职")选择另一个职业也会授予该职业的标签。
...
只有圣武士和邪术师有其每个副职的标签。对于野蛮人，只有狂战士副职有标签。
...
所有[出身](Origin.md "出身")角色和[伙伴](Companions.md "伙伴")都有一个特定于它们的标签。
...
- 博德人 – 如果角色的种族不是来自[幽暗地域](Underdark.md "幽暗地域")（[地底侏儒](Deep_Gnome.md "地底侏儒")、[卓尔](Drow.md "卓尔")、[半卓尔](Drow_Half-Elf.md "半卓尔")、[灰矮人](Duergar.md "灰矮人")）或[星界](Astral_Plane.md "星界")（[吉斯洋基人](Githyanki.md "吉斯洋基人")），则授予此标签。
...
- 独眼 – 在以下情况下授予：
  ...
  - 角色在第一幕或第二幕同意[瓦罗](Volo.md "瓦罗")的手术后，拥有[瓦罗的人造眼](Volo's_Ersatz_Eye_(passive_feature).md "瓦罗的人造眼（被动特性）")
  - [真魂者](True_Soul.md "真魂者") – 在使用[灵吸怪游说](Illithid_Persuasion.md "灵吸怪游说")七次后授予\[[_验证_](bg3wiki_colon_Verification.md "bg3wiki:验证")\]。
- [幽暗地域](Underdark.md "幽暗地域") – 如果角色的种族来自幽暗地域（[地底侏儒](Deep_Gnome.md "地底侏儒")、[卓尔](Drow.md "卓尔")、[半卓尔](Drow_Half-Elf.md "半卓尔")、[灰矮人](Duergar.md "灰矮人")），则授予此标签。

## 特殊互动

### 伪装术

使用[伪装术](Disguise_Self.md "伪装术")或类似效果时，由种族和亚种授予的标签将被移除，并替换为所选伪装的种族。伪装的亚种是预设的，无法更改。例如，[伪装术：雄性矮人](Disguise_Self_colon__Masc_Dwarf.md "伪装术：雄性矮人")会将玩家变为[黄金矮人](Gold_Dwarf.md "黄金矮人")，同时授予矮人和黄金矮人标签。
...
1. [↑](#cite_ref-1) 这在[抢先体验](Early_Access.md "抢先体验")期间对所有角色都可用，但在正式版发布前被移除。其他牧师神祇也曾可用，参见[已删除内容](Cut_and_Unimplemented_Content.md#Cleric_deities "已删除和未实现的内容")。
