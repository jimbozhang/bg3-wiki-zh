...
`S_WYR_MerchantsHouse_Thug_002` ###

UUID

`e7fc87a2-2320-43fc-83b3-5c9bc2076efe` ###

Stats

`WYR_MerchantsHouse_Human_Barbarian` **欢乐的克朗**是[泽诺维娅·道格](Zenovia_Dawg.md "泽诺维娅·道格")帮派的成员，也是[公会](The_Guild.md "公会")的成员，在[利文顿](Rivington.md "利文顿")的[阿尔弗·格雷戈里奥](Arfur_Gregorio.md "阿尔弗·格雷戈里奥")宅邸外被发现。

## 参与

克朗和[泽诺维娅·道格](Zenovia_Dawg.md "泽诺维娅·道格")帮派的其他成员受雇于[阿尔弗·格雷戈里奥](Arfur_Gregorio.md "阿尔弗·格雷戈里奥")，驱逐目前非法占据他宅邸的难民。如果被敌对，或威吓他失败，阿尔弗会召唤泽诺维娅用武力驱逐难民。如果介入，战斗爆发，克朗会变得敌对。
...
拾取物品或生物并将其投向目标，造成额外伤害并将其击至[倒伏](Prone_(Condition).md "倒伏（状态）").
...
作为附赠动作，使用你装备的武器进行一次近战攻击。

将对野蛮人造成一层[发狂昏迷](Frenzied_Strain_(Condition).md "发狂昏迷（状态）").
...
你的[狂暴](Rage_(Condition).md "狂暴（状态）")转变为狂怒！你获得[狂怒攻击](Frenzied_Strike.md "狂怒攻击")和[愤怒投掷](Enraged_Throw.md "愤怒投掷")。你还可以作为附赠动作进行[即兴近战武器](Improvised_Melee_Weapon_(Bonus_Action).md "即兴近战武器（附赠动作）")攻击。

近战武器、即兴武器和投掷武器造成额外 2 点伤害。获得对[物理伤害](Physical_damage.md "物理伤害")的[抗性](Resistance.md "抗性")，以及在力量[检定](Checks.md "检定")和[豁免检定](Saving_throws.md "豁免检定")中具有[优势](Advantage.md "优势").
...
---
*Source: [Gleeful Clong](https://bg3.wiki/wiki/Gleeful_Clong)*