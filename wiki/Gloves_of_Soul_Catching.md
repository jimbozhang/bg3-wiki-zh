...
每回合一次，在徒手命中时，你恢复 10⁠⁠[生命值](Healing.md "Healing")。或者，你可以放弃治疗，在你的下一回合结束前获得攻击掷骰或豁免检定的 +5 奖励。_\[[参见：错误](Soul_Catching.md#Bugs "Soul Catching")\]_
...
- **灵魂捕捉**存在多处错误：
  ...
  - 它说明穿戴者恢复 10⁠⁠[生命值](Healing.md "Healing")，但实际上它提供了一个能力，使用时才会提供治疗。
