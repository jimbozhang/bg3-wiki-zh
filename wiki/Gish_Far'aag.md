...
- [**战地施法者：专注**](War_Caster_colon__Concentration.md "War Caster: Concentration")

你在维持[法术](Spells.md "Spells")的[专注](Concentration.md "Concentration")时，进行[豁免检定](Saving_throw.md "Saving throw")获得[优势](Advantage.md "Advantage")。

- [**战地施法者：借机施法**](War_Caster_colon__Opportunity_Spell.md "War Caster: Opportunity Spell")

你还可以使用[反应](Reaction.md "Reaction")对离开近战范围的目标施放[电爪](Shocking_Grasp.md "Shocking Grasp")。
...
`S_CRE_MainCheckpointMainGuard` ###

UUID

`161701af-17b7-4def-b378-5f24e95d667f` ###

属性

`Githyanki_Gish` **熟手法'拉格**是[吉斯洋基熟手](Githyanki_gish.md "Githyanki gish")，负责守卫[伊雷珂养育间](Cr%C3%A8che_Y'llek.md "Crèche Y'llek")的入口。任何寻求进入养育间的人都必须先说服她放行。

> “
>
> 灵吸怪的奴仆是需要消灭的东西，而不是讲道理的对象。
>
> „
...
法'拉格最初对队伍友好，但根据对话中的选择，可能会变得敌对。

[找出遗物的秘密](Discover_the_Artefact's_Secrets.md "找出遗物的秘密")的某些结果也会导致法'拉格变得敌对。
...
- [游说] 我被告知要将武器带给最高权威人士。那看起来不像你。(DC 18)
- [吉斯洋基人] [游说] 我将按规程向你的凯斯拉克报告。别忘了自己的身份。(DC 18)

这些检定中的任何一项失败都会导致她和附近的守卫变得敌对。

也可以选择透露他们正在寻找治疗蝌蚪的方法。让[莱埃泽尔](Lae'zel.md "Lae'zel")代表队伍发言也会导致她这样做。队伍也可以直接要求通过：

- [威吓] 让我过去。与我战斗对你来说结局会很糟糕。(DC 18)
- [游说] 你们吉斯洋基人憎恨灵吸怪。我有证据表明他们正在入侵。我们需要你们的帮助。(DC 18)
- [邪念] [威吓] 我是个无与伦比的杀手。你想要我作为你的盟友。(DC 18 )
- [游侠] [威吓] 我猎杀怪物。要么是你，要么是夺心魔——你选吧。(DC 18 )
- [战士] [历史的] _尝试回忆并援引古老的吉斯洋基谈判战礼。 (DC 18)_

无论如何，法'拉格会不怎么费力地让玩家通过，并去医务室寻找[古斯提尔](Stornugoss.md "Stornugoss")，但她的语气变得不那么友好了。
...
限制敌人的视线范围。更容易命中，该生物会更频繁地失手。对其的[攻击掷骰](Attack_roll.md "Attack roll")具有[优势](Advantage.md "Advantage")，敌人攻击时具有[劣势](Disadvantage.md "Disadvantage")。
...
[割裂](Lacerate.md "Lacerate") () – [吉斯洋基长剑](Githyanki_Longsword.md "吉斯洋基长剑")
...
目标无法使用[反应](Reaction.md "Reaction")。此法术对穿着金属[护甲](Armour.md "护甲")的生物具有[优势](Advantage.md "Advantage")。
...
---
*Source: [Far'aag](https://bg3.wiki/wiki/Far'aag)*