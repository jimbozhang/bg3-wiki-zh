...
每[长休](Long_Rest.md "长休")一次，当你的生命值降至 0 时，你恢复 2d6⁠⁠[生命值](Healing.md "治疗")。9 米 / 30 英尺内的盟友也恢复 1d6⁠⁠[生命值](Healing.md "治疗")。
...
- 由于 `TargetConditions` 字段设置不正确，额外的 1d6⁠⁠[生命值](Healing.md "治疗")会影响持有者，除了 2d6⁠⁠[生命值](Healing.md "治疗")之外。
- 由于治疗应用方式的时间限制，持有者可能并不总是获得战斗日志中所述的所有治疗；他们通常只获得 1⁠⁠[生命值](Healing.md "治疗")（来自稳定）或 1d6⁠⁠[生命值](Healing.md "治疗")，而不是所述的 1d6+2d6⁠⁠[生命值](Healing.md "治疗")。持有者也可能获得治疗，但仍保持死亡状态，显示其可掠夺的尸体并有剩余生命值。
