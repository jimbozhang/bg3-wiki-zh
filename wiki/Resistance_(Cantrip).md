...
**抗性**是一种[戏法（防护学派）](Spells.md "法术")。它为生物的[豁免检定](Saving_throw.md "豁免检定")提供临时加值。

## 描述

使目标对法术效果和状态更具抗性：其获得**+1d4**的[豁免检定](Saving_throw.md "豁免检定")加值。
...
- 职业等级 2：[大地结社](Circle_of_the_Land.md "大地结社")
...
抗性的咒语是 **Resisto**，拉丁语意为 _"我抵抗"_。

## 外部链接

- ⁠[抗性](https://forgottenrealms.fandom.com/wiki/Resistance) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page) 上

---
*Source: [Resistance (Cantrip)](https://bg3.wiki/wiki/Resistance_(Cantrip)*