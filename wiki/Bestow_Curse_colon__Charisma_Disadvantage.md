...
**降咒：魅力劣势** 是一个 [3级死灵学派法术](Spells.md "Spells")。此法术允许施法者诅咒一个目标，使其在魅力检定和豁免检定上承受劣势。

## 描述

用你的触摸诅咒一个生物。它在 [魅力](Charisma.md "Charisma") [属性检定](Ability_Check.md "Ability Check") 和 [豁免检定](Saving_throw.md "Saving Throw") 上承受 [劣势](Disadvantage.md "Disadvantage")。
...
- 在使用 [魅力](Charisma.md "Charisma") 的 [属性检定](Ability_Check.md "Ability Check") 和 [豁免检定](Saving_throw.md "Saving Throw") 上承受 [劣势](Disadvantage.md "Disadvantage")。
...
---
*Source: [Bestow Curse: Charisma Disadvantage](https://bg3.wiki/wiki/Bestow_Curse:_Charisma_Disadvantage)*