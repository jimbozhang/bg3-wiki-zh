...
`S_GOB_WolfPens_Kid_001` ###

UUID

`dff4432a-85b4-4d5c-95b5-6d1179dbabf4` ###

属性

`Goblin_Kid` **One** 是 [地精营地](Goblin_Camp.md "Goblin Camp") 中的一个地精小孩，出现在 [第一幕](Act_One.md "Act One")。
...
One 可以在 [破碎圣所](Shattered_Sanctum.md "Shattered Sanctum") 的 [座狼兽栏](Worg_Pens.md "Worg Pens") 中找到，她正急切地用石头砸向一头 [哈尔辛](Halsin.md "Halsin")。
...
- ⁠[One](https://forgottenrealms.fandom.com/wiki/One) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page) 上

---
*Source: [One](https://bg3.wiki/wiki/One)*