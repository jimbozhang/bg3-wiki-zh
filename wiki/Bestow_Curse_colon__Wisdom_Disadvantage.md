...
**降咒：感知劣势**是一个[等级 3 死灵学派法术](Spells.md "Spells")。此法术允许施法者诅咒一个目标，使其在感知检定和豁免检定上遭受劣势。

## 描述

用你的触碰诅咒一个生物。它在[感知](Wisdom.md "Wisdom")的[属性检定](Ability_Check.md "Ability Check")和[豁免检定](Saving_throw.md "Saving Throw")上遭受[劣势](Disadvantage.md "Disadvantage")。
...
[升环施法](Upcasting.md "Upcasting")：当以 4 级法术位施法时，持续时间增加至 20 驱散；以 5 级法术位施法时，持续时间增加至 50 驱散；以 6 级法术位施法时，持续时间增加至 100 驱散。

## 技术细节

UID

`Target_BestowCurse_Ability_Wisdom`
...
- ⁠[降咒](https://forgottenrealms.fandom.com/wiki/Bestow_curse) 在 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page)

---
*Source: [Bestow Curse: Wisdom Disadvantage](https://bg3.wiki/wiki/Bestow_Curse:_Wisdom_Disadvantage)*