...
**徒手打击** 是一种常见的 [动作](Actions.md#Resources "动作")，允许用户在没有装备近战武器时用空手进行攻击。
...
- 为徒手打击添加伤害掷骰但没有 [武僧](Monk.md "武僧") 的 [武术：灵巧打击](Martial_Arts_colon__Deft_Strikes.md "武术：灵巧打击") 的物品和特性，会导致伤害工具提示显示为 0d20 + [力量](Strength.md "力量") 调整值 + 额外的奖励伤害。基础钝击伤害仍会正确施加。
