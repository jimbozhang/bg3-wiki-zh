...
`S_LOW_TheLodge_SocietyMember_02` ###

UUID

`2e6e254e-967c-49ee-a52d-b100eadecbee` ###

属性

`LOW_TheLodge_Warlock` **德尔韦登**是一名 [盾矮人](Shield_Dwarf.md "盾矮人") [邪术师](Warlock.md "邪术师")，也是 [光耀会](Society_of_Brilliance.md "光耀会") 的成员。
...
德尔韦登可以在 [博德之门](Baldur's_Gate.md "博德之门") [下城区](Lower_City.md "下城区") 的 [会所](Lodge.md "会所") 遭遇。
...
对目标造成 8d8⁠⁠[黯蚀](Necrotic.md "黯蚀") 伤害。植物受此法术伤害时承受最大伤害，且对其的 [豁免检定](Saving_throw.md "豁免检定") 具有 [劣势](Disadvantage.md "劣势")。
...
- 由于其属性块中的错误，德尔韦登的移动速度为 9 米 (30 英尺)，而不是矮人应有的 7.5 米 (25 英尺)。

---
*Source: [Delverdenn](https://bg3.wiki/wiki/Delverdenn)*