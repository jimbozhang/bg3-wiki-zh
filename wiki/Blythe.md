...
当近战范围内的敌人攻击一名盟友时，你可以使用[反应](Reaction.md "反应")对该敌人进行一次武器攻击。目标盟友不得拥有哨兵专长。
...
`Human_Cultist_Bhaal_DeathsHead` **巴尔的死亡牧首布莱斯**是位于[底城区](Undercity.md "底城区")[公会大厅](Guildhall.md "公会大厅")外的一名人类[巴尔的死亡牧首](Death's_Head_of_Bhaal.md "巴尔的死亡牧首")，出现在[第三幕](Act_Three.md "第三幕")。
