...
这是BG3Wiki的_模组资源_中心。可以通过以下地址轻松链接：

<https://bg3.wiki/wiki/Modding:Modding_resources>

您可以在Larian的[补丁7](https://larian.club/Patch7)概要和他们的[社区更新#29 - 与模组一起游玩](https://baldursgate3.game/news/community-update-29-playing-with-mods_124)中找到Larian的模组资源。

_如果您正在寻找Larian的官方模组文档，可以在他们的[官方模组维基](https://docs.baldursgate3.game/index.php?title=Main_Page)上找到。_
...
想创建模组？查看[模组创建主页](Modding_colon_Creating_mods.md "Modding:创建模组")！

## 安装模组

需要安装模组的帮助？查看[模组安装和故障排除主页](Modding_colon_Installing_mods.md "Modding:安装模组")

## 工具

您需要一些工具才能开始模组制作。请确保下载以下工具，因为它们基本上是模组制作的必备工具：

- [BG3 Multitool](https://github.com/ShinyHobo/BG3-Modders-Multitool) 由 ShinyHobo 开发
  - 多功能工具是一个很棒的工具，提供了几个重要功能，其中最主要的是能够搜索游戏文件，并将您的模组打包成可导入BG3MM的格式。
- [Lslib](https://github.com/Norbyte/lslib) 由 Norbyte 开发
  - Lslib允许您在可编辑格式和游戏就绪格式之间转换文件。更多详情请参见[模组:解包和转换文件](Modding_colon_Unpacking_and_converting_files.md "Modding:解包和转换文件")。
- [ScriptExtender](https://github.com/Norbyte/bg3se) 由 Norbyte 开发
  - Script Extender为游戏添加了Lua/Osiris脚本支持。
- [Blender](https://www.blender.org/download/lts/3-6/) (推荐3.6版本)
  - 仅当您计划进行任何类型的网格编辑（头发、头部、衣服、武器等）时才需要此工具。
  - [Collada/GR2导入/导出Blender插件](https://github.com/Norbyte/dos2de_collada_exporter) 由 Norbyte 开发
    - 用于导入/导出.BG3使用的.GR2文件。
- [BG3 ModManager (BG3MM)](https://github.com/LaughingLeader/BG3ModManager) 由 LaughingLeader 开发
  - 一个便携式的BG3模组管理器。
...
- 模组 (.PAK文件)：%LocalAppdata%\\Larian Studios\\Baldur's Gate 3\\Mods
- 模组 (松散文件)：<游戏安装路径>\\Baldur's Gate 3\\Data
- 工具 (脚本扩展器、原生模组加载器)：<游戏安装路径>\\Baldur's Gate 3\\bin

### Mac

- 配置文件：User/Documents/Larian Studios/Baldur's Gate 3/PlayerProfiles/Public
- 模组：User/Documents/Larian Studios/Baldur's Gate 3/Mods
...
- 模组：SteamLibrary/steamapps/compatdata/1086940/pfx/drive_c/users/steamuser/AppData/Local/Larian Studios/Baldur's Gate 3/Mods
