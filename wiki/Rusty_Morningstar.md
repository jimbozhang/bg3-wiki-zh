...
**锈钉头锤**是[钉头锤](Morningstars.md "钉头锤")武器家族的一个常见变种。它是一种单手挥舞的[近战武器](Weapons.md "武器")。
...
重量：1.8 千克（3.6 磅）
价格：5 金币
UID `WPN_HUM_Morningstar_A_0_Rusty_A` UUID `f8856d2d-ffda-417c-b7a8-c7aa757903b7` ### 武器动作
...
---
*Source: [Rusty Morningstar](https://bg3.wiki/wiki/Rusty_Morningstar)*