...
目标在 [敏捷](Dexterity.md "Dexterity") [属性检定](Ability_Check.md "属性检定")、[豁免检定](Saving_throw.md "Saving Throw") 和 [攻击掷骰](Attack_roll.md "Attack Roll") 上获得 [劣势](Disadvantage.md "Disadvantage")。

痉挛折磨着生物，损害其 [敏捷](Dexterity.md "Dexterity")。
...
**[癫痫发作](Stricken_With_Seizures_(Condition).md "癫痫发作 (状态)")**

持续时间：永久

- 不自主的痉挛使受影响的实体颤抖，使其在使用 [敏捷](Dexterity.md "Dexterity") 的 [属性检定](Ability_Check.md "属性检定")、[豁免检定](Saving_throw.md "Saving Throw") 和 [攻击掷骰](Attack_roll.md "Attack Roll") 上获得 [劣势](Disadvantage.md "Disadvantage")。
...
- ⁠[疫病术](https://forgottenrealms.fandom.com/wiki/Contagion) 在 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page) 上

---
*Source: [Contagion: Seizure](https://bg3.wiki/wiki/Contagion:_Seizure)*