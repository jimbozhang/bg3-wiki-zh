...
- 重量：0.3 kg (0.6 lb)
- 价格：210 gp
- UID `DEC_Ketheric_Armor_Mask_Scrap_A_Magic` UUID `58968403-4dd6-4611-a7a2-a293ae7cf0b0` Stats `UND_Justiciar_Mask_Magic` ### 特殊效果
...
---
*Source: [Dark Justiciar Mask](https://bg3.wiki/wiki/Dark_Justiciar_Mask)*