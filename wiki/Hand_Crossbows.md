...
手弩是一种单手军用远程[武器](Weapons.md "武器")。以下是大多数手弩共有的基础属性，尽管特殊或魔法变体可能有显著差异。关于这种武器最常见的非魔法类型，请参见[手弩](Hand_Crossbow.md "手弩")。在下方，您可以找到游戏中所有手弩的列表。

## 目录

- [1 属性](#properties)
  - [1.1 动作](#actions)
- [2 手弩列表](#list-of-hand-crossbows)
...
| [手弩（尤格）](Hand_Crossbow_(Yurgir).md "手弩（尤格）") |  | 2d10 | 穿刺 | 0.9 kg / 1.8 lb | 50 | 不可被类人生物使用。 |
...
- [魔法手弩](Magical_Hand_Crossbow.md "魔法手弩") - _[不可访问](Category_colon_Inaccessible.md "类别：不可访问")_
- [锈手弩](Rusty_Hand_Crossbow.md "锈手弩") - _[不可访问](Category_colon_Inaccessible.md "类别：不可访问")_

## 外部链接

- ⁠[手弩](https://forgottenrealms.fandom.com/wiki/Hand_crossbow) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page)

[￪ 返回顶部](#top)

---
*Source: [Hand Crossbows](https://bg3.wiki/wiki/Hand_Crossbows)*