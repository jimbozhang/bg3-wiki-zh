...
战斧是一种两用军用近战[武器](Weapons.md "武器")。以下是大多数战斧共有的基础属性，尽管特殊或魔法变体可能有显著差异。关于该武器最常见的非魔法类型，请参见[战斧](Battleaxe.md "战斧")。在下方，您可以找到游戏中所有战斧的列表。

## 目录

- [1 属性](#properties)
  - [1.1 动作](#actions)
- [2 战斧列表](#list-of-battleaxes)
...
| --- | --- | --- | --- | --- | --- | --- |
| [战斧](Battleaxe.md "战斧") |  | 1d8 | 挥砍 | 1.8 千克 / 3.6 磅 | 50 |  |
...
- [合成斧](Combination_Axe.md "合成斧") - _[无法访问](Category_colon_Inaccessible.md "类别：无法访问")_
- [回旋战斧](Rebound_Battleaxe.md "回旋战斧") - _[无法访问](Category_colon_Inaccessible.md "类别：无法访问")_
- [锈战斧](Rusty_Battleaxe.md "锈战斧") - _[无法访问](Category_colon_Inaccessible.md "类别：无法访问")_
- [幽影战斧](Shadow_Battleaxe.md "幽影战斧") - _[无法访问](Category_colon_Inaccessible.md "类别：无法访问")_

## 外部链接

- ⁠[战斧](https://forgottenrealms.fandom.com/wiki/Battleaxe) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page) 上

[￪ 返回顶部](#top)

---
*Source: [Battleaxes](https://bg3.wiki/wiki/Battleaxes)*