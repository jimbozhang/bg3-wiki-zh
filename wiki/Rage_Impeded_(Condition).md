...
[堆叠ID](Stack_ID.md "堆叠ID"): `RAGE_ARMOUR_BLOCK` [状态组](Status_groups.md "状态组"): [SG_RemoveOnRespec](SG_RemoveOnRespec.md "SG RemoveOnRespec")
...
伤害抗性的丧失*不*适用于狂暴：蛮熊之心，与其他所有变体不同。
