...
另见：[奥术回想](Arcane_Recovery.md "奥术回想") 和 [创造法术位](Create_Spell_Slot.md "创造法术位")
...
- 大地结社德鲁伊获得的自然恢复充能数量等于职业等级除以二，向上取整。例如，5级德鲁伊将拥有总共3点自然恢复充能。
- 这些充能在长休后恢复。
- 恢复一个法术位消耗的充能数量等于法术等级。例如，恢复一个[3级法术位](Spells.md#Spell_slots "法术位")需要消耗3点自然恢复充能。
- 可恢复的最高等级法术位上限为5级，即使11级或12级德鲁伊拥有总共6点充能。
