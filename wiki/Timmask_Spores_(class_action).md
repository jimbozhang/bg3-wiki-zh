...
使生物[昏沉](Befuddled_(Condition).md "昏沉 (状态)")的几率。
...
- 由[孢子守护者护甲](Armour_of_the_Sporekeeper.md "孢子守护者护甲")授予，适用于装备该护甲的[孢子结社](Circle_of_Spores.md "孢子结社")德鲁伊，且[共生实体](Symbiotic_Entity_(Condition).md "共生实体 (状态)")处于激活状态

---
*Source: [Timmask Spores (class action)](https://bg3.wiki/wiki/Timmask_Spores_(class_action)*