...
`S_HAG_Hag_MaskedVictim3` ###

UUID

`d7707fd3-301b-49a3-b7f1-2fb92cfa9805` ###

Stats

`HAG_Masked_Fighter` 请勿与[复仇面具 (脸红的美人鱼)](Mask_of_Vengeance_(The_Blushing_Mermaid).md) 混淆
...
- 她的[复仇打击](Vengeful_Strike.md "复仇打击")可以在一回合内使用两次，这要归功于[睚眦必报](Vengeful.md "睚眦必报")为她提供了一次额外反应。
- 与[睚眦必报](Vengeful.md "睚眦必报")提示中所述的“仅在被攻击时触发”相反，[复仇打击](Vengeful_Strike.md "复仇打击")会对近战范围内任何以复仇面具为目标的攻击作出反应，包括法术。

---
*Source: [Mask of Vengeance (Overgrown Tunnel)](https://bg3.wiki/wiki/Mask_of_Vengeance_(Overgrown_Tunnel)*