...
**命令：掉落** 是一个 [1级惑控学派法术](Spells.md "Spells")。此法术是 [命令术](Command.md "Command") 的一个变体。它允许施法者命令目标丢下武器并停止其他一切行动。
...
- 一个敌人让你将武器掉到地上，类似于 [缴械](Disarmed_(Condition).md "缴械 (状态)")。
...
---
*Source: [Command: Drop](https://bg3.wiki/wiki/Command:_Drop)*