...
3米（10英尺）范围内的盟友对邻近你的敌人进行攻击掷骰时具有[优势](Advantage.md "优势")。

- [**猎物的气味**](Prey's_Scent.md "猎物的气味")

你对被你的游侠[猎人印记](Hunter's_Mark.md "猎人印记")的目标造成额外1d6伤害。
...
`WolfCompanion_Summon_CompanionsBond` ###
...
`Companion_Wolf_5` ## 变体 1

###

UID

`WolfCompanion_Summon_ExceptionalTraining` ###
...
`Companion_Wolf_7` ## 变体 2

###

UID

`WolfCompanion_Summon_8` ###
...
`Companion_Wolf_8` **天狼座**是通过[驯兽师](Beast_Master.md "驯兽师")的[狼伙伴](Wolf_Companion.md "狼伙伴")能力召唤的[狼](Wolf.md "狼")，是[游侠伙伴](Ranger's_Companion.md "游侠伙伴")的变体。当天狼座达到5级时，天狼座会从[天狼座](Lupus.md "天狼座")升级而来，并在驯兽师达到11级时变为[天狼座](Lupus_Optumus.md "天狼座")。
...
随着游侠等级提升，天狼座也会成长，直到在11级时转变为天狼座：

#### 等级 7

- 天狼座获得被动[训练有素](Exceptional_Training.md "训练有素")，使其获得：
...
- 天狼座拥有61[生命值](Hit_Points.md "生命值")（探索者难度下为122）和16[护甲等级](Armour_Class.md "护甲等级")。

---
*Source: [Lupus Major](https://bg3.wiki/wiki/Lupus_Major)*