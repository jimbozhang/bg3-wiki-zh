...
近战攻击未命中时，仍会根据 [力量](Strength.md "力量") [调整值](Ability_Scores.md#Ability_score_modifiers "属性值") 造成 [钝击](Bludgeoning.md "钝击") 伤害，最低为 1。
...
`S_GOB_Festivities_Bugbear_Wanderer` ###

UUID

`c45936ea-2e38-4cf5-b5e1-1ff382888737` ###

属性

`Bugbear` **宝可纳克** 是位于 [地精营地](Goblin_Camp.md "地精营地") 的 [熊地精](Bugbear.md "熊地精")，出现在 [第一幕](Act_One.md "第一幕")。
...
- ⁠[宝可纳克](https://forgottenrealms.fandom.com/wiki/Bao%27ek%27nuk) 在 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page)

---
*Source: [Bao'ek'nuk](https://bg3.wiki/wiki/Bao'ek'nuk)*