...
了不起的复仇之炉是一个[故事道具](Story_Item.md "故事道具")[书籍](Books.md "书籍")。它包含了操作[精金熔炉](Adamantine_Forge_(location).md) of [复仇之炉](Grymforge.md "复仇之炉")的说明。

关于使用精金熔炉的信息记录在这本书的页面上。
...
- UID `UNI_UND_FurnaceSearch_MyconidDrowJournal_Real` UUID `b4d60093-28b0-4076-b2f4-c7c3d3aa9d50` ## 位置

- 在[黑檀湖洞穴](Ebonlake_Grotto.md "黑檀湖洞穴")的隐藏房间中，[夏格林](Xargrim.md "夏格林")的尸体上，坐标 X: 49 Y: -72

## 用法

- 在阅读此文本之前，该书的标题是[《呋噜交配仪式》](Flumph_Mating_Rituals.md "《呋噜交配仪式》")。在通过一次[属性检定](Ability_Check.md "属性检定")后，它会变成“了不起的复仇之炉”。
...
- ⁠[复仇之炉](https://forgottenrealms.fandom.com/wiki/Grymforge)在[被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page)上

---
*Source: [The Great Furnace of Grymforge](https://bg3.wiki/wiki/The_Great_Furnace_of_Grymforge)*