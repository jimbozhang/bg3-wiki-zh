...
本文介绍的内容**[无法通过正常游戏方式获取](Category_colon_Inaccessible.md "Category:Inaccessible")**。但仍可通过第三方工具获取。

另请参阅：[古尔的长臂](The_Long_Arm_of_the_Gur.md "The Long Arm of the Gur")
...
1d10 + 2 (3~12) + [敏捷调整值](Damage_Roll.md#Modifiers "Damage Roll") ⁠[穿刺](Piercing.md "Piercing")
...
重量：8.1 千克 (16.2 磅)
价格：380 金币
UID `MAG_LC_UndeadSlayer_HeavyCrossbow` UUID `85f60e49-d868-4897-afc5-b22e965a0471` Stats `MAG_LC_UndeadSlayer_Crossbow` ### 特殊

**持有此物品者获得：**

[亡魂灾祸](Revenant_Scourge.md "Revenant Scourge")
当对不死生物使用时，此武器的攻击和伤害掷骰获得 +1d4 加成。
...
---
*Source: [Undead Slayer Crossbow](https://bg3.wiki/wiki/Undead_Slayer_Crossbow)*