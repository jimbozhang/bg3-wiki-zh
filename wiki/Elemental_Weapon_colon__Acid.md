...
为武器注入腐蚀之力。它获得 +1 的 [攻击掷骰](Attack_roll.md "Attack Roll") 加值，并造成额外的 1d4⁠⁠[强酸](Acid.md "Acid") 伤害。
...
- 拥有 +1 的 [攻击掷骰](Attack_roll.md "Attack Roll") 加值，并造成额外的 1d4⁠⁠[强酸](Acid.md "Acid") 伤害。
...
- 此法术不与 [元素武器](Elemental_Weapon.md "Elemental Weapon")、[龙族元素武器](Draconic_Elemental_Weapon.md "Draconic Elemental Weapon") 或 [元素年代](Elemental_Age.md "Elemental Age") 的其他变体叠加。
- 只有 [魔契主](The_Hexblade.md "The Hexblade") 可以获得升环版本的元素武器。
- 它与 [魔法武器](Magic_Weapon.md "Magic Weapon") 叠加。

---
*Source: [Elemental Weapon: Acid](https://bg3.wiki/wiki/Elemental_Weapon:_Acid)*