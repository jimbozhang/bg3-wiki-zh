...
重量：0.45 千克（0.9 磅）
价格：40 金币
UID `WPN_HUM_Dagger_A_1` UUID `1eab180b-5bf9-48ea-aece-7ba20d1deb78` ### 武器动作
...
- 在 [染疫村落](Blighted_Village.md "染疫村落") 俯瞰谷仓的小山上，插在一块在营火上烤的肉里

## 备注

- 可通过以下任一检定将匕首从肉块中取出：
- [巧手] _小心地扭动匕首，直到它滑出。_（DC 15）
- [力量] _抓住握柄，用尽全力拔出匕首。_（DC 15）
- [调查] _检查肉块。也许有什么窍门可以取出匕首。_（DC 15）
- _将匕首与肉的纹理对齐并拔出。_

## 外部链接

- ⁠[匕首](https://forgottenrealms.fandom.com/wiki/Dagger) 在 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page) 上

---
*Source: [Dagger +1](https://bg3.wiki/wiki/Dagger_+1)*