...
[石主的使者](Rivington.md#Western_Beach "利文顿")
...
当近战攻击未命中时，可以消耗一个[卓越骰子](Superiority_Die.md "卓越骰子")进行反击。
...
`S_WYR_SmugglersCave_StoneLord_Leader` ###

UUID

`40756dfd-a16c-4586-b1c3-6f0de1c7f515` ###

属性

`WYR_SmugglersCave_StoneLord_Tiefling` **卡利欧斯**是[明斯克](Minsc.md "明斯克")的使者，可以在[利文顿](Rivington.md "利文顿")的[西部海滩](Western_Beach.md "西部海滩")上与[公会](The_Guild.md "公会")成员发生争执时找到他，这发生在[第三幕](Act_Three.md "第三幕")期间。

> “
>
> 到此为止了，公会成员——你们不该信任那些你们称之为男人的老鼠。
>
> „

— 卡利欧斯，嘲讽[法尔林](Farlin.md "法尔林")和她的团伙
...
如果队伍拒绝协助、向卡利欧斯求情或阻止任何一方战斗，双方都会变得敌对。队伍也可以在附近等待战斗开始、加入或等待战斗结束。

如果明斯克在场，他可以尝试解释自己就是石主，但卡利欧斯不相信他。

如果卡利欧斯一方赢得战斗，队伍随后杀死他们，具有[罪犯](Criminal.md "罪犯")背景的队伍成员会获得激励点⁠[易得之物](Criminal.md#Easy_Pickings "罪犯")。
...
在你的打击中施加额外的力量，可能将敌人击至[倒伏](Prone_(Condition).md "倒伏（状态）")。
...
2d6 + 6⁠[钝击](Bludgeoning.md "钝击")

\+ 1d4⁠[雷鸣](Thunder.md "雷鸣")
...
将武器猛击地面，造成额外的[雷鸣](Thunder.md "雷鸣")伤害，伤害值等于你的[熟练项加值](Proficiency_bonus.md "熟练项加值")，雷鸣般冲击附近敌人并可能将他们推开。
...
当攻击未命中时，仍然造成⁠[钝击](Bludgeoning.md "钝击")伤害，伤害值等于你的[力量](Strength.md "力量") [调整值](Ability_scores.md#Ability_score_modifiers "属性值")（最小值为1）。
...
- ⁠[卡利欧斯](https://forgottenrealms.fandom.com/wiki/Cairos) 在 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page)

---
*Source: [Caïros](https://bg3.wiki/wiki/Caïros)*