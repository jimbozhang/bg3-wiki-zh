...
- 目标在其下一回合结束时受到 1d8⁠⁠[中毒](Poison.md "中毒")伤害，除非他们通过一次 [掷骰](Dice_rolls.md#Save_DCs "掷骰") 15 的 [体质](Constitution.md "体质") [豁免检定](Saving_throw.md "豁免检定")。
...
- 受影响实体在其下一回合结束时受到 1d8⁠⁠[毒素](Poison.md "毒素")伤害。
