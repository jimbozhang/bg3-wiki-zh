...
治疗中心占据小镇的西北角。这是一座长条形的两层建筑，末端是一个圆形大厅；二楼仅在圆形部分上方使用，那里存放着医院图书室。在其北侧和东侧，一片大型墓园向外延伸，紧邻河岸。西侧则是停尸房。

治疗中心包括一个医院病房、一个带有儿童病房的附属建筑，以及最引人注目的——一个大型手术室，其外观与旧时用于解剖尸体的解剖剧场极为相似。这里完全由[不死护士](Undead_Nurse.md "不死护士")负责，由驻院外科医生[马鲁斯·索姆](Malus_Thorm.md "马鲁斯·索姆")领导。手术室上方是藏书丰富的图书室；手术室后方是马鲁斯·索姆的办公室。办公室和两个病房都有通往墓园的独立出口。

探索治疗中心对于推进[解除幽影诅咒](Lift_the_Shadow_Curse.md "解除幽影诅咒")任务至关重要，而该任务又是队伍想要招募[哈尔辛](Halsin.md "哈尔辛")作为永久伙伴所必需的。
...
主医院病房是一个矩形大厅，末端有两座螺旋楼梯通往手术室的上层。楼梯下方是用于运送检查目标（及运出遗体）的双开门。大厅两侧还有较小的廊道，分别通向墓园（西侧）和儿童病房（东侧）。

主病房由[馨妲姐妹](Sinda.md "馨妲姐妹")照料，她站在接待台附近。如果队伍使用主入口并靠近她，她会开始对话并礼貌地要求他们排队等候就诊。根据交互角色的特性，有多种[属性检定](Ability_Check.md "属性检定")可让队伍继续前进，具体列在馨妲姐妹的页面上。在所有可能的出身和伙伴中，只有[邪念](Dark_Urge.md "邪念")和[阿斯代伦](Astarion.md "阿斯代伦")无需检定即可说服馨妲。

馨妲锁着的接待台及其旁边的重箱子（均显示红色轮廓）含有一些[炼金术](Alchemy.md "炼金术")材料。接待台的钥匙可从馨妲身上搜刮或扒窃获得。

馨妲身后 X: -210 Y: 0 处的床垫上躺着一具骷髅，携带[真爱之拥](True_Love's_Embrace.md "真爱之拥")。

对面的（东侧）廊道堆满了书架和各种医疗设备。这里可拿取三瓶[睡眠药水](Potion_of_Sleep.md "睡眠药水")。廊道尽头 X: -193 Y: 12 处有一堆木箱，顶部放着一张赌注清单。其中一个箱子内可找到[莎尔的诱惑](Shar's_Temptation.md "莎尔的诱惑")。

该廊道有一扇门通向儿童病房。儿童病房有通往墓园的出口，且廊道距离馨妲的接待台足够远。因此，可使用此路进入治疗中心——无需在入口处进行任何属性检定。
...
尸体附近站着[丽德雯姐妹](Anna_Lidwin.md "安雅·丽德雯")。如果队伍说服她她的“病人”已得到充分照料，她可作为商人。此外，房间内的箱子和篮子含有随机的炼金材料。

### 手术室

从上层廊道看到的手术室景象

建筑的圆形北侧包含手术室，木制楼梯供观察者通往沿墙的巨大书架。前述从医院病房通往上层的螺旋楼梯可到达 X: -199 Y: 26 处的电梯，用于前往医院图书室（见下文）。
...
此外，如果之前未获得，还可赚取以下激励点：

- ⁠[权力腐蚀](Folk_Hero.md#Power_Corrupts "平民英雄")（具有[平民英雄](Folk_Hero.md "平民英雄")背景的角色）——杀死马鲁斯·索姆，无论对话结果如何。
- ⁠[最佳进攻纯属无稽之谈](Soldier.md#The_Best_Offence_is_Virtually_Nonsense "士兵")（具有[士兵](Soldier.md "士兵")背景的角色）——通过对话选项击败他。<sup>[\[1\]](#cite_note-1)</sup>

与马鲁斯·索姆交谈、揭示其故事并击败他，也是进一步获得以下激励点的必要条件：

- ⁠[家族屠杀](Soldier.md#Familicide "士兵")（具有[士兵](Soldier.md "士兵")背景的角色）——杀死索姆家族所有重要成员，凯瑟里克除外。
- ⁠[权力腐蚀……绝对](Folk_Hero.md#Power_Corrupts..._Absolutely "平民英雄")（具有[平民英雄](Folk_Hero.md "平民英雄")背景的角色）——同上。
- ⁠[索姆家族的秘密](Sage.md#Thorm_Family_Secrets "博学")（具有[智者](Sage.md "智者")背景的角色）——发现上述每位成员的命运。
- ⁠[阴影小镇](Entertainer.md#Town_of_Shadows "艺人")（具有[艺人](Entertainer.md "艺人")背景的角色）——发现上述每位成员以及[石匠公会](Mason's_Guild.md "石匠公会")负责人[地狱石匠](Infernal_Mason.md "地狱石匠")的命运。

最后，协助的护士每人携带一件特殊手术工具：[手动吸血器 (+1)](Artificial_Leech_(+1).md "手动吸血器 (+1)")、[骨锯 (+1)](Bonesaw_(+1).md "骨锯 (+1)")、[手术针管 (+1)](Syringe_(+1).md "手术针管 (+1)") 和[手术圆锯 (+1)](Trepan_(+1).md "手术圆锯 (+1)")。搜刮（或扒窃）所有这些物品可为具有[罪犯](Criminal.md "罪犯")背景的角色授予激励点[对症下药](Criminal.md#Right_Tool_for_the_Job "罪犯")。

如果马鲁斯·索姆被杀死，而他的护士未被杀死，她们会升到手术室上层并在那里游荡，对队伍保持中立。此外，队伍探索该地点时可能已发现几名护士死亡。处理完外科医生后，可搜刮其尸体获得[外科医生镇压护符](Surgeon's_Subjugation_Amulet.md "外科医生镇压护符")和[破旧鲁特琴](Battered_Lute.md "破旧鲁特琴")——这是推进[唤醒阿尔特·库拉](Wake_Art_Cullagh.md "唤醒阿尔特·库拉")任务的故事道具。手术室周围的书架可能含有随机的不常见或稀有法术卷轴。
...
墓园从北面环绕治疗中心，并与河流相邻。有多个可能的入口点：

- 主入口：X: -152 Y: 20 处的铸铁大门
- 通往停尸房的小巷侧门（见下文）：X: -219 Y: 16
- 多条从石匠公会（后阳台、后院及外院附属建筑）延伸的藤蔓
- 治疗中心建筑所有房间（图书室除外）的众多出口
...
如果队伍尚未解决[第二幕](Act_Two.md "第二幕")的主要事件，从 X: -235 Y: 54 开始的石阶可眺望[至上真神](Absolute.md "至上真神")大军的广阔营地。沿石阶继续前行，可在 X: -252 Y: 38 处找到一对骷髅。其中一个可搜刮获得[刺客短剑](Assassin's_Shortsword.md "刺客短剑")，另一个可获得[卫士盾牌](Watcher's_Shield.md "卫士盾牌")。此石阶处还有两处埋藏宝藏。
...
— [阿斯代伦](Astarion.md "阿斯代伦")，看着停尸房实验室的血库

通往停尸房的铺砌小路始于手术室旁医院病房的侧门。由一群不死生物守卫：两名[幽影](Shadow.md "幽影")、一名[缚灵](Wraith.md "缚灵")、一只[幽影獒犬](Shadow_Mastiff.md "幽影獒犬")和三名幽影诅咒类人生物——一名人类、一名矮人和一名半兽人。
...
如果队伍反向穿越此区域（从大陵寝出发），雕像上的按钮——位于 X: 42 Y: -969——会打开通往停尸房的门。
...
1. [↑](#cite_ref-3) 也可以在战斗前秘密解除所有通风口——例如，结合[躲藏](Hide.md "躲藏")、[高等隐形术](Greater_Invisibility.md "高等隐形术")和[回合制模式](Turn-based_mode.md "回合制模式")。然而，任何动作后，相关队伍成员必须进行被动[隐匿](Stealth.md "隐匿")检定以保持隐藏。首次检定失败时，僵尸会攻击。
