...
近战攻击未命中时，仍造成等于 [力量](STR.md "STR") 调整值或至少 1 点的 [钝击](Bludgeoning.md "Bludgeoning") 伤害。
...
`S_LOW_CountingHouse_Guard_01` ###

UUID

`316f2520-fe74-4287-869b-88eea90c983d` ###

属性

`LOW_CountingHouse_Melee_Human` **现金守卫打手 莫夫提** ，是位于 [博德之门](Baldur's_Gate.md "Baldur's Gate") [下城区](Lower_City.md "Lower City") [清账屋](The_Counting_House.md "The Counting House") 的现金守卫中的一名人类成员。他可以在主楼层的后室门口守卫时找到。
...
唤起天堂之光，并可能使目标 \_(状态)[目盲](Blinded_(Blinding_Smite)_(Condition).md "Blinded (Blinding Smite) (Condition)")

[体质](Constitution.md "Constitution") [豁免](Saving_throws.md "Saving throws")
射程：普通武器射程

[至圣斩](Divine_Smite.md "Divine_Smite") (+ )
...
---
*Source: [Mofty](https://bg3.wiki/wiki/Mofty)*