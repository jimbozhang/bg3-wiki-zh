...
[堆叠ID](Stack_ID.md "堆叠ID"): `ASPECT_OF_THE_WOLF` [状态组](Status_groups.md "状态组"): [SG_RemoveOnRespec](SG_RemoveOnRespec.md "SG RemoveOnRespec")
...
---
*Source: [Aspect of the Wolf (Condition)](https://bg3.wiki/wiki/Aspect_of_the_Wolf_(Condition)*