...
[堆叠ID](Stack_ID.md "堆叠ID"): `WET` [状态组](Status_groups.md "状态组"): [SG_Surface](SG_Surface.md "SG Surface")
...
- [Steam云服务](Steam_Cloud.md "Steam云服务")
- [一瓶水](Carafe_of_Water.md "一瓶水")
- [近无尽水瓶](Decanter_of_Nearly_Endless_Water.md "近无尽水瓶")
- [反雨斗篷](Reverse_Rain_Cloak.md "反雨斗篷")
- [水](Water.md "水")
- [求水得水](The_Water_Caller.md "求水得水")
...
- 受影响实体的[护甲等级](Armour_Class.md "护甲等级")已降低5点。该唾液可用水清除。

[腐蚀唾液：溶解中](Corrosive_Spit_colon__Dissolving_(Condition).md "腐蚀唾液：溶解中 (状态)")
|

- 每回合受到1d10⁠⁠[强酸](Acid.md "强酸")伤害。
- 受影响实体的[护甲等级](Armour_Class.md "护甲等级")已降低1点。除非用水洗掉，否则唾液会持续侵蚀其防御，进一步降低其护甲等级。

| 状态 | 效果 |
| --- | --- |
| [腐蚀唾液：已溶解](Corrosive_Spit_colon__Dissolved_(Condition).md "腐蚀唾液：已溶解 (状态)") | 受影响实体的[护甲等级](Armour_Class.md "护甲等级")已降低5点。该唾液可用水清除。 |
| [腐蚀唾液：溶解中](Corrosive_Spit_colon__Dissolving_(Condition).md "腐蚀唾液：溶解中 (状态)") | 每回合受到1d10⁠⁠[强酸](Acid.md "强酸")伤害。受影响实体的[护甲等级](Armour_Class.md "护甲等级")已降低1点。除非用水洗掉，否则唾液会持续侵蚀其防御，进一步降低其护甲等级。 |
| [浸湿](Drenched_(Condition).md "浸湿 (状态)") | 你的近战攻击会使目标陷入湿透状态。 |
...
- 与[冻僵](Chilled_(Condition).md "冻僵 (状态)")结合会取代这两种状态，并使目标[冰冻](Frozen_(Condition).md "冰冻 (状态)")。然而，目标必须先被冻僵，然后才能被弄湿，否则不会冻结。
- 变成湿透的角色会洗掉他们和护甲上积累的任何血迹和污垢。
- 湿透的实体如果对⁠[闪电](Lightning.md "闪电")或⁠[寒冷](Cold.md "寒冷")伤害有抗性，其抗性会被抵消，但会受到相应元素的易伤。
