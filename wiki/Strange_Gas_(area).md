...
**奇异气体**是一个[区域](Area.md "Area")。它是[吉斯洋基人](Githyanki.md "Githyanki")信息素的升华物。暴露在此云中时，除非你是吉斯洋基人，否则每回合开始时都需要通过一次[豁免检定](Saving_throw.md "Saving Throw")。
...
- 奇异气体可在[伊雷珂养育间](Crèche_Y'llek.md "Crèche Y'llek")的孵化室中找到。
