...
**云**是一种[区域](Area.md "区域")。云悬停在地面上方，与覆盖地面本身的[地表](Surfaces.md "地表")不同。

## 属性

云通常在角色进入其影响范围时应用其效果。除此之外，大多数云的效果更为具体和个性化。一些云在开始或结束回合时应用额外效果；一些云的效果仅在云内持续，而另一些则应用在离开后仍持续的状态。

云可以通过[造风术](Gust_of_Wind.md "造风术")和[盖尔之灵急冲](Rush_of_the_Gale_Spirits.md "盖尔之灵急冲")移除。

与地表不同，云不是[可蘸取](Dippable.md "可蘸取")的。
...
| [电蒸汽](Electrified_Steam.md "电蒸汽") | 使范围内的生物获得[濡湿](Wet_(Condition).md "濡湿 (状态)")。[电击](Electrocuted_(Condition).md "电击 (状态)") - 每回合受到1d4⁠⁠[闪电](Lightning.md "闪电")伤害。 |
| [雾](Fog.md "雾") | 使范围内的生物[目盲](Blinded_(Condition).md "目盲 (状态)")并阻挡远程攻击进出。 |
...
| [鬼头蘑菇孢子](Timmask_Spores_(cloud).md "鬼头蘑菇孢子 (云)") | 使范围内的生物有几率[昏沉](Befuddled_(Condition).md "昏沉 (状态)")。 |
| [虚空](Void.md "虚空") | 使范围内的生物有几率[目盲](Blinded_(Condition).md "目盲 (状态)")。角色还会在每回合结束时受到⁠⁠[寒冷](Cold.md "寒冷")伤害。 |
