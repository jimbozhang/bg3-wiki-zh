...
3d10 + 5[心灵](Psychic.md "心灵")

详情
近战法术[攻击掷骰](Attack_roll.md "攻击掷骰")
[智力](Intelligence.md "智力")[豁免检定](Saving_throws.md "豁免检定")（[难度等级](DC.md "难度等级") 14）
近战：1.5 米（5 英尺）
...
- 由于此攻击使用近战法术攻击掷骰，因此不符合[额外攻击](Extra_Attack.md "额外攻击")的使用条件。
- 此动作的[难度等级](Difficulty_Class.md "难度等级")固定为 14，不会随任何调整值或特性而变化。

---
*Source: [Tentacle Whip (Full-illithid)](https://bg3.wiki/wiki/Tentacle_Whip_(Full-illithid)*