...
硬头锤是一种单手简易近战[武器](Weapons.md "武器")。以下是大多数硬头锤共有的基础属性，尽管特殊或魔法变体可能有显著差异。关于最常见的非魔法类型，请参见[硬头锤](Mace.md "硬头锤")。在下方，您可以找到游戏中所有硬头锤的列表。

## 目录

- [1 属性](#properties)
  - [1.1 动作](#actions)
- [2 硬头锤列表](#list-of-maces)
...
| [损坏的链枷](Shattered_Flail.md "损坏的链枷") | +2 | 1d6 + 2 | 钝击 | 1.8 kg / 3.6 lb | 190 | [伊诺胡之馈赠](Yeenoghu's_Gift.md "伊诺胡之馈赠")用此武器击中敌人时，使用者恢复1d6⁠⁠[生命值](Healing.md "治疗")——但如果他们没有在每回合继续击中敌人，则可能陷入[疯狂](Madness_(Condition).md "疯狂（状态）")。通过此物品进行的治疗不会触发其他对治疗有反应的被动效果。 |
...
| [信徒硬头锤](Devotee's_Mace.md "信徒硬头锤") | +3 | 1d6 + 3 / 1d8 | 钝击 / 光耀 | 1.8 kg / 3.6 lb | 640 | 仅限主手 [治疗熏香灵光](Healing_Incense_Aura.md "治疗熏香灵光") () 散发舒缓灵光，您和附近盟友在回合开始时恢复1d4[生命值](Healing.md "治疗")（充能：[长休](Long_Rest.md "长休")。） |
| [洛山达之血](The_Blood_of_Lathander.md "洛山达之血") | +3 | 1d6 + 3 | 钝击 | 1.8 kg / 3.6 lb | 640 | [洛山达的祝福](Lathander's_Blessing.md "洛山达的祝福")每[长休](Long_Rest.md "长休")一次，当您的生命值降至0时，您恢复2d6⁠⁠[生命值](Healing.md "治疗")。9米/30英尺内的盟友也恢复1d6⁠⁠[生命值](Healing.md "治疗")。[洛山达的光芒](Lathander's_Light.md "洛山达的光芒")散发半径6米/20英尺的圣光。在战斗中，站在光中的[邪魔](Fiends.md "邪魔")和[不死生物](Undead.md "不死生物")如果未能通过DC 14的体质豁免，则会被[目盲](Blinded_(Condition).md "目盲（状态）")。[阳炎射线](Sunbeam.md "阳炎射线") () 施放为6环法术（充能：[长休](Long_Rest.md "长休")。） |
...
- ⁠[硬头锤](https://forgottenrealms.fandom.com/wiki/Mace) 于 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page)

[￪ 返回顶部](#top)

---
*Source: [Maces](https://bg3.wiki/wiki/Maces)*