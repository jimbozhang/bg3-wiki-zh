...
`S_END_HarperSummon001` ###

UUID

`97e7a9d6-4f11-4de9-bda2-7197d5647971` ###

属性

`END_HarperRanger_Elf` ## 变体 1

###

UID

`S_END_HarperSummon002` ###

UUID

`7518e757-234a-4a16-899b-873c749d06ad` ###

属性

`END_HarperRanger_Elf` ## 变体 2

###

UID

`S_END_HarperSummon003` ###

UUID

`753a3cf7-4718-4715-b963-5eb6e74bfac7` ###

属性

`END_HarperRanger_Halfling` **竖琴手弓箭手**是可召唤的、可靠的盟友，在[第三幕](Act_Three.md "第三幕")提供远程支援。
...
如果[贾希拉](Jaheira.md "贾希拉")是盟友且所有先前的[竖琴手](Harpers.md "竖琴手")化身均已死亡，则可以使用[召集盟友](Gather_Your_Allies_(class_action).md "召集盟友 (职业动作)")的变体[白银竖琴中队](Silver_Harp_Squadron.md "白银竖琴中队")来召唤竖琴手弓箭手。
...
---
*Source: [Harper Archer](https://bg3.wiki/wiki/Harper_Archer)*