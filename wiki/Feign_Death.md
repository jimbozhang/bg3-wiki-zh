...
**假死术**是一个[3级死灵学派法术](Spells.md "法术")。它允许施法者让盟友进入魔法保护性昏迷状态，假装死亡。
...
- 根据犯罪的严重程度，其他队伍成员也可能被审问，并需要进行魅力检定。鉴于这一点，建议对轻微犯罪（如[扒窃](Sleight_of_Hand.md "巧手")）或更严重的犯罪（如果其他队伍成员不在附近）使用**假死术**。
