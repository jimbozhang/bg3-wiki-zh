...
如果角色的隐匿值足够高，敌人有时即使其盟友在远处被攻击和杀死，也无法注意到他们。这甚至可以与 [火球术术](Fireball.md "火球术术") 等范围效果法术一起使用，只要施法的队伍成员保持隐藏。敌人会四处奔跑，拼命搜索队伍成员但无法找到他们。这可以通过高 [敏捷](Dexterity.md "敏捷") 分数、[熟练项](Proficiency.md "熟练项") 和 [专精](Expertise.md "专精") 隐匿、[优势](Advantage.md "优势") 敏捷或隐匿检定，以及某些法术和能力（如 [行动无踪](Pass_Without_Trace.md "行动无踪")）来实现。
