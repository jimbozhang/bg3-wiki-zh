...
**解除秘法锁**是一个[等级 2 防护学派法术](Spells.md "Spells")。此法术允许施法者解除其秘法锁。

## 描述

移除你施加在门或容器上的[秘法锁](Arcane_Lock.md "Arcane Lock")。
...
---
*Source: [Dismiss Arcane Lock](https://bg3.wiki/wiki/Dismiss_Arcane_Lock)*