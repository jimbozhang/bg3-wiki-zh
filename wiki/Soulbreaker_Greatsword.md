...
碎魂者巨剑是一把稀有 +1 [巨剑](Greatswords.md "巨剑")，它赋予持有者[碎魂者](Soulbreaker.md "碎魂者")武器动作和[先攻](Initiative.md "先攻")掷骰加值；当由[吉斯洋基人](Githyanki.md "吉斯洋基人")持有时，它还会造成额外的心灵伤害。

锋利的金属向你低语。恳求着。诅咒着……被击败敌人的回响。
...
重量：2.7 千克 (5.4 磅)
价格：380 金币
UID `MAG_Githborn_Mindcrusher_Greatsword` UUID `523a959d-4101-4beb-9a8e-276c3f687c02` Stats `MAG_Githborn_Mindcrusher_Greatsword` ### 特殊效果
...
- 吉斯灵能武器提供的吉斯洋基人专属加成，也可以通过[伪装术](Disguise_Self.md "伪装术")成吉斯洋基人来启用。但是，持有者必须在装备武器前进行伪装才能生效。
...
---
*Source: [Soulbreaker Greatsword](https://bg3.wiki/wiki/Soulbreaker_Greatsword)*