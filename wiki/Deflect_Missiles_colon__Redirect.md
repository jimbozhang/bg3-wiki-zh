...
本文介绍的是将飞弹投掷回去的后续反应。关于最初接住飞弹的反应，请参见 [拨挡飞弹](Deflect_Missiles.md "拨挡飞弹")。

**拨挡飞弹**是[武僧](Monk.md "武僧")的[反应](Reaction.md "反应")，允许在首先使用[拨挡飞弹](Deflect_Missiles.md "拨挡飞弹")接住飞弹后，将远程武器投射物投掷回攻击者。
...
- 如果两名武僧被同一[游侠](Ranger.md "游侠")的单次[疾速齐射](Volley.md "疾速齐射")击中，他们可以同时将伤害反击回发送者。
