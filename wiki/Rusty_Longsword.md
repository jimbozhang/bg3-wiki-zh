...
**锈长剑**是[长剑](Longswords.md "长剑")武器家族的常见变体。这是一把[军用近战武器](Weapons.md "武器")，可以单手持用，或双手持用以获得额外伤害。
...
重量：1.35 千克 (2.7 磅)
价格：4 金币
UID `WPN_HUM_Longsword_A_0_Rusty_A` UUID `dddd2204-0ee3-47b0-a7ea-6b5216a65e89` ### 武器动作
...
- 位于[瑰晨修道院](Rosymorn_Monastery.md "瑰晨修道院")鹰巢正下方

\[[Category:挥砍伤害来源]

---
*Source: [Rusty Longsword](https://bg3.wiki/wiki/Rusty_Longsword)*