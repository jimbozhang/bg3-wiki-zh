...
`Human_Cultist_Bhaal_Reaper` **加兹**，伪装成**夜刃 爱德华·特伦比**，是一个[变形怪](Doppelganger.md "变形怪")，在[博德之门](Baldur's_Gate.md "博德之门")的[底城区](Undercity.md "底城区")内的[废弃蓄水池](Abandoned_Cistern.md "废弃蓄水池")中的石王藏身点被发现。
...
加兹是[明斯克](Minsc.md "明斯克")船员的一部分，可以在他的藏身点找到。如果队伍解决了水闸门谜题或通过[运动](Athletics.md "运动")检定打开大门，加兹和其余船员会变得敌对，并在队伍到达隧道尽头时攻击队伍。
