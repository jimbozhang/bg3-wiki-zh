...
**黎明破晓**是[瑰晨修道院](Rosymorn_Monastery.md "瑰晨修道院")中[破晓者](Dawnbreaker.md "破晓者")陷阱使用的一种动作，用于将入侵者推下悬崖致死。

## 描述

释放一道能量脉冲，可能将所有附近的生物和物体推开并使其[倒伏](Prone_(Condition).md "倒伏 (状态)")。
...
- 由[瑰晨修道院](Rosymorn_Monastery.md "瑰晨修道院")中的陷阱触发。

## 错误

- 工具提示错误地显示“目标仍会受到一半伤害”，而实际上目标既不会被推开也不会被击倒。

---
*Source: [Break of Dawn](https://bg3.wiki/wiki/Break_of_Dawn)*