...
**命令术：逃窜** 是一个 [等级 1 惑控学派法术](Spells.md "Spells")。此法术是 [劝诫复生者](Exhort_the_Risen.md "Exhort_the Risen") 的变体，与 [命令术：逃窜](Command_colon__Flee.md "Command: Flee") 相似，但仅适用于不死生物。它允许施法者命令其不死生物目标从你身边逃窜。

## 描述

命令一个生物在其回合逃离你，并且不做其他任何事情。
...
以此法术的更高法术位施法不会获得额外收益。

## 技术细节

UID

`Target_MAG_Myrkulites_CommandUndead_Flee`
...
**[命令术：逃窜](Command_colon__Flee_(Condition).md "命令术：逃窜（状态）")**
...
---
*Source: [Command: Flee (Undead)](https://bg3.wiki/wiki/Command:_Flee_(Undead)*