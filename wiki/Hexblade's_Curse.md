...
诅咒一个目标。你对目标的伤害掷骰获得等于你[熟练项加值](Proficiency_Bonus.md "熟练项加值")的加值。攻击目标时需要掷出[重击](Critical_Hit.md "重击")的数值也减少1。

如果目标死亡，你将恢复邪术师等级 + 魅力调整值的[生命值](Hit_Points.md "生命值")。
...
邪术师等级 + [魅力调整值](Charisma.md#Charisma_modifier_chart "魅力")⁠[治疗](Healing.md "治疗")
