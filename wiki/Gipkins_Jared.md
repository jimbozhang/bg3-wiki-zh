...
- [Kate O'Rourke](https://www.imdb.com/name/nm4566041/)
...
`S_WYR_Ironhand_ArtificerExtra_001` ###

UUID

`a47370d5-d3f6-4acb-9d87-5d13a1f7e83c` ###

属性

`WYR_IronHand_Gnome_Deep_Melee` **吉普金斯·贾里德**是[利文顿](Rivington.md "利文顿")的[铁手氏族](Clan_Ironhand.md "铁手氏族")侏儒，出现在[第三幕](Act_Three.md "第三幕")。

## 参与

### 第三幕

如果在[第一幕](Act_One.md "第一幕")和[第二幕](Act_Two.md "第二幕")中只有两名铁手侏儒幸存，吉普金斯会在[角铁地窖](Angleiron's_Cellar.md "角铁地窖")与铁手侏儒抵抗军一同出现。
...
[摔绊攻击（近战）](Trip_Attack_(Melee).md "摔绊攻击（近战）") (+ ) – [巨剑](Greatsword.md "巨剑")
...
---
*Source: [Gipkins Jared](https://bg3.wiki/wiki/Gipkins_Jared)*