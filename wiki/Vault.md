...
另请参阅：[保险柜](Safe.md "Safe")

这是一个消歧义页面，指向名称模糊的文章。如果您是通过文章中的链接[被带到这里](Special_colon_WhatLinksHere/Vault.md "Special:WhatLinksHere/Vault")的，请考虑编辑该链接以指向正确的页面。
...
- 地点：
  ...
  - ⁠[秘密下水道保险库](Guildhall.md#Secret_Sewer_Vault "Guildhall") - 可从 [九指基恩](Nine-Fingers_Keene.md "Nine-Fingers Keene") 的卧室进入
- 多个 [保险库钥匙](Vault_Key.md "Vault Key") 之一

---
*Source: [Vault](https://bg3.wiki/wiki/Vault)*