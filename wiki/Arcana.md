...
**奥秘**是一种基于[智力](Intelligence.md "智力")的[技能](Skill.md "技能")。

它代表了对奥术魔法和魔网的学术理解，但施法并不需要它。生物的智力属性越高，他们成功通过奥秘[检定](Checks.md "检定")的可能性就越大。
...
**熟练**奥秘的角色在进行[属性检定](Ability_Check.md "属性检定")时可以添加其[熟练项加值](Proficiency_Bonus.md "熟练项加值")。

以下[背景](Background.md "背景")授予奥秘熟练项：

- [智者](Sage.md "智者")

以下职业可以在1级时选择奥秘作为熟练技能：

- [吟游诗人](Bard.md "吟游诗人")
- [德鲁伊](Druid.md "德鲁伊")
- [游侠](Ranger.md "游侠") - 通过宿敌选项[面纱守护者](Keeper_of_the_Veil.md "面纱守护者")或[法师破坏者](Mage_Breaker.md "法师破坏者")
- [术士](Sorcerer.md "术士")
- [邪术师](Warlock.md "邪术师")
- [法师](Wizard.md "法师")
...
- 用于对话。
- 用于识别或揭示魔法物品和一些超自然生物的信息，尤其是来自其他位面的生物。

## 提升或惩罚的方法

提高或降低[智力](Intelligence.md "智力")也会使智力调整值（因此也影响奥秘）每偶数增减1点。
...
---
*Source: [Arcana](https://bg3.wiki/wiki/Arcana)*