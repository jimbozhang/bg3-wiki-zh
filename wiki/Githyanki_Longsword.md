...
**吉斯洋基长剑**是[长剑](Longswords.md "长剑")武器家族的一种常见变体。它是一种[军用近战武器](Weapons.md "武器")，可以单手持用，或双手持用以获得额外伤害。

这把精致长剑的每一处尖端和刃口都磨得致命而完美。
...
重量：1.35 千克 (2.7 磅)
价格：40 金币
UID `WPN_Longsword_Gith` UUID `907a794b-b089-406b-880d-6f2df2bb3f13` ### 武器动作
...
- [伊雷珂养育间](Cr%C3%A8che_Y'llek.md "伊雷珂养育间")：在武器架上，以及众多吉斯洋基人装备

---
*Source: [Githyanki Longsword](https://bg3.wiki/wiki/Githyanki_Longsword)*