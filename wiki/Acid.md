...
关于游戏中 **强酸** 的其他可能含义，请参见：**[强酸（消歧义）](Acid_(disambiguation).md "强酸（消歧义）")**
...
- [守卫刻文：强酸](Glyph_of_Warding_colon__Acid.md "守卫刻文：强酸")
- [哈达之饥渴](Hunger_of_Hadar.md "哈达之饥渴")
- [马友夫强酸箭](Melf's_Acid_Arrow.md "马友夫强酸箭")

### 职业动作

- [啃咬（双脊龙）](Bite_(Dilophosaurus).md "啃咬（双脊龙）")
...
以下装备为穿戴者的攻击添加强酸伤害，或可通过其他方式造成强酸伤害。

- [腐蚀指环](Caustic_Band.md "腐蚀指环")：武器攻击造成 +2⁠⁠强酸伤害。
- [血肉消熔披风](Fleshmelter_Cloak.md "血肉消熔披风")：当生物对穿戴者造成近战伤害时，该生物受到 1d4⁠⁠强酸伤害。
...
- [腐液手套](Ichorous_Gloves.md "腐液手套")：造成强酸伤害时，同时对目标施加[有毒烟雾](Noxious_Fumes_(Condition).md "有毒烟雾（状态）")。
- [养育官寇库的靴子](Varsh_Ko'kuu's_Boots.md "养育官寇库的靴子")：[强酸](Acid_(surface).md "强酸（地表）")地表不影响穿戴者，且穿戴者[抗性](Resistant.md "抗性")⁠强酸伤害。
- [元素强化项链](Necklace_of_Elemental_Augmentation.md "元素强化项链")：当使用[戏法](Cantrip.md "戏法")造成强酸伤害时，将[施法调整值](Spellcasting_Modifier.md "施法调整值")添加到伤害中。

## 注释

- [强酸桶](Acid_Barrel.md "强酸桶")：销毁时创建[强酸](Acid_(surface).md "强酸（地表）")地表，但不造成任何伤害。

---
*Source: [Acid](https://bg3.wiki/wiki/Acid)*