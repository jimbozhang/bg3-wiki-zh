...
此[生物专属](NPC.md "NPC")动作允许使用者传送至视线范围内的任何地点，而不会触发[借机攻击](Opportunity_Attacks.md "Opportunity Attacks")。

## 描述

被银色雾气环绕，你传送至一个你能看到的未被占据的空间。
