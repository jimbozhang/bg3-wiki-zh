...
- [1 软件](#software)
- [2 概述](#overview)
- [3 基础色/基础贴图](#basecolour/Base_Map)
- [4 法线贴图](#normal-map)
- [5 物理贴图](#physical-map)
  - [5.1 红色通道：金属度](#red-channel:_Metalness)
  - [5.2 绿色通道：粗糙度](#green-channel:_Roughness)
  - [5.3 蓝色通道：环境光遮蔽](#blue-channel:_Ambient_Occlusion)
- [6 MSK](#msk)
  - [6.1 使用 Blender 制作 MSK 文件](#make-msk-files-with-blender)
- [7 GM](#gm)
- [8 如何打开纹理并提取其文件](#how-to-open-a-texture-and-extract-its-files)
  - [8.1 物理贴图](#physical-map-2)
  - [8.2 BM 和 MSK](#bm-and-msk)
  - [8.3 法线贴图](#normal-map-2)
- [9 文件大小](#file-sizes)
- [10 如何保存纹理](#how-to-save-the-textures)
- [11 记住你的 Mipmap](#remember-your-mipmaps)
- [12 工具](#tools)
