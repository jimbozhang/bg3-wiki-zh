...
可供[圣武士](Paladin.md "圣武士")职业准备的法术列表。

## 概述

圣武士法术是[预备法术](Prepared_spells.md "预备法术")，因此所有圣武士都可以使用这些法术（最多到其圣武士等级），并在任何时候准备有限数量的法术。
...
| [命令术](Command.md "命令术") | 1 |  |  | - | 18米 / 60英尺 | [感知](Wisdom.md "感知") [豁免检定](Saving_throws.md "豁免检定") | - |
| [强令对决](Compelled_Duel.md "强令对决") | 1 |  |  | 3回合 | 9米 / 30英尺 | [感知](Wisdom.md "感知") [豁免检定](Saving_throws.md "豁免检定") | - |
...
- [惊惧斩](Staggering_Smite.md "惊惧斩")、[放逐斩](Banishing_Smite.md "放逐斩")和[湮灭波](Destructive_Wave.md "湮灭波")是圣武士专属的法术，但无法由他们学习，因为在D&D 5e中，这些法术仅在13级和17级解锁。

---
*Source: [List of Paladin spells](https://bg3.wiki/wiki/List_of_Paladin_spells)*