...
美味血肉之歌是长剑武器家族中一种稀有、中等附魔（+2）的变体。它是一种[军用近战武器](Weapons.md "Weapons")，可单手持用，或双手持用以获得额外伤害。

或许只是你的想象，但当鲜血流过剑刃时，你几乎能听到……吮吸声。
...
重量：1.35千克（2.7磅）
价格：250金币
UID `MAG_LC_Fleshred_Longsword` UUID `5c41bb72-9a50-4d98-a12a-0de374c43f19` ### 武器动作
...
---
*Source: [Render of Scrumptious Flesh](https://bg3.wiki/wiki/Render_of_Scrumptious_Flesh)*