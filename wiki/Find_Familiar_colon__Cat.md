...
**获得魔宠：猫**是一个[1级咒法学派法术](Spells.md "Spells")。此法术是[获得魔宠](Find_Familiar.md "获得魔宠")的变体，可召唤一只小型猫到施法者身边。

## 描述

召唤一只猫魔宠，它可以使用[猫叫声](Meow.md "Meow")来分散敌人的注意力。
...
---
*Source: [Find Familiar: Cat](https://bg3.wiki/wiki/Find_Familiar:_Cat)*