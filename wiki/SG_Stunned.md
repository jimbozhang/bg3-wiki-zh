...
本文介绍的是状态组。有关具体状态，请参见 [震慑（状态）](Stunned_(Condition)..md)

**震慑**是一个[状态组](Status_group.md "状态组")。此状态组中的状态通常会阻止受影响的生物进行任何类型的行动。
...
- 受影响实体无法控制其行动，且会漫无目的地四处游荡。

[木僵](Catatonic_(Condition).md "木僵（状态）")
|

- 阿尔特·库拉已关闭，似乎对周围发生的一切完全无反应。

[困惑呆滞](Confused_Stupor_(Condition).md "困惑呆滞（状态）")
|

- 过于困惑而无法行动 - 受影响实体会浪费其回合，什么也不做。

[力竭](Lethargic_(Condition).md "力竭（状态）")
|

- 在[加速术](Haste.md "加速术")效果结束后被疲惫吞噬。
- 无法[移动](Movement_speed.md "移动速度")或进行[动作](Actions.md#Resources "动作")、[附赠动作](Actions.md#Resources "动作")或[反应](Actions.md#Reactions "动作")。
...
[欢笑折磨](Mirth-Wracked_(Condition).md "欢笑折磨（状态）")
|

- 被狂野的笑话震慑。在受到伤害前，无法移动或进行[动作](Action.md "动作")、[附赠动作](Bonus_action.md "附赠动作")或[反应](Reaction.md "反应")。

[平息](Pacified_(Condition).md "平息（状态）")
|

- 失能。无法移动或进行动作、附赠动作或反应。
...
---
*Source: [Stunned (status group)](https://bg3.wiki/wiki/Stunned_(status_group)*