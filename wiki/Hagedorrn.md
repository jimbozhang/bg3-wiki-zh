...
`S_LOW_SWS_Patrols_OnWall_FF_001` ###

UUID

`b944774a-ab63-4325-81a0-3931fbbe0842` ###

Stats

`FlamingFist_Human_Ranger` **拳手哈格多恩**是一名[人类](Human.md "人类")游侠，也是[焰拳](Flaming_Fist.md "焰拳")的成员。她可以在[下城区](Lower_City.md "下城区")的[第三幕](Act_Three.md "第三幕")中找到。

> “
>
> 我刚才在想一个我非常想念的人，他看起来很像你。但你不是他，所以请离开。
>
> „
...
哈格多恩与[拳手埃奎德纳](Equidna.md "拳手埃奎德纳")一起，持续在[下城主墙](Lower_City_Central_Wall.md "下城主墙")顶部巡逻，从其断口尽头走到[扎尔宅邸](Szarr_Palace.md "扎尔宅邸")的入口。如果与她对话，她会要求玩家角色离开。
...
---
*Source: [Hagedorrn](https://bg3.wiki/wiki/Hagedorrn)*