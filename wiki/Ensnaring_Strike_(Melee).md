...
关于此法术的远程版本，请参见 [诱捕攻击（远程）](Ensnaring_Strike_(Ranged).md "Ensnaring Strike (Ranged)")。

**诱捕打击（近战）** 是一个 [1级咒法学派法术](Spells.md "Spells")。此法术允许施法者使用近战武器攻击，用荆棘藤蔓诱捕敌人，并每回合对其造成穿刺伤害。

## 描述

你的攻击会召唤荆棘藤蔓，可能 \_(状态)[诱捕](Ensnared_(Ensnaring_Strike)_(Condition).md "诱捕（诱捕打击）（状态）") 目标。
...
- [荆棘之刃](Thorn_Blade.md "荆棘之刃")（充能：[长休](Long_Rest.md "长休")）
...
- 此法术与 [游侠](Ranger.md "游侠") 的 [宿敌](Favoured_Enemy.md "宿敌") 被动 [赏金猎人](Bounty_Hunter.md "赏金猎人") 搭配良好。
...
<https://bg3.wiki/wiki/File:Ensnaring_Strike_(Melee)_Action.mp4>

## 外部链接

- ⁠[诱捕打击](https://forgottenrealms.fandom.com/wiki/Ensnaring_strike) 在 [被遗忘的国度维基](https://forgottenrealms.fandom.com/wiki/Main_Page)

---
*Source: [Ensnaring Strike (Melee)](https://bg3.wiki/wiki/Ensnaring_Strike_(Melee)*