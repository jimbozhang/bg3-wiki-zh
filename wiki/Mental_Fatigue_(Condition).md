...
[堆叠ID](Stack_ID.md "堆叠ID")：`MAG_PSYCHIC_MENTAL_FATIGUE` [如果已应用](Conditions.md#Stack_type "状态")：增加持续时间
...
- 精神疲劳造成的伤害在战斗日志中显示为“心灵放电”。
- 尽管有工具提示，精神疲劳在屏幕上可以堆叠到任意数量。豁免检定减值的实际上限为-20。

## 精神疲劳的来源

- [精神抑制](Mental_Debilitation.md "精神抑制")
- [精神抑制](Mental_Inhibition.md "精神抑制")
...
- [脑力汲取斗篷](Braindrain_Cape.md "脑力汲取斗篷")：当穿戴者对任何敌人的法术或动作的[豁免检定](Saving_throw.md "豁免检定")成功时，该敌人获得精神疲劳。注意：此物品无法通过正常游戏获得。仍可通过第三方工具访问。

---
*Source: [Mental Fatigue (Condition)](https://bg3.wiki/wiki/Mental_Fatigue_(Condition)*