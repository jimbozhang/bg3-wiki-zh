...
**以太漫游**是相位蜘蛛使用的附赠动作。其行为类似于[迷踪步](Misty_Step.md "迷踪步")，允许蜘蛛传送至22米（73英尺）内的一个未被占据的空间。

## 描述

被银色雾气环绕，你传送至一个你能看见的未被占据的空间。
...
---
*Source: [Ethereal Jaunt](https://bg3.wiki/wiki/Ethereal_Jaunt)*