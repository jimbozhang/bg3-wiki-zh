...
近战范围的弩攻击不会获得[劣势](Disadvantage.md "劣势")。
...
`S_GLO_GithRaider_002` ###

UUID

`5dd3bb4a-97fa-48b6-9489-5cd577d217f2` ###

属性

`Githyanki_Raider` **掠夺者乔斯特**是[山隘](Mountain_Pass.md "山隘")中[第一幕](Act_One.md "第一幕")期间的一名吉斯洋基掠夺者。
...
乔斯特是[凯斯拉克百夫长沃斯](Voss.md "沃斯")搜索队中的远程武器专家。该小队的任务是搜寻[荒野](Wilderness.md "荒野")以取回一件强大武器。乔斯特只能在战斗中与之互动。
...
乔斯特最多可使用四个[卓越骰子](Battle_Master.md#Level_3 "战斗大师")施展[策略](Manoeuvres.md "策略")：
...
- [熟手佛瑞斯](For'reth.md "佛瑞斯")
- [掠夺者扎斯特里](Zastri.md "扎斯特里")
- [萨斯十夫长巴瑞萨](Baretha.md "巴瑞萨")

### 战利品

- [伊尔梅特之箭](Arrow_of_Ilmater.md "伊尔梅特之箭") - 2x（如果未使用）
...
- ⁠[乔斯特](https://forgottenrealms.fandom.com/wiki/Chost) 在 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page) 上

---
*Source: [Chost](https://bg3.wiki/wiki/Chost)*