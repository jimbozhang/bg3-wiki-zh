...
`S_LOW_GrottoCheckpointGuard_001` ###

UUID

`1effcc57-318d-4d42-873d-7550a399a40b` ###
...
诅咒一个生物被黑暗纠缠。如果它进入或在其回合开始时处于轻度或重度遮蔽区域，它将受到 2d8[黯蚀](Necrotic.md "Necrotic")伤害。
...
阻止目标治疗，直到你的下一回合。目标无法协助[倒地](Downed_(Condition).md "Downed (Condition)")的角色。不死生物目标在[攻击掷骰](Attack_roll.md "Attack Roll")时获得[劣势](Disadvantage.md "Disadvantage")。
...
- [写给自己(血迹)](Note_to_Self_(Bloodstains).md "Note to Self (Bloodstains)") (提及)

---
*Source: [Hyrald](https://bg3.wiki/wiki/Hyrald)*