...
[堆叠ID](Stack_ID.md "堆叠ID"): `PASS_WITHOUT_TRACE` [状态组](Status_groups.md "状态组"): [SG_RemoveOnRespec](SG_RemoveOnRespec.md "SG RemoveOnRespec")
...
- [暗影技艺：行动无踪](Shadow_Arts_colon__Pass_Without_Trace.md "暗影技艺：行动无踪")
