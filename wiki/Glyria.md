...
- \_(状态)[谋杀灵光](Cult_of_Bhaal.md "谋杀灵光 (NPC) (状态)")

2 米 (7 英尺) 内的敌人对穿刺伤害[易伤](Vulnerability.md "易伤")。

- [不可撼动](Medium.md "不可撼动 (状态)")

将下一次受到的伤害降低至 1 点，并消耗一层不可撼动。无法被外力移动。

## 状态

- \_(状态)[谋杀灵光](Humanoid.md "谋杀灵光 (NPC) (状态)")

2 米 (7 英尺) 内的敌人对穿刺伤害[易伤](Vulnerability.md "易伤")。

- [不可撼动](Human.md "不可撼动 (状态)")
...
佯攻以可能使对手[失衡](Darkvision.md "失衡 (状态)")。

[敏](Dexterity.md "敏捷") [豁免](Saving_throw.md "豁免检定")
射程：正常武器射程
...
斩击目标的要害部位使其[流血](Murder_Hungry.md "流血 (状态)")。

[不死生物](Undead.md "不死生物")和[构装生物](Constructs.md "构装生物")无法流血。

[体](CON.md "体质") [豁免](Saving_throw.md "豁免检定")
射程：正常武器射程
充能：[短休](Short_rest.md "短休")

[主手攻击](Melee_Attack.md "主手攻击") – [凶残切割](Murderous_Cut.md "凶残切割")
...
以 18 米 (60 英尺) 内它能看到的一个生物为目标。目标必须成功通过[感知](WIS.md "感知")[豁免检定](Saving_throw.md "豁免检定")，否则将被[震慑](Stunned_(Condition).md "震慑 (状态)")直到其下一回合结束。**硬核难度：** 此动作不需要[专注](Concentration.md "专注")。

[感](WIS.md "感知") [豁免](Saving_throw.md "豁免检定")
射程：18 米 (60 英尺)
充能：每回合
