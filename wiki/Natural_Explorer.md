...
[游侠](Ranger.md "游侠")对特定类型的自然环境特别熟悉，并擅长在这些区域旅行和生存。他们在等级 1、6 和 10 时选择一种偏好的地形，并因此获得相关的增强效果。

## 自然探索者选项列表

_以下部分可以使用 `{{:Natural Explorer}}` 被包含到其他页面中。_

| 架构 | 描述 | 授予 |
| --- | --- | --- |
| [驯兽师](Beast_Tamer.md "驯兽师") | 你与动物建立了牢固的联系。你可以以[仪式](Ritual.md "仪式")形式施放[获得魔宠](Find_Familiar.md "获得魔宠")。 | 每[短休](Short_Rest.md "短休")一次施放[获得魔宠](Find_Familiar.md "获得魔宠") |
