...
以下物品可使角色在对抗此状态组中所有状态的豁免检定上获得 [优势](Advantage.md "优势")：

- [灰矮人解毒剂](Duergar_Antidote.md "灰矮人解毒剂")

以下法术/动作可使角色在对抗此状态组中所有状态的豁免检定上获得 [优势](Advantage.md "优势")：

- [防护毒素](Protection_from_Poison.md "防护毒素")

以下被动特性可使角色在对抗此状态组中所有状态的豁免检定上获得 [优势](Advantage.md "优势")：
...
- 高级中毒感染。[力量](Strength.md "力量")、[敏捷](Dexterity.md "敏捷")、[体质](Constitution.md "体质")、[智力](Intelligence.md "智力")、[魅力](Charisma.md "魅力") 和 [感知](Wisdom.md "感知") 降低 6 点。生物休息越多，感觉越糟。

\_(状态)[濒死](At_Death's_Door_(Moderate)_(Condition).md "濒死 (中等) (状态)")
|

- 中等中毒感染。[力量](Strength.md "力量")、[敏捷](Dexterity.md "敏捷")、[体质](Constitution.md "体质")、[智力](Intelligence.md "智力")、[魅力](Charisma.md "魅力") 和 [感知](Wisdom.md "感知") 降低 4 点。生物休息越多，感觉越糟。

\_(状态)[濒死](At_Death's_Door_(Emergent)_(Condition).md "濒死 (紧急) (状态)")
|

- 紧急中毒感染。[力量](Strength.md "力量")、[敏捷](Dexterity.md "敏捷")、[体质](Constitution.md "体质")、[智力](Intelligence.md "智力")、[魅力](Charisma.md "魅力") 和 [感知](Wisdom.md "感知") 降低 2 点。生物休息越多，感觉越糟。
...
- 在 [攻击掷骰](Attack_roll.md "攻击掷骰") 和 [属性检定](Ability_Check.md "属性检定") 上承受 [劣势](Disadvantage.md "劣势")。
- 每回合必须通过 [豁免检定](Saving_throw.md "豁免检定")，否则毒素将进入下一阶段。3 次成功则恢复。3 次失败则感染与施放的 [疫病术](Contagion.md "疫病术") 变体对应的疾病。
...
- 所有对目标的攻击在 3 米（10 英尺）内具有 [优势](Advantage.md "优势") 和 [重击](Critical_Hit.md "重击")。
...
- 持续到受影响的实体通过 [体质](Constitution.md "体质") [豁免检定](Saving_throw.md "豁免检定")。

[感染卓尔毒药](Stricken_with_Drow_Poison_(Condition).md "感染卓尔毒药 (状态)")
|

- 受影响的实体 [中毒](Poisoned_(Condition).md "中毒 (状态)") 并陷入 [沉睡](Sleeping_(Condition).md "沉睡 (状态)")。
- 持续到受影响的实体通过 [体质](Constitution.md "体质") [豁免检定](Saving_throw.md "豁免检定") 或受到伤害。

[感染怨恨](Stricken_with_Malice_(Condition).md "感染怨恨 (状态)")
|

- 受影响的实体目盲且中毒。
- 在 [攻击掷骰](Attack_rolls.md "攻击掷骰") 上承受 [劣势](Disadvantage.md "劣势")，其攻击和法术范围缩短至 3 米（10 英尺）。
- 对目盲生物的攻击掷骰具有 [优势](Advantage.md "优势")。
- 在 [检定](Checks.md "检定") 上承受 [劣势](Disadvantage.md "劣势")。

[狂乱之舌](Tongue_of_Madness_(Condition).md "狂乱之舌 (状态)")
|

- 大声说出每个想法，在魅力 [检定](Checks.md "检定") 上获得 [劣势](Disadvantage.md "劣势")。
...
- 受影响的实体在其下一回合结束时受到 1d8⁠⁠[中毒](Poison.md "中毒") 伤害。
