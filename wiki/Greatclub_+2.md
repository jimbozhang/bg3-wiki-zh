...
巨棒 +2 是一件稀有、中等附魔（+2）的[巨棒](Greatclubs.md "Greatclubs")。

这根沉重的棍棒末端的黄铜螺旋散发着蓝色的光芒。
...
重量：4.5 千克（9 磅）
价格：95 金币
UID `WPN_HUM_Greatclub_A_2` UUID `adf0ef57-7811-40ed-9d29-05c6336f9e1f` Stats `WPN_Greatclub_2` ### 武器动作
...
---
*Source: [Greatclub +2](https://bg3.wiki/wiki/Greatclub_+2)*