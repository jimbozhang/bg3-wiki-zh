...
巨棒是一种双手简易近战[武器](Weapons.md "武器")。以下是大多数巨棒共有的基础属性，但特殊或魔法变体可能大不相同。关于这种武器最常见的非魔法类型，请参阅[巨棒](Greatclub.md "巨棒")。在下方，您可以找到游戏中所有巨棒的列表。

## 目录

- [1 属性](#properties)
  - [1.1 动作](#actions)
- [2 巨棒列表](#list-of-greatclubs)
...
| --- | --- | --- | --- | --- | --- | --- |
| [多节树枝](Gnarled_Tree_Branch.md "多节树枝") |  | 2d8 | 钝击 | 8.5 公斤 / 17 磅 | 16 | 类人生物不可用。 |
...
- [巨棒 +2](Greatclub_+2.md "巨棒 +2") - _[不可访问](Category_colon_Inaccessible.md "类别：不可访问")_

## 外部链接

- ⁠[巨棒](https://forgottenrealms.fandom.com/wiki/Greatclub) 于 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page)

[￪ 返回顶部](#top)

---
*Source: [Greatclubs](https://bg3.wiki/wiki/Greatclubs)*