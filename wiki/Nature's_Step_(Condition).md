...
- 免疫[麻痹](Paralyzed_(status_group).md)、[束缚](Restrained_(status_group).md)和[劣势地形](Difficult_Terrain_(status_group).md)状态组中的所有。

## 属性

[堆叠ID](Stack_ID.md "堆叠ID"): `NATURES_STEP_AURA_DRYAD` [更多属性](Status_properties.md "状态属性"):
