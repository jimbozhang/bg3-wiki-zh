...
你的攻击造成额外1d6⁠⁠[心灵](Psychic.md "Psychic")伤害——灵吸怪奴役的伤痕深深刻入骨髓。
...
`S_CRE_CaptainOfficeSquad03` ###

UUID

`9c72cc0e-d0a7-4faf-977c-0aa042de48cd` ###

属性

`Githyanki_Warrior` **战士 Xon'ar'as** 是一名在[第一幕](Act_One.md "Act One")中出现的[吉斯洋基人](Githyanki.md "Githyanki")[战士](Warrior.md "Warrior")。
...
对敌人进行非致命攻击，可能使其[眩晕](Dazed_(Condition).md "Dazed (Condition)")。
...
调动体力保护自己。恢复1d10 + 战士等级⁠⁠[生命值](Healing.md "Healing")。
