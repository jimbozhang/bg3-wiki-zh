...
使用[武僧武器](Monk.md#Monk_weapons "武僧")进行攻击或徒手攻击后，你可以作为附赠动作进行另一次徒手攻击。

- [**武艺：敏捷攻击**](Martial_Arts_colon__Dextrous_Attacks.md "武艺：敏捷攻击")

如果你的敏捷更高，[武僧武器](Monk.md#Monk_weapons "武僧")的攻击和徒手攻击将使用你的敏捷而非力量进行计算。
...
`S_INT_PortalGithyanki_Wave2_Melee_01` ###

UUID

`99b01e7f-ff4b-4b55-b275-dd0d02c08a0e` ###

Stats

`Githyanki_Gishra_Melee` **高级吉斯拉 泽尔林**是[吉斯拉](Gish'ra_(melee).md) 在[第三幕](Act_Three.md "第三幕")开始时遭遇，在长休期间攻击队伍。他是[俄耳甫斯](Orpheus.md "俄耳甫斯")的荣誉守卫之一，正在为释放他而战。
...
在[第二幕](Act_Two.md "第二幕")结束时的长休期间，队伍突然被各种吉斯洋基武僧的攻击惊醒。泽尔林是传送门中出现的第二波吉斯洋基的一部分。
...
---
*Source: [Zelrin](https://bg3.wiki/wiki/Zelrin)*