...
`S_UND_DuergarRebelPatroller_02` ###

UUID

`407307ff-6adb-488c-9576-534e2c158e29` ###

属性

`UND_KC_Duergar_Ranger` **莫里斯**是[焰须氏族](Clan_Flameshade.md "Clan Flameshade")的灰矮人游侠，在[复仇之炉](Grymforge.md "Grymforge")的[第一幕](Act_One.md "Act One")期间出现。
...
莫里斯在被奴役的[地底侏儒](Deep_Gnome.md "Deep gnome")附近巡逻。如果队伍与[布里特瓦尔](Brithvar.md "Brithvar")密谋对抗[尼讷](Nere.md "Nere")，莫里斯会忠于焰须氏族，并加入对抗卓尔和灰矮人至上真神教徒的战斗。
...
消耗 6 米 (20 英尺) 的[移动速度](Movement_speed.md "Movement Speed")。在你的回合剩余时间内，投掷两次远程伤害并使用较高结果。
...
你的攻击会召唤荆棘藤蔓，可能\_(状态)[诱捕](Ensnared_(Ensnaring_Strike)_(Condition).md "Ensnared (Ensnaring Strike) (Condition)")你的目标。
...
- 尽管拥有 4 个一级[法术位](Spell_Slot.md "Spell Slot")和 2 个二级法术位，莫里斯没有可用的游侠法术。

---
*Source: [Mirthis](https://bg3.wiki/wiki/Mirthis)*