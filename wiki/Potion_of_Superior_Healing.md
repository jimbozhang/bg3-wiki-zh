...
另请参阅：[治疗药水](Potion_of_Healing.md "治疗药水")、[高等治疗药水](Potion_of_Greater_Healing.md "高等治疗药水") 和 [极效治疗药水](Potion_of_Supreme_Healing.md "极效治疗药水")

**特效治疗药水**是一种[消耗品](Consumables.md "消耗品")（[药水](Potions.md "药水")）。饮用后可恢复[生命值](Hit_Points.md "生命值")。
...
- 重量：0.1 千克 (0.2 磅)
- 价格：25 金币
- UID `CONS_Potion_Healing_A_Superior` UUID `df4f3495-abaf-4732-b82f-55bcccd561db` Stats `OBJ_Potion_Healing_Superior` ### 效果
...
**[特效治疗药水](Potion_of_Superior_Healing_(cloud).md "特效治疗药水 (云)")**
...
---
*Source: [Potion of Superior Healing](https://bg3.wiki/wiki/Potion_of_Superior_Healing)*