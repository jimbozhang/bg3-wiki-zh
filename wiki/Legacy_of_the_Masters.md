...
- UID `MAG_BG_OfTheMasters_Legacy_Gauntlet` UUID `c9ea7679-d30a-481f-b45b-c0427d569ec7` Stats `MAG_BG_OfTheMasters_Legacy_Gauntlet` File `ARM_Gloves_Metal_C` ### 特殊效果
...
- **武器增强**提供的+2攻击掷骰加值也会影响法术、徒手和投掷攻击；然而，投掷攻击（涉及具有[投掷](Thrown.md "投掷")属性的武器）不会获得+2伤害加值。
