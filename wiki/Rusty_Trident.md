...
**锈三叉戟**是[三叉戟](Tridents.md "Tridents")武器家族的一个常见变种。它是一种[军用近战武器](Weapons.md "Weapons")，可以单手持用，或双手持用以获得额外伤害。其设计使其非常适合作为投射物[投掷](Thrown.md "Thrown")向敌人。
...
1d6 (1~6) + [力量调整值](Damage_Roll.md#Modifiers "Damage Roll") ⁠[穿刺](Piercing.md "Piercing")

双手伤害

1d8 (1~8) + [力量调整值](Damage_Roll.md#Modifiers "Damage Roll") ⁠[穿刺](Piercing.md "Piercing")
...
重量：1.8 千克 (3.6 磅)
价格：4 金币
UID `WPN_HUM_Trident_A_0_Rusty_A` UUID `27ef84b1-ea40-4f06-a013-f6281511f0e9` ### 武器动作
...
---
*Source: [Rusty Trident](https://bg3.wiki/wiki/Rusty_Trident)*