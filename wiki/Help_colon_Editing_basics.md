...
- [1 页面标签](#page-tabs)
  - [1.1 编辑](#edit)
  - [1.2 讨论](#discussion)
  - [1.3 查看历史](#view-history)
- [2 链接](#linking)
  - [2.1 内部链接](#internal-linking)
  - [2.2 外部链接](#external-links)
- [3 模板](#templates)
  - [3.1 使用可视化编辑器添加模板](#adding-templates-using-the-visual-editor)
  - [3.2 使用源代码编辑器添加模板](#adding-templates-using-the-source-editor)
- [4 分类](#categories)
- [5 创建新页面](#creating-new-pages)
  - [5.1 创建重定向](#creating-redirects)
- [6 附加资源](#additional-resources)
