...
`S_LOW_SWS_Patrols_001_FF_000` ###

UUID

`04589068-fb1d-4497-8a54-38eebe94290a` ###

属性

`FlamingFist_Human_Melee_Attacker` **拳头斯塔蕾特**是一名[人类](Human.md "人类")战士，也是[焰拳](Flaming_Fist.md "焰拳")的成员。她可以在[第三幕](Act_Three.md "第三幕")的[下城区](Lower_City.md "下城区")街道上找到。
...
---
*Source: [Starrlet](https://bg3.wiki/wiki/Starrlet)*