...
`S_WYR_South_GoldQuestGiver` ###

UUID

`ad4a43f4-a86c-4946-a696-43a4ba4e6b45` ###

属性

`FlamingFist_Human_Melee_Attacker` **精卫法尔考**是一名[人类](Human.md "人类")<sup>[\[1\]](#cite_note-1)</sup> [战士](Fighter.md "战士")，也是[焰拳](Flaming_Fist.md "焰拳")的一员。他可以在[飞龙关](Wyrm's_Crossing.md "飞龙关")的[第三幕](Act_Three.md "第三幕")中找到。
