...
**信仰守望者的藤蔓** 是一个 [等级 1 咒法学派法术](Spells.md "Spells")。此法术允许施法者召唤魔法藤蔓，并将射程内的一个区域转变为劣势地形。生物在该区域内站立时可能被 [缠绕](Entangled_(Condition).md "缠绕 (状态)")，且移动速度减半。其效果等同于德鲁伊的等级 1 法术 [纠缠](Entangle.md "纠缠")。
