...
- 受影响的实体已被秘术师卡里翁诅咒。它处于[中毒](Poisoned_(Condition).md "中毒 (状态)")状态。
- 在其回合结束时，它必须通过一次体质[豁免检定](Saving_throw.md "豁免检定")，否则将受到[秘术师卡里翁的目盲诅咒](Mystic_Carrion's_Blinding_Curse_(Condition).md "秘术师卡里翁的目盲诅咒 (状态)")影响，并受到2d10⁠⁠[黯蚀](Necrotic.md "黯蚀")伤害。
...
---
*Source: [Mystic Carrion's Poisoned Curse (Condition)](https://bg3.wiki/wiki/Mystic_Carrion's_Poisoned_Curse_(Condition)*