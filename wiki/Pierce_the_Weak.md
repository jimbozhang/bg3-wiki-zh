...
使一个敌人对[穿刺](Piercing.md "Piercing")伤害处于[易伤](Vulnerable.md "Vulnerable")状态。
...
`Target_MAG_Gish_WeaknessBranding_Piercing`
...
- 受影响实体在 3 驱散内对[穿刺](Piercing.md "Piercing")伤害处于[易伤](Vulnerable.md "Vulnerable")状态，或直到其受到伤害。
...
---
*Source: [Pierce the Weak](https://bg3.wiki/wiki/Pierce_the_Weak)*