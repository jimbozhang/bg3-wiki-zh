...
如果你的敏捷更高，使用[武僧武器](Monk.md#Monk_weapons "武僧")和徒手攻击时，攻击检定将基于敏捷而非力量。
...
你的反应如同任何[护甲](Armour.md "护甲")一样有效。未穿着护甲时，你将你的[感知调整值](Wisdom.md#Wisdom_Modifier_Chart "感知")加到你的[护甲等级](Armour_Class.md "护甲等级")上。
...
`S_INT_Githyanki_FirstContact_001` ###

UUID

`798325ee-42ad-4237-86b1-e1410a548e26` ###

Stats

`Githyanki_Gishra_Melee` **高级熟手 K'i'lar** 是在[星界](Astral_Plane.md "星界")第三幕开始时遭遇的[熟手](Gish'ra_(melee).md)。她是[俄耳甫斯](Orpheus.md "俄耳甫斯")的荣誉守卫之一，正在为释放他而战。
...
在[第二幕](Act_Two.md "第二幕")结束时的长休期间，队伍突然被各种吉斯洋基武僧的攻击惊醒。随后，队伍被[梦境守护者](Dream_Guardian.md "梦境守护者")召唤进一个传送门。K'i'lar 是星界内第一波武僧的一部分，可以看到她正在与一群[噬脑怪](Intellect_Devourer.md "噬脑怪")战斗。
