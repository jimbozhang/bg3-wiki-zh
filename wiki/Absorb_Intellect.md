...
**吞噬智力**是一种[灵吸怪威能](Illithid_powers.md "灵吸怪威能")，它会吸取目标的[智力](Intelligence.md "智力")，并随时间治疗使用者。每回合的治疗量和智力减少量起始分别为1d8⁠⁠[治疗](Healing.md "治疗")和-1，随后每回合叠加增加1d8⁠⁠[治疗](Healing.md "治疗")和-1的减少量，持续5回合。
