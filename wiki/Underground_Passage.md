...
不要与[蔓生地道](Overgrown_Tunnel.md "蔓生地道")混淆
...
[空谷](The_Hollow.md "空谷")
↑
|  | **地下通道** | → | [闲庭图书馆](Enclave_Library.md "闲庭图书馆") |
↓
[森林](Forest.md "森林")
**地下通道**是[博德之门3](Baldur's_Gate_3.md "博德之门3")[第一幕](Act_One.md "Act_One")中[翠绿林地](Emerald_Grove.md "Emerald Grove")内的一个[地点](Location.md "Location")。

> “
>
> 我觉得那座雕像的眼睛发光不是为了照明。最好小心点。
>
> „

— [影心](Shadowheart.md "Shadowheart")，发现内部的守护者雕像时
...
| ↑ |  |  |  |  |
|  |  | 地下通道 | → | [闲庭图书馆](Enclave_Library.md "Enclave Library") |
| ↓ |  |  |  |  |
| [森林](Forest.md "Forest") |  |  |  |  |

地下通道是一个洞穴状的隧道，大致与[空谷](Hollow.md "Hollow")的西侧平行，将[翠绿林地](Emerald_Grove.md "Emerald Grove")的某些部分与[森林](Forest.md "Forest")连接起来。通道内设有多个守护者雕像陷阱，会向视线内的任何闯入者投掷火焰，造成2d6⁠⁠[火焰](Fire.md "Fire")伤害，并在一次失败的DC 12[敏捷](Dexterity.md "Dexterity")[豁免检定](Saving_throw.md "Saving Throw")下施加3回合的[燃烧](Burning_(Condition).md "燃烧 (状态)")状态。
...
最后一个符文隐藏在从水中突出的岩石露头侧面，到达它需要从隧道主路径跳跃。

或者，可以从远处攻击并摧毁雕像。

## 互动

如果队伍尚未击败[地精营地](Goblin_Camp.md "Goblin Camp")，他们会发现一名昏迷的[芬德尔](Findal.md "Findal")被几只地精包围。击败地精后，队伍可以治疗芬德尔或告诉他他们要完成工作。如果是前者，他将返回林地，稍后可在[内圣所](Inner_Sanctum.md "Inner Sanctum")遇到。击败地精并治疗芬德尔会为具有[平民英雄](Folk_Hero.md "Folk Hero")背景的角色获得激励点[及时救援](Folk_Hero.md#A_Timely_Rescue "平民英雄")。然而，如果队伍带着[萨扎](Sazza.md "Sazza")，芬德尔会意识到他偶然发现了一次逃跑企图，并可能变得敌对。

当芬德尔仍昏迷时，可以自由扒窃[远古之匙](Key_of_the_Ancients.md "Key of the Ancients")；他醒来后不会指控队伍偷窃。
...
- ⁠[解救地精萨扎](Save_the_Goblin_Sazza.md "Save the Goblin Sazza")
...
- [格雷什](Gresh.md "Gresh")
- [古尔扎](Gurza.md "Gurza")
- [萨扎](Sazza.md "Sazza") - 条件性
- [托拉克](Torrack.md "Torrack")
- [蠕虫](Worm.md "Worm")
...
1. [↑](#cite_ref-1) 远古之匙可以从地下通道的[芬德尔](Findal.md "Findal")身上获取，或从[内圣所](Inner_Sanctum.md "Inner Sanctum")的[内蒂](Nettie.md "Nettie")身上获取。
1. [↑](#cite_ref-2) 隧道内还有一座第六座麋鹿雕像的遗迹，但没有找到相应的符文。
1. [↑](#cite_ref-3) 在热修复#33之前[[_验证_](bg3wiki_colon_Verification.md "bg3wiki:Verification")\]，尸体名为“焦黑的尸体”，后改为“死者”。模型也相应更改。

---
*Source: [Underground Passage](https://bg3.wiki/wiki/Underground_Passage)*