...
**游侠**是[博德之门3](Baldur's_Gate_3.md "博德之门3")中的一个角色[职业](Class.md "职业")。

> “
>
> 游侠是无与伦比的侦察兵和追踪者，他们与自然建立深厚的联系，以追猎其宿敌。
>
> „
...
游侠与自然及其周围环境协调一致，他们利用对荒野的知识和[法术](Spells.md "法术")来追猎其猎物。游侠的重要[属性值](Ability_Scores.md "属性值")包括[敏捷](Dexterity.md "敏捷")（或[力量](Strength.md "力量")）、[体质](Constitution.md "体质")和[感知](Wisdom.md "感知")。
...
生命值
等级 1 时：10 + [体质](Constitution.md "体质") 调整值
升级时：6 + [体质](Constitution.md "体质") 调整值
关键属性
[敏捷](Dexterity.md "敏捷")（或[力量](Strength.md "力量")）用于物理攻击
[体质](Constitution.md "体质")用于生命值和[专注](Concentration.md "专注")检定
[感知](Wisdom.md "感知")用于法术。
施法关键属性
[感知](Wisdom.md "感知")
[习得法术](Spells.md#Known_spells "法术")

游侠可用法术列表见：[游侠法术列表](List_of_Ranger_spells.md "游侠法术列表")。

游侠法术总是已准备。作为交换，游侠在低等级时掌握的法术较少。

游侠主要是战斗型战士；他们获得法术位的速率是完整施法者的 1/2。
...
| 原型 | 描述 | 获得 |
| --- | --- | --- |
| [驯兽师](Beast_Tamer.md "驯兽师") | 你与动物建立了牢固的联系。你可以将[获得魔宠](Find_Familiar.md "获得魔宠")作为仪式施放。 | 每短休施放一次[获得魔宠](Find_Familiar.md "获得魔宠") |
...
[防御](Defence.md "防御")
当你穿着[护甲](Armour.md "护甲")时，你的[护甲等级](Armour_Class.md "护甲等级")获得 +1 加值。
[对决](Duelling.md "对决")
当你单手持握一把非双手的近战武器，且另一只手未持武器时，你使用该武器造成的伤害额外增加 2 点。
[双武器战斗](Two-Weapon_Fighting.md "双武器战斗")
当你进行副手攻击时，你可以将你的[属性值调整值](Ability_score_modifier.md "属性值调整值")加到该攻击的伤害上。
...
你获得两个 1 级法术位。
习得法术：2
从[游侠法术列表](List_of_Ranger_spells.md "游侠法术列表")中选择 2 个起始法术。

可用的新 1 级法术

- [化兽为友](Animal_Friendship.md "化兽为友")
- [疗伤术](Cure_Wounds.md "疗伤术")
- [强化跳跃](Enhance_Leap.md "强化跳跃") *[诱捕打击](Ensnaring_Strike.md "诱捕打击")* [云雾术](Fog_Cloud.md "云雾术") * [神莓](Goodberry.md "神莓")
- [荆雹术](Hail_of_Thorns.md "荆雹术")
- [猎人印记](Hunter's_Mark.md "猎人印记") *[大步奔行](Longstrider.md "大步奔行")* [动物交谈](Speak_with_Animals.md "动物交谈") ### 等级 3

解锁 1 级法术位：3
你获得一个额外的 1 级法术位。

习得法术：3
从[游侠法术列表](List_of_Ranger_spells.md "游侠法术列表")中选择 1 个额外法术。
替换法术（可选）
选择 1 个已知法术，并用[游侠法术列表](List_of_Ranger_spells.md "游侠法术列表")中的另一个法术替换它。

#### 选择副职

| 游侠职业进阶 | [法术位](Spells#Spell_Slots.md#Spell_Slots "法术")（按[法术等级](Spells#Spell_Level.md#Spell_Level "法术")） |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
| 等级 | 熟练项加值 | 特性 | 习得法术 | 1 级 | 2 级 | 3 级 |
| [1 级](#Level_1 "1 级") | +2 | [宿敌](Favoured_Enemy.md "宿敌")、[自然探索者](Natural_Explorer.md "自然探索者") | - | - | - | - |
| [2 级](#Level_2 "2 级") | [战斗风格](Fighting_style.md "战斗风格")、[施法](#Spellcasting "施法") | 2 | 2 | - | - |  |
| [3 级](#Level_3 "3 级") | [选择副职](#Level_3 "选择副职") | 3 | 3 | - | - |  |
| [4 级](#Level_4 "4 级") | [专长](Feats.md "专长") | 3 | - | - |  |  |
| [5 级](#Level_5 "5 级") | +3 | [额外攻击](Extra_Attack.md "额外攻击")、[副职特性](#Level_5 "副职特性") | 4 | 4 | 2 | - |
| [6 级](#Level_6 "6 级") | [宿敌](Favoured_Enemy.md "宿敌")、[自然探索者](Natural_Explorer.md "自然探索者") | 4 | 2 | - |  |  |
| [7 级](#Level_7 "7 级") | [副职特性](#Level_7 "副职特性") | 5 | 4 | 3 | - |  |
| [8 级](#Level_8 "8 级") | [专长](Feats.md "专长")、[大地之步：劣势地形](Land's_Stride_colon__Difficult_Terrain.md "大地之步：劣势地形") | 4 | 3 | - |  |  |
| [9 级](#Level_9 "9 级") | +4 | - | 6 | 4 | 3 | 2 |
| [10 级](#Level_10 "10 级") | [宿敌](Favoured_Enemy.md "宿敌")、[自然探索者](Natural_Explorer.md "自然探索者")、[环境融合](Hide_in_Plain_Sight.md "环境融合") | 4 | 3 | 2 |  |  |
| [11 级](#Level_11 "11 级") | [副职特性](#Level_11 "副职特性") | 7 | 4 | 3 | 3 |  |
| [12 级](#Level_12 "12 级") | [专长](Feats.md "专长") | 4 | 3 | 4 |  |  |

[游侠伙伴](Ranger's_Companion.md "游侠伙伴")

- [熊伙伴](Bear_Companion.md "熊伙伴")
- [野猪伙伴](Boar_Companion.md "野猪伙伴")
- [恐鸦伙伴](Dire_Raven_Companion.md "恐鸦伙伴")
- [狼伙伴](Wolf_Companion.md "狼伙伴")
- [狼蛛伙伴](Wolf_Spider_Companion.md "狼蛛伙伴")

- [惧怖伏兵](Dread_Ambusher.md "惧怖伏兵")
- [惧怖伏兵：躲藏](Dread_Ambusher_colon__Hide.md "惧怖伏兵：躲藏")
- [高级黑暗视觉](Superior_Darkvision.md "高级黑暗视觉")
- [暗影幔](Umbral_Shroud.md "暗影幔")

- [巨像屠夫](Colossus_Slayer.md "巨像屠夫")

- [巨人杀手](Giant_Killer.md "巨人杀手")

[猎物的气味](Prey's_Scent_(Swarmkeeper).md "猎物的气味 (蜂群守护者)") 聚集蜂群（选择 1）：
...
当你在自己的回合中进行攻击动作时，你可以攻击两次，而不是一次。
...
宿敌
选择 1 个额外的[宿敌](Favoured_Enemy.md "宿敌")
自然探索者
选择 1 个额外的[自然探索者](Natural_Explorer.md "自然探索者")
...
| [翻腾潮汐](Writhing_Tide.md "翻腾潮汐")|

### 等级 8

- 选择一个[专长](Feat.md "专长")。

[大地之步：劣势地形](Land's_Stride_colon__Difficult_Terrain.md "大地之步：劣势地形")
你已成为穿越荒野的专家。[劣势地形](Difficult_Terrain_(Condition).md "劣势地形 (状态)")不再使你减速。

此特性是隐藏的，不会出现在任何地方，但仍然会授予。

[大地之步：植物](Land's_Stride_colon__Plants.md "大地之步：植物")
你已成为穿越荒野的专家。带有荆棘、尖刺或类似危险的植物地表不再伤害你。
...
- [防护能量伤害](Protection_from_Energy.md "防护能量伤害") #### 副职特性
...
- [疾速齐射](Volley.md "疾速齐射")
- [旋风斩](Whirlwind_Attack.md "旋风斩")

| [强力蜂群](Mighty_Swarm.md "强力蜂群")|
...
- [所有游侠列表](Category_colon_Rangers.md "分类：游侠")

## 外部链接

- ⁠[游侠](https://forgottenrealms.fandom.com/wiki/Ranger) 在 [被遗忘的国度 Wiki](https://forgottenrealms.fandom.com/wiki/Main_Page) 上

---
*Source: [Ranger](https://bg3.wiki/wiki/Ranger)*