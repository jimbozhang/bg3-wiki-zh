...
- 视线（即“视野锥”）在玩家角色当前处于隐藏状态时会以红色覆盖层显示。可以使用[初级幻影](Minor_Illusion.md "初级幻影")或[猫叫声](Meow.md "猫叫声")等干扰手段来操纵视线，这些手段会迫使生物转向特定方向和/或走向另一个位置。这可以为[扒窃](Sleight_of_Hand.md "巧手")尝试或隐匿攻击创造机会。
