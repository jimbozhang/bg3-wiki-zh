...
本教程来自 [tyvianpear](https://www.nexusmods.com/baldursgate3/users/73681713) 在 DbtR Discord 服务器中分享的帖子。

## Template

**TemplateID** 在 `Status_POLYMORPHED.txt` 中。
...
这与 `RootTemplates/_merged.lsx` 中的 **MapKey** 相同。
...
然后在 `[PAK]_CharacterVisuals/_merged.lsx` 的 **Name** 中，我们有这个，我们可以在这里更改身体网格、头发等。
