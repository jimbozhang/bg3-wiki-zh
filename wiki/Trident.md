...
关于装备类型，请参见 [三叉戟](Tridents.md "Tridents")。

**三叉戟**是 [三叉戟](Tridents.md "Tridents") 武器家族中一种普通的、非魔法的变体。它是一种 [军用近战武器](Weapons.md "Weapons")，可以单手挥舞，或双手持握以获得额外伤害。其设计非常适合作为投射物 [投掷](Thrown.md "Thrown") 向敌人。

据说三叉戟是由安博里将一位蔑视她的海族王子扔到费伦海岸时带到地表的。
...
重量：1.8 千克 (3.6 磅)
价格：40 金币
UID `WPN_HUM_Trident_A_0` UUID `d3807461-7c32-44ae-9aba-49ef4d3bf35e` ### 武器动作
...
---
*Source: [Trident](https://bg3.wiki/wiki/Trident)*