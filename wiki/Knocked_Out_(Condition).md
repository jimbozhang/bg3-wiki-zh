...
- 之前永久处于[敌对](Hostile.md "敌对")状态的受影响实体无法[移动](Movement_speed.md "移动速度")或进行[动作](Action.md "动作")、[附赠动作](Bonus_action.md "附赠动作")或[反应](Reaction.md "反应")。

## 属性

[堆叠ID](Stack_ID.md "堆叠ID"): `KNOCKED_OUT_PLAYERINFO` [堆叠优先级](Stack_priority.md "堆叠优先级"): 1

## 倒地的来源

- [失觉打击](Knock_Unconscious.md "失觉打击")
