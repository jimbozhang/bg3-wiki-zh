...
龙裔威能灵药：毒素是一种独特的稀有[灵药](Elixirs.md "Elixirs")，由毒龙裔的所有最佳特质蒸馏而成。

这是血液供应商[阿拉吉·欧布罗扎](Araj_Oblodra.md "Araj Oblodra")的灵药之一，由特定的血液特质蒸馏而成，其属性与同样特定的种族相符。
...
- 重量：0.1 kg (0.2 lb)
- 价格：10 gp
- UID `CONS_Elixir_Blood_Dragonborn_Poison` UUID `f737ed58-b467-4d6b-b1d0-76df984ec092` Stats `OBJ_BloodPotion_Dragonborn_Poison` ### 效果
...
**[龙族威能：毒素](Draconic_Prowess_colon__Poison_(Condition).md "龙族威能：毒素（状态）")**
