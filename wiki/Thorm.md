...
这是一个消歧义页面，指向名称模糊的文章。如果您是通过文章中的链接[被带到这里](Special_colon_WhatLinksHere/Thorm.md "Special:WhatLinksHere/Thorm")的，请考虑编辑该链接，将其指向正确的页面。
...
---
*Source: [Thorm](https://bg3.wiki/wiki/Thorm)*